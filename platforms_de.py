...
PLATFORMS_DE = [
    ...
    },
    {
        ...
        "title": "SkyPrivate mit SplitCam nutzen — Skype-basierte private Cam-Calls",
        "desc": "SkyPrivate mit kostenlosem SplitCam als virtuelle Kamera nutzen — Pay-per-Minute-Skype-Cam-Calls, Multi-Cam-Szenen, Beauty-Filter. Ohne Wasserzeichen, ohne Registrierung.",
        "kw": "skyprivate, sky private cam, skype cam private, skyprivate splitcam, skyprivate virtuelle kamera, pay-per-minute cam",
    ...
    },
    {
        ...
        "title": "Auf MV Live (ManyVids) senden mit SplitCam — Creator Studio Setup",
        "desc": "Auf ManyVids' MV Live senden mit kostenlosem SplitCam — Creator Studio External Encoder, OnlyFans-ähnliche Creator Economy, Multi-Cam-Szenen. Ohne Wasserzeichen, ohne Registrierung.",
        "kw": "manyvids senden, mv live, manyvids live broadcast, manyvids obs, mv live external encoder, manyvids stream key, manyvids creator",
    ...
    },
    {
        ...
        "title": "Auf Fansly Live senden mit SplitCam — Creator Dashboard External Encoder",
        "desc": "Auf Fansly Live senden mit kostenlosem SplitCam — Creator Dashboard External Encoder, OnlyFans-Konkurrent, Multi-Cam-Szenen, Beauty-Filter. Ohne Wasserzeichen, ohne Registrierung.",
        "kw": "fansly senden, fansly live, fansly broadcast, fansly obs, fansly external encoder, fansly rtmp, fansly stream key, fansly creator",
    ...
    },
    {
        ...
        "title": "Auf iFriends senden mit SplitCam — Model Center External Encoder",
        "desc": "Auf iFriends senden mit kostenlosem SplitCam — Model Center External Encoder, langjähriges unabhängiges Cam-Netzwerk, Multi-Cam-Szenen. Ohne Wasserzeichen, ohne Registrierung.",
        "kw": "ifriends senden, ifriends obs, ifriends external encoder, ifriends rtmp, ifriends stream key, ifriends model center, ifriends.net",
    ...
    },
    {
        ...
        "desc": "Auf Babestation senden mit kostenlosem SplitCam — Performer Hub External Encoder, britisches Adult-TV-/Cam-Netzwerk, Multi-Cam-Szenen, Overlays. Ohne Wasserzeichen, ohne Registrierung.",
        "kw": "babestation senden, babestation cam, babestation obs, babestation external encoder, babestation rtmp, babestation performer, uk cam netzwerk",
    ...
    },
    {
        ...
        "title": "Auf AdultWork senden mit SplitCam — Members Area External Encoder",
        "desc": "Auf AdultWork senden mit kostenlosem SplitCam — Members Area External Encoder, britischer Adult-Service-Marktplatz mit Cam-Feature, Multi-Cam-Szenen. Ohne Wasserzeichen, ohne Registrierung.",
        "kw": "adultwork senden, adultwork cam, adultwork obs, adultwork external encoder, adultwork rtmp, adultwork webcam, uk cam",
    ...
    },
    {
        ...
        "desc": "Auf Jerkmate senden mit kostenlosem SplitCam — Jerkmate bezieht seine Live-Models aus dem Streamate-Netzwerk, du sendest also über SM Connect und den eingebauten Streamate-Kanal von SplitCam. Multi-Cam-Szenen, ohne Wasserzeichen.",
        "kw": "auf jerkmate senden, jerkmate model werden, jerkmate cam, jerkmate streamate, jerkmate obs, jerkmate external encoder, jerkmate broadcast",
    ...
    },
    {
        ...
        "title": "Auf JustForFans live gehen mit SplitCam — Virtual-Camera-Setup",
        "desc": "Auf JustForFans (JFF) live gehen mit kostenlosem SplitCam — SplitCam als virtuelle Kamera im JFF-Live-Broadcaster für Multi-Cam-Szenen, Overlays und Filter. Ohne Wasserzeichen, ohne Registrierung.",
        "kw": "auf justforfans live gehen, justforfans live, jff live stream, justforfans obs, justforfans virtuelle kamera, justfor.fans cam, justforfans broadcast",
