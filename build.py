...
nav.toc{position:static;height:auto;z-index:auto;display:flex;flex-wrap:wrap;gap:8px 4px;padding:14px 22px;margin:24px 40px;max-width:900px;border:1px solid var(--app-border);border-radius:10px;background:var(--app-panel);font-size:13.5px;font-weight:600;justify-content:flex-start}
