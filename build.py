...
.collab-plat-xlovecam .collab-logo,
.collab-plat-xmodels .collab-logo,
.collab-plat-streamate .collab-logo,
.collab-plat-streamray .collab-logo,
.collab-plat-vxlive .collab-logo,
.collab-plat-virtwish .collab-logo{filter:brightness(0) invert(1);
-webkit-filter:brightness(0) invert(1)}
