...
PLATFORMS_PT = [
    ...
    },
    {
        ...
        "title": "Como transmitir no LiveJasmin com SplitCam — encoder externo HD",
        "desc": "Transmitir no LiveJasmin com SplitCam grátis — encoder externo do Model Center, setup HD 1080p, cenas multicâmera e overlays. Sem marca d'água, sem cadastro.",
        "kw": "transmitir livejasmin, livejasmin obs, livejasmin encoder externo, livejasmin rtmp, livejasmin stream key, configurar modelo livejasmin",
    ...
    },
    {
        ...
        "title": "Como transmitir no AmateurTV com SplitCam — rede cam em espanhol",
        "desc": "Transmitir no AmateurTV com SplitCam grátis — encoder externo do Model Panel, rede cam hispanohablante (Espanha e LatAm), cenas multicâmera. Sem marca d'água, sem cadastro.",
        "kw": "transmitir amateurtv, amateur.tv obs, amateurtv encoder externo, amateurtv rtmp, amateurtv stream key, modelos amateur tv",
    ...
    },
    {
        ...
        "title": "Como transmitir no Camster com SplitCam — encoder externo do Model Hub",
        "desc": "Transmitir no Camster com SplitCam grátis — encoder externo do Model Hub, plataforma cam mid-tier consolidada, cenas multicâmera e overlays. Sem marca d'água, sem cadastro.",
        "kw": "transmitir camster, camster.com obs, camster encoder externo, camster rtmp, camster stream key, camster model hub",
    ...
    },
    {
        ...
        "title": "Como transmitir no Camversity com SplitCam — encoder externo do Performer Dashboard",
        "desc": "Transmitir no Camversity com SplitCam grátis — encoder externo do Performer Dashboard, plataforma cam independente em crescimento, cenas multicâmera. Sem marca d'água, sem cadastro.",
        "kw": "transmitir camversity, camversity obs, camversity encoder externo, camversity rtmp, camversity stream key, camversity performer",
    ...
    },
    {
        ...
        "title": "Como usar o SkyPrivate com SplitCam — chamadas cam privadas via Skype",
        "desc": "Usa o SkyPrivate com SplitCam grátis de câmera virtual — chamadas cam privadas pay-per-minute via Skype, cenas multicâmera, filtros de beleza. Sem marca d'água, sem cadastro.",
        "kw": "skyprivate, sky private cam, skype cam privado, skyprivate splitcam, skyprivate câmera virtual, cam pay per minute",
    ...
    },
    {
        ...
        "title": "Como transmitir no MV Live (ManyVids) com SplitCam — Creator Studio",
        "desc": "Transmitir no MV Live do ManyVids com SplitCam grátis — encoder externo do Creator Studio, economia do criador estilo OnlyFans, cenas multicâmera. Sem marca d'água, sem cadastro.",
        "kw": "transmitir manyvids, mv live, manyvids broadcast ao vivo, manyvids obs, mv live external encoder, manyvids stream key, manyvids creator",
    ...
    },
    {
        ...
        "title": "Como transmitir no Fansly Live com SplitCam — encoder externo do Creator Dashboard",
        "desc": "Transmitir no Fansly Live com SplitCam grátis — encoder externo do Creator Dashboard, concorrente direto do OnlyFans, cenas multicâmera e filtros de beleza. Sem marca d'água, sem cadastro.",
        "kw": "transmitir fansly, fansly live, fansly broadcast, fansly obs, fansly encoder externo, fansly rtmp, fansly stream key, fansly creator",
    ...
    },
    {
        ...
        "title": "Como transmitir no iFriends com SplitCam — External Encoder do Model Center",
        "desc": "Transmitir no iFriends com SplitCam grátis — encoder externo do Model Center, rede cam independente de longa data, cenas multicâmera. Sem marca d'água, sem cadastro.",
        "kw": "transmitir ifriends, ifriends obs, ifriends encoder externo, ifriends rtmp, ifriends stream key, ifriends model center, ifriends.net",
    ...
    },
    {
        ...
        "title": "Como transmitir no Babestation com SplitCam — setup da rede cam do Reino Unido",
        "desc": "Transmitir no Babestation com SplitCam grátis — encoder externo do Performer Hub, rede cam / TV adulta do Reino Unido, cenas multicâmera e overlays. Sem marca d'água, sem cadastro.",
        "kw": "transmitir babestation, babestation cam, babestation obs, babestation encoder externo, babestation rtmp, babestation performer, rede cam reino unido",
    ...
    },
    {
        ...
        "title": "Como transmitir no AdultWork com SplitCam — External Encoder da Members Area",
        "desc": "Transmitir no AdultWork com SplitCam grátis — encoder externo da Members Area, marketplace de serviços adultos do Reino Unido com recurso de cam, cenas multicâmera. Sem marca d'água, sem cadastro.",
        "kw": "transmitir adultwork, adultwork cam, adultwork obs, adultwork encoder externo, adultwork rtmp, adultwork webcam, cam reino unido",
    ...
    },
    {
        ...
        "title": "Transmitir no Jerkmate com SplitCam — Setup pela rede Streamate",
        "desc": "Transmitir no Jerkmate com SplitCam grátis — o Jerkmate puxa os modelos ao vivo da rede Streamate, então você transmite via SM Connect e o canal Streamate integrado do SplitCam. Cenas multi-câmera, sem marca d'água.",
        "kw": "transmitir no jerkmate, virar modelo no jerkmate, jerkmate cam, jerkmate streamate, jerkmate obs, jerkmate encoder externo, jerkmate broadcast",
    ...
    },
    {
        ...
        "title": "Entrar ao vivo no JustForFans com SplitCam — Câmera virtual",
        "desc": "Entrar ao vivo no JustForFans (JFF) com SplitCam grátis — usa o SplitCam como câmera virtual no broadcaster ao vivo do JFF pra cenas multi-câmera, overlays e filtros. Sem marca d'água, sem cadastro.",
        "kw": "entrar ao vivo no justforfans, justforfans live, jff live stream, justforfans obs, justforfans câmera virtual, justfor.fans cam, justforfans broadcast",
