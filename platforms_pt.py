...
PLATFORMS_PT = [
    ...
    },
    {
        ...
        "desc": "Adiciona um toy Lovense ao stream no SplitCam grátis — app Lovense Connect + Cam Extension (suporte SplitCam integrado), com alertas de tips na tela.",
        ...
        "intro": "Roda seu stream cam pelo <strong style='color:var(--text)'>SplitCam</strong> grátis e pareia um toy <strong style='color:var(--text)'>Lovense</strong> interativo pra ele reagir aos tips. Você instala três coisas: o <strong>SplitCam</strong> (o encoder), o app <strong>Lovense Connect</strong> (a ponte Bluetooth pro brinquedo) e a <strong>Lovense Cam Extension</strong> pro Chrome/Edge (ela lê os tips e alimenta o overlay na tela). O suporte ao SplitCam é integrado à Cam Extension (versão 30.1.4 ou mais nova) — o SplitCam fica direto na aba Video Feedback da extensão, sem plugin separado pra baixar.",
        "quick": "Pra adicionar um toy Lovense ao stream: instala o SplitCam, o app Lovense Connect e a Lovense Cam Extension, pareia o toy, liga a extensão ao seu site cam, adiciona o overlay Lovense como camada Browser no SplitCam e transmite normal."
                 "<ol><li>Instala o SplitCam.</li>"
                 "<li>Instala o Lovense Connect &amp; pareia o toy.</li>"
                 "<li>Instala a Lovense Cam Extension (Chrome/Edge).</li>"
                 "<li>Liga a extensão ao site cam + adiciona o overlay no SplitCam.</li>"
                 "<li>Go Live.</li></ol>",
        "key_how": "O toy nunca fala direto com o SplitCam. A cadeia é: um espectador manda um tip no seu site cam &rarr; a <strong>Lovense Cam Extension</strong> no navegador detecta &rarr; ela envia um comando pro app <strong>Lovense Connect</strong> no localhost &rarr; o Remote aciona o toy por Bluetooth. A única função do SplitCam é mostrar o <strong>overlay Lovense</strong> (status do toy + tips recentes) como camada Browser e transmitir sua câmera. Não existe um app «Lovense Browser» separado — é uma <em>extensão</em> de navegador pro Chrome ou Edge.",
        "steps": [
            ("Instala o SplitCam",
             "O SplitCam é um software de streaming grátis pra Windows e macOS — o encoder que envia seu vídeo pra sua plataforma cam. Instala; sem marca d'água, sem cadastro."),
            ("Instala o Lovense Connect e pareia o toy",
             "Instala o app <strong>Lovense Connect</strong> — desktop (Windows / Mac) ou o app no celular. É a ponte que fala com o toy por Bluetooth. Liga o toy e pareia até o app mostrar conectado."),
            ("Instala a Lovense Cam Extension",
             "Adiciona a <strong>Lovense Cam Extension</strong> ao Chrome ou Edge (versão 30.1.4 ou mais nova) e faz login com sua conta Lovense. Não existe um «Lovense Browser» avulso — é essa extensão que lê os tips e alimenta o overlay. <strong>O suporte ao SplitCam é integrado</strong>: ele aparece na aba <strong>Video Feedback</strong> da extensão, então não precisa de nenhum plugin do SplitCam à parte."),
            ("Liga a extensão ao site cam e adiciona o overlay no SplitCam",
             "Na Cam Extension, clica em <strong>+</strong> pra adicionar seu site cam (Chaturbate, Stripchat, etc.), define os níveis de tip, depois abre a aba <strong>Video Feedback</strong> e escolhe <strong>SplitCam</strong>. Copia a URL de overlay que ela te dá e adiciona como camada <strong>Browser</strong> na cena do SplitCam pros espectadores verem o status do toy e os tips recentes."),
            ("Monta a cena e Go Live",
             "Adiciona a câmera e os outros overlays, cola a chave RTMP da sua plataforma cam no SplitCam e clica <strong>Go Live</strong>. Agora o toy reage aos tips em tempo real."),
        ],
        "tips": [
            ("Três instalações, nesta ordem", "SplitCam (encoder) + Lovense Connect (ponte Bluetooth) + Lovense Cam Extension (leitor de tips / overlay). Falta uma e o toy não reage no stream."),
            ("É uma extensão, não um navegador", "Não tem um «Lovense Browser» separado pra baixar — a Lovense Cam Extension instala no Chrome ou Edge. Mantém atualizada (30.1.4 ou mais nova) ou o SplitCam pode não aparecer na lista Video Feedback."),
            ("Mantém o toy carregado", "Bateria acabando no meio do show mata a parte interativa — carrega total antes de entrar ao vivo."),
            ("Testa a reação a tips", "Manda um pequeno tip de teste pra confirmar que o toy reage antes de a sala ficar pública."),
            ("Quais sites cam são cobertos", "A Cam Extension cobre oficialmente Chaturbate, Stripchat, BongaCams, MyFreeCams e CamSoda — pra qualquer outro site, usa a integração Generic URL da Lovense. O SplitCam funciona com todos eles como camada de overlay."),
        ],
        "faq": [
            ("O que preciso instalar pra usar Lovense no SplitCam?", "Três coisas: o <strong>SplitCam</strong> (o encoder), o app <strong>Lovense Connect</strong> (faz a ponte com o toy por Bluetooth) e a <strong>Lovense Cam Extension</strong> pro Chrome/Edge (lê os tips e alimenta o overlay). Sem plugin do SplitCam à parte — o suporte ao SplitCam é integrado à Cam Extension."),
            ("A Cam Extension 30.1.4+ funciona com o SplitCam de cara?", "Sim — o suporte ao SplitCam é integrado. Abre a aba <strong>Video Feedback</strong> da extensão, escolhe <strong>SplitCam</strong>, copia a URL do overlay e coloca como camada Browser no SplitCam. Sem plugin extra, só esse link único."),
            ("Existe um «Lovense Browser» que eu preciso baixar?", "Não. Não tem um navegador Lovense avulso — é a <strong>Lovense Cam Extension</strong>, que instala no Chrome ou Edge. O pareamento do toy fica com o app Lovense Connect (desktop ou celular), à parte."),
            ("O toy conecta direto no SplitCam?", "Não — o toy pareia com o app Lovense Connect por Bluetooth; a Cam Extension lê os tips e o SplitCam só mostra o overlay e transmite sua câmera."),
            ...
            ("Posso mostrar os tips recentes na tela?", "Sim — a Cam Extension te dá uma URL de overlay; adiciona como camada Browser no SplitCam e os espectadores veem o status do toy e os tips recentes."),
        ],
    },
    {
    ...
    },
    {
        ...
        "title": "Ao Vivo no MyFans.jp com SplitCam — Câmera Virtual",
        "desc": "Transmita ao vivo no MyFans.jp (OnlyFans do Japão) com SplitCam grátis como câmera virtual — cenas multicâmera, overlays e filtros. Sem marca d'água.",
        "kw": "como transmitir no myfans, myfans.jp ao vivo, myfans 配信, myfans câmera virtual, myfans criadora, マイファンズ, myfans japão, myfans broadcast, myfans assinante",
        "h1html": 'Como transmitir ao vivo no <span class="accent">MyFans.jp</span> com SplitCam',
        "h1short": "Ao vivo no MyFans.jp",
        "card": "Usa o SplitCam como câmera virtual no live do MyFans.jp.",
        "intro": "O MyFans.jp é a principal plataforma de assinatura pra criadores do Japão — a resposta japonesa ao OnlyFans, com assinaturas, pay-per-view, gorjeta (投げ銭) e um recurso de <strong>transmissão ao vivo</strong> pros fãs. O broadcaster roda no navegador, então apontar o <strong style='color:var(--text)'>SplitCam</strong> grátis pro MyFans como <strong>câmera virtual</strong> adiciona cenas multicâmera, overlays e filtros que uma webcam comum não entrega. Se o seu painel de criadora oferecer encoder externo, o SplitCam também conecta via RTMP.",
        "quick": "Transmitir ao vivo no MyFans.jp com SplitCam: instala o SplitCam, monta a cena, começa um ao vivo no MyFans e, no seletor de câmera do broadcaster, escolhe <em>SplitCam</em> — depois fica ao vivo."
                 "<ol><li>Instala o SplitCam.</li><li>Adiciona câmera + cena.</li><li>Começa um ao vivo no MyFans.jp.</li><li>Escolhe SplitCam no menu de câmera.</li><li>Go Live.</li></ol>",
        "key_how": "O ao vivo do MyFans.jp roda no navegador. Monta a cena no SplitCam — ele registra como uma webcam chamada <strong>\"SplitCam Video Driver\"</strong> — depois abre o broadcaster do MyFans e escolhe o <strong>SplitCam</strong> no menu de câmera. Se aparecer a opção de <strong>stream key / encoder externo</strong> no seu painel de criadora, cola nos campos de RTMP personalizado do SplitCam.",
        "tips": [
            ("Maior fan platform do Japão", "O MyFans é a plataforma de assinatura de criadora #1 no Japão, com público japonês acostumado a pagar em 円 (JPY). Overlays em japonês e uma cena caprichada do SplitCam convertem muito mais que uma webcam pelada."),
            ("Câmera virtual, sem stream key", "O ao vivo só pelo navegador ainda entrega a cena completa do SplitCam — segunda câmera, overlays, filtro de beleza ou fundo com IA — só escolhendo o SplitCam como webcam."),
            ("Vende PPV durante o ao vivo", "O MyFans é construído em cima de 投げ銭 (gorjeta) e posts pagos. Um overlay na tela mencionando o pacote PPV ou a meta de gorjeta sobe a receita bem durante o ao vivo."),
            _T_TEST,
        ],
        "faq": [
            ("Como o SplitCam conecta no MyFans.jp?", "O ao vivo do MyFans é baseado em navegador, então o SplitCam conecta como câmera virtual — escolhe o SplitCam no seletor de câmera. Não precisa de stream key."),
            ("Dá pra usar overlays e várias câmeras no MyFans?", "Dá — monta a cena no SplitCam (segunda câmera, overlays, fundo com IA); o MyFans vê a cena pronta como uma única webcam."),
            ("O MyFans.jp suporta OBS ou encoder externo?", "O ao vivo é principalmente via navegador/webcam. Se aparecer a opção de stream key no seu painel, cola nos campos de RTMP personalizado do SplitCam; senão, usa o método de câmera virtual."),
            ("O SplitCam é grátis pra usar com o MyFans.jp?", "É — o SplitCam é grátis, sem marca d'água e sem limite de tempo."),
        ],
        "steps": [
            ("Baixa e instala o SplitCam", "O SplitCam é um software de live streaming grátis pra Windows e macOS — sem cadastro, sem cartão, sem marca d'água. Ele instala uma câmera virtual que o navegador consegue selecionar."),
            ("Monta sua cena", "Abre o SplitCam e adiciona a webcam. Encaixa overlays (em japonês — 「投げ銭」「PPV解放」 pro seu público), uma segunda câmera ou o celular, filtros de beleza ou fundo com IA."),
            ("Começa um ao vivo no MyFans.jp", "Entra na sua conta de criadora do MyFans e abre o broadcaster ao vivo (配信) pra começar uma transmissão pras assinantes."),
            ("Escolhe o SplitCam como câmera", "No menu de câmera do MyFans, troca da webcam crua pro <strong>SplitCam</strong> — sua cena composta substitui a câmera achatada. (Ou cola uma stream key nos campos de RTMP personalizado do SplitCam se disponível.)"),
            ("Go Live", "Começa a transmissão — sua cena do SplitCam, com overlays e filtros, chega nas assinantes do MyFans."),
        ],
    },
    {
        "slug": "privacy-com-br", "name": "Privacy.com.br",
        "title": "Transmitir ao Vivo no Privacy.com.br com SplitCam",
        "desc": "Vai ao vivo no Privacy.com.br (OnlyFans do Brasil) com SplitCam grátis como câmera virtual — cenas multicâmera, overlays e filtros. Sem marca d'água.",
        "kw": "como ir ao vivo no privacy, privacy.com.br ao vivo, privacy live, privacy brasil, privacy câmera virtual, privacy criadora, privacy broadcast, privacy br criadora, privacy assinante",
        "h1html": 'Como ir ao vivo no <span class="accent">Privacy.com.br</span> com SplitCam',
        "h1short": "Ao vivo no Privacy.com.br",
        "card": "Usa o SplitCam como câmera virtual no ao vivo do Privacy.com.br.",
        "intro": "O Privacy.com.br é a principal plataforma de assinatura pra criadoras do Brasil — a resposta brasileira ao OnlyFans, com assinaturas, pay-per-view, gorjetas e um recurso de <strong>ao vivo</strong> embutido pros fãs. O broadcaster roda no navegador, então apontar o <strong style='color:var(--text)'>SplitCam</strong> grátis pro Privacy como <strong>câmera virtual</strong> adiciona cenas multicâmera, overlays e filtros que uma webcam pelada não entrega. Se o seu painel de criadora oferecer a opção de encoder externo, o SplitCam também conecta via RTMP.",
        "quick": "Ir ao vivo no Privacy.com.br com SplitCam: instala o SplitCam, monta a cena, começa um ao vivo no Privacy e, no seletor de câmera do broadcaster, escolhe <em>SplitCam</em> — depois entra ao vivo."
                 "<ol><li>Instala o SplitCam.</li><li>Adiciona câmera + cena.</li><li>Começa um ao vivo no Privacy.com.br.</li><li>Escolhe SplitCam no menu de câmera.</li><li>Go Live.</li></ol>",
        "key_how": "O ao vivo do Privacy.com.br roda no navegador. Monta a cena no SplitCam — ele registra como uma webcam chamada <strong>\"SplitCam Video Driver\"</strong> — depois abre o broadcaster de ao vivo do Privacy e escolhe o <strong>SplitCam</strong> no menu de câmera. Se aparecer a opção de <strong>stream key / encoder externo</strong>, cola nos campos de RTMP personalizado do SplitCam.",
        "tips": [
            ("Maior fan platform do Brasil", "O Privacy é a plataforma de assinatura de criadora #1 no Brasil, com público que fala português e tá acostumado a pagar em BRL via PIX. Overlays em português + cena caprichada do SplitCam convertem muito mais que uma webcam pelada."),
            ("Câmera virtual, sem stream key", "O ao vivo só pelo navegador ainda entrega a cena completa do SplitCam — segunda câmera, overlays, filtro de beleza ou fundo com IA — só escolhendo o SplitCam como webcam."),
            ("Menu de gorjeta + PPV durante o ao vivo", "O Privacy suporta gorjetas e posts pagos. Um overlay na tela mostrando seu pacote PPV ou a meta de gorjeta levanta a receita durante o ao vivo."),
            _T_TEST,
        ],
        "faq": [
            ("Como o SplitCam conecta no Privacy.com.br?", "O ao vivo do Privacy é baseado em navegador, então o SplitCam conecta como câmera virtual — escolhe o SplitCam no seletor de câmera. Não precisa de stream key."),
            ("Dá pra usar overlays e várias câmeras no Privacy?", "Dá — monta a cena no SplitCam (segunda câmera, overlays, fundo com IA); o Privacy vê a cena pronta como uma única webcam."),
            ("O Privacy.com.br suporta OBS ou encoder externo?", "O ao vivo é principalmente via navegador/webcam. Se aparecer a opção de stream key no seu painel, cola nos campos de RTMP personalizado do SplitCam; senão, usa o método de câmera virtual."),
            ("O SplitCam é grátis pra usar com o Privacy.com.br?", "É — o SplitCam é grátis, sem marca d'água e sem limite de tempo."),
        ],
        "steps": [
            ("Baixa e instala o SplitCam", "O SplitCam é um software de live streaming grátis pra Windows e macOS — sem cadastro, sem cartão, sem marca d'água. Ele instala uma câmera virtual que o navegador consegue selecionar."),
            ("Monta sua cena", "Abre o SplitCam e adiciona a webcam. Encaixa overlays em português (\"gorjeta\", \"desbloquear PPV\"), uma segunda câmera ou o celular, filtros de beleza ou fundo com IA."),
            ("Começa um ao vivo no Privacy.com.br", "Entra na sua conta de criadora do Privacy e abre o broadcaster de ao vivo pra começar uma transmissão pras suas assinantes."),
            ("Escolhe o SplitCam como câmera", "No menu de câmera do Privacy, troca da webcam crua pro <strong>SplitCam</strong> — sua cena composta substitui a câmera achatada. (Ou cola uma stream key nos campos de RTMP personalizado do SplitCam se disponível.)"),
            ("Go Live", "Começa a transmissão — sua cena do SplitCam, com overlays e filtros, chega nas assinantes do Privacy.com.br."),
        ],
    },
]
