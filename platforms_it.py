...
PLATFORMS_IT = [
    ...
    },
    {
        ...
        "desc": "Aggiungi un toy Lovense allo stream SplitCam — app Lovense Connect + Cam Extension (supporto SplitCam integrato), con alert mance a schermo. Nessun plugin.",
        ...
        "steps": [
            ...
            ("Installa Lovense Connect e accoppia il toy",
             "Installa l'app <strong>Lovense Connect</strong> — desktop (Windows / Mac) o l'app mobile "
            ...
            ("Collega l'estensione al sito cam e aggiungi l'overlay in SplitCam",
             ...
             "Feedback</strong> e scegli <strong>SplitCam</strong>. Copia l'URL dell'overlay che ti "
             "fornisce e aggiungilo come livello <strong>Browser</strong> nella scena SplitCam così gli "
             "spettatori vedono lo stato del toy e le mance recenti."),
            ("Componi la scena e Go Live",
             "Aggiungi la camera e gli altri overlay, incolla la chiave RTMP della tua piattaforma cam in "
        ...
        "faq": [
            ...
            ("Devo scaricare un «Lovense Browser»?", "No. Non esiste un browser Lovense a sé — è la "
             ...
             "del toy lo gestisce l'app separata Lovense Connect (desktop o mobile)."),
            ...
            ("Quali siti cam supportano Lovense?", "La Cam Extension di Lovense supporta ufficialmente "
             ...
             "controlla la lista attuale nell'app Lovense."),
            ("Posso mostrare le mance recenti a schermo?", "Sì — la Cam Extension ti dà un URL di "
             "overlay; aggiungilo come livello Browser in SplitCam e gli spettatori vedono lo stato del "
             "toy e le mance recenti."),
        ],
    },
    {
    ...
    },
    {
        ...
        "title": "In diretta su MyFans.jp con SplitCam — Camera virtuale",
        "desc": "Vai in diretta su MyFans.jp (l'OnlyFans giapponese) con SplitCam gratis come camera virtuale — scene multi-camera, overlay, filtri. Senza filigrana.",
        "kw": "andare in diretta su myfans, myfans.jp live, myfans 配信, myfans camera virtuale, creator myfans, マイファンズ, myfans giappone, myfans broadcast, abbonato myfans",
        "h1html": 'Come andare in diretta su <span class="accent">MyFans.jp</span> con SplitCam',
        "h1short": "In diretta su MyFans.jp",
        "card": "Usa SplitCam come camera virtuale per le dirette MyFans.jp.",
        "intro": "MyFans.jp è la principale piattaforma di abbonamento per creator del Giappone — la risposta giapponese a OnlyFans, con abbonamenti, pay-per-view, mance (投げ銭) e una funzione di <strong>live stream</strong> integrata per i fan. Il broadcaster gira nel browser, quindi puntare il free <strong style='color:var(--text)'>SplitCam</strong> su MyFans come <strong>camera virtuale</strong> aggiunge scene multi-camera, overlay e filtri che una webcam piatta non può offrire. Se la tua dashboard creator offre un'opzione external-encoder, SplitCam può collegarsi anche via RTMP.",
        "quick": "Vai in diretta su MyFans.jp con SplitCam: installa SplitCam, componi la scena, avvia una diretta su MyFans e nel selettore camera del broadcaster scegli <em>SplitCam</em> — poi vai live."
                 "<ol><li>Installa SplitCam.</li><li>Aggiungi camera + scena.</li><li>Avvia una diretta su MyFans.jp.</li><li>Seleziona SplitCam nel menu camera.</li><li>Go Live.</li></ol>",
        "key_how": "La diretta di MyFans.jp gira nel browser. Componi la scena in SplitCam — viene riconosciuto come una webcam chiamata <strong>\"SplitCam Video Driver\"</strong> — poi apri il broadcaster live di MyFans e scegli <strong>SplitCam</strong> nel menu camera. Se nella dashboard creator compare un'opzione <strong>stream-key / external-encoder</strong>, incollala invece nei campi Custom RTMP di SplitCam.",
        "tips": [
            ("La più grande fan-platform del Giappone", "MyFans è la piattaforma di abbonamento per creator numero 1 in Giappone, con un pubblico JP-nativo che paga in 円 (JPY). Overlay in giapponese e una scena SplitCam curata convertono molto meglio di una webcam piatta."),
            ("Camera virtuale, senza stream key", "La diretta solo-browser ti dà comunque la scena SplitCam completa — seconda camera, overlay, filtri beauty o sfondo IA — basta selezionare SplitCam come webcam."),
            ("Cross-sell PPV durante la diretta", "MyFans è costruita attorno al 投げ銭 (mance) e ai post a pagamento. Un overlay on-screen che nomina il tuo pacchetto PPV o l'obiettivo di mance alza nettamente i guadagni durante una diretta."),
            _T_TEST,
        ],
        "faq": [
            ("Come si collega SplitCam a MyFans.jp?", "La diretta MyFans è browser-based, quindi SplitCam si collega come camera virtuale — scegli SplitCam nel selettore camera. Nessuna stream key necessaria."),
            ("Posso usare overlay e più camere su MyFans?", "Sì — componi la scena in SplitCam (seconda camera, overlay, sfondo IA); MyFans vede la scena finita come un'unica webcam."),
            ("MyFans.jp supporta OBS o encoder esterni?", "La diretta è principalmente browser/webcam-based. Se nella dashboard compare un'opzione stream-key, incollala nei campi Custom RTMP di SplitCam; altrimenti usa il metodo camera virtuale."),
            ("SplitCam è gratis su MyFans.jp?", "Sì — SplitCam è gratis, senza filigrana e senza limite di tempo."),
        ],
        "steps": [
            ("Scarica e installa SplitCam",
             "SplitCam è un software di live streaming gratuito per Windows e macOS — senza registrazione, senza carta, senza filigrana. Installa una camera virtuale che il browser può selezionare."),
            ("Componi la scena",
             "Apri SplitCam e aggiungi la webcam. Sovrapponi overlay (in giapponese — 「投げ銭」「PPV解放」 per il tuo pubblico), una seconda camera o il telefono, filtri beauty o sfondo IA."),
            ("Avvia una diretta su MyFans.jp",
             "Accedi al tuo account creator MyFans e apri il broadcaster live (配信) per avviare una diretta per i tuoi abbonati."),
            ("Seleziona SplitCam come camera",
             "Nel menu camera di MyFans scegli <strong>SplitCam</strong> al posto della webcam grezza — la tua scena composta sostituisce la camera piatta. (Oppure incolla una stream key nei campi Custom RTMP di SplitCam se disponibile.)"),
            ("Go Live",
             "Avvia la trasmissione — la scena, gli overlay e i filtri di SplitCam arrivano ai tuoi abbonati MyFans."),
        ],
    },
    {
        "slug": "privacy-com-br", "name": "Privacy.com.br",
        "title": "Andare in diretta su Privacy.com.br con SplitCam",
        "desc": "Vai in diretta su Privacy.com.br (l'OnlyFans brasiliano) con SplitCam gratis come camera virtuale — scene multi-camera, overlay, filtri. Senza filigrana.",
        "kw": "andare in diretta su privacy, privacy.com.br ao vivo, privacy live, privacy brasile, privacy camera virtuale, creator privacy, privacy broadcast, criadora privacy br, abbonato privacy",
        "h1html": 'Come andare in diretta su <span class="accent">Privacy.com.br</span> con SplitCam',
        "h1short": "In diretta su Privacy.com.br",
        "card": "Usa SplitCam come camera virtuale per le dirette Privacy.com.br.",
        "intro": "Privacy.com.br è la principale piattaforma brasiliana di abbonamento per creator — la risposta brasiliana a OnlyFans, con abbonamenti, pay-per-view, mance (gorjetas) e una funzione <strong>ao vivo</strong> (live stream) integrata per i fan. Il broadcaster gira nel browser, quindi puntare il free <strong style='color:var(--text)'>SplitCam</strong> su Privacy come <strong>camera virtuale</strong> aggiunge scene multi-camera, overlay e filtri che una webcam piatta non può offrire. Se la tua dashboard creator offre un'opzione external-encoder, SplitCam può collegarsi anche via RTMP.",
        "quick": "Vai in diretta su Privacy.com.br con SplitCam: installa SplitCam, componi la scena, avvia un ao-vivo su Privacy e nel selettore camera del broadcaster scegli <em>SplitCam</em> — poi vai live."
                 "<ol><li>Installa SplitCam.</li><li>Aggiungi camera + scena.</li><li>Avvia un ao vivo su Privacy.com.br.</li><li>Seleziona SplitCam nel menu camera.</li><li>Go Live.</li></ol>",
        "key_how": "L'ao vivo di Privacy.com.br gira nel browser. Componi la scena in SplitCam — viene riconosciuto come una webcam chiamata <strong>\"SplitCam Video Driver\"</strong> — poi apri il broadcaster live di Privacy e scegli <strong>SplitCam</strong> nel menu camera. Se è offerta un'opzione <strong>stream-key / external-encoder</strong>, incollala invece nei campi Custom RTMP di SplitCam.",
        "tips": [
            ("La più grande fan-platform del Brasile", "Privacy è la piattaforma di abbonamento per creator numero 1 in Brasile, con un pubblico di lingua portoghese abituato a pagare in BRL via PIX. Overlay in portoghese + una scena SplitCam curata convertono molto meglio di una webcam piatta."),
            ("Camera virtuale, senza stream key", "La diretta solo-browser ti dà comunque la scena SplitCam completa — seconda camera, overlay, filtri beauty o sfondo IA — basta selezionare SplitCam come webcam."),
            ("Tip menu + PPV durante l'ao vivo", "Privacy supporta gorjetas (mance) e post a pagamento. Un overlay on-screen che nomina il tuo pacchetto PPV o la meta-de-gorjeta alza i guadagni durante una diretta."),
            _T_TEST,
        ],
        "faq": [
            ("Come si collega SplitCam a Privacy.com.br?", "L'ao vivo di Privacy è browser-based, quindi SplitCam si collega come camera virtuale — scegli SplitCam nel selettore camera. Nessuna stream key necessaria."),
            ("Posso usare overlay e più camere su Privacy?", "Sì — componi la scena in SplitCam (seconda camera, overlay, sfondo IA); Privacy vede la scena finita come un'unica webcam."),
            ("Privacy.com.br supporta OBS o encoder esterni?", "L'ao vivo è principalmente browser/webcam-based. Se nella dashboard compare un'opzione stream-key, incollala nei campi Custom RTMP di SplitCam; altrimenti usa il metodo camera virtuale."),
            ("SplitCam è gratis su Privacy.com.br?", "Sì — SplitCam è gratis, senza filigrana e senza limite di tempo."),
        ],
        "steps": [
            ("Scarica e installa SplitCam",
             "SplitCam è un software di live streaming gratuito per Windows e macOS — senza registrazione, senza carta, senza filigrana. Installa una camera virtuale che il browser può selezionare."),
            ("Componi la scena",
             "Apri SplitCam e aggiungi la webcam. Sovrapponi overlay in portoghese (\"gorjeta\", \"desbloquear PPV\"), una seconda camera o il telefono, filtri beauty o sfondo IA."),
            ("Avvia un ao vivo su Privacy.com.br",
             "Accedi al tuo account creator Privacy e apri il broadcaster ao-vivo per avviare una diretta per i tuoi abbonati."),
            ("Seleziona SplitCam come camera",
             "Nel menu camera di Privacy scegli <strong>SplitCam</strong> al posto della webcam grezza — la tua scena composta sostituisce la camera piatta. (Oppure incolla una stream key nei campi Custom RTMP di SplitCam se disponibile.)"),
            ("Go Live",
             "Avvia la trasmissione — la scena, gli overlay e i filtri di SplitCam arrivano ai tuoi abbonati Privacy.com.br."),
        ],
    },
]
