    ...
    {"slug": "lovense", "name": "Lovense",
     ...
     "steps": [
         ...
         ("Instalează Lovense Connect și împerechează toy-ul",
          "Instalează aplicația <strong>Lovense Connect</strong> (desktop, de pe lovense.com/connect) — sau folosește <strong>Lovense Remote</strong> pe telefon. Aceasta e puntea care vorbește cu toy-ul prin Bluetooth. Pornește toy-ul și împerechează-l până când aplicația îl arată conectat."),
         ("Instalează Lovense Cam Extension",
          "Adaugă <strong>Lovense Cam Extension</strong> în Chrome sau Edge (versiunea 30.1.4 sau mai nouă) și autentifică-te cu contul Lovense. Nu există un «Lovense Browser» separat — această extensie e cea care citește tip-urile și alimentează overlay-ul. Pentru widget-uri specifice SplitCam, ia și <strong>Lovense SplitCam Toolset</strong> oficial de pe pagina de plugin-uri SplitCam (splitcam.com/more-plugins)."),
     ...
     "tips": [
         ...
         ("Atenție la cerințele de versiune", "Lovense SplitCam Toolset cere SplitCam 10.4.5 sau mai nou. Cam Extension acoperă oficial Chaturbate, Stripchat, BongaCams, MyFreeCams și CamSoda — pentru orice alt site, folosește integrarea Generic URL Lovense."),
     ],
     "faq": [
         ("Ce trebuie să instalez pentru Lovense pe SplitCam?", "Trei lucruri: <strong>SplitCam</strong> (encoderul), aplicația <strong>Lovense Connect</strong> (leagă toy-ul prin Bluetooth) și <strong>Lovense Cam Extension</strong> pentru Chrome/Edge (citește tip-urile și alimentează overlay-ul). Opțional, adaugă Lovense SplitCam Toolset oficial de pe splitcam.com/more-plugins."),
         ("Există un «Lovense Browser» pe care trebuie să-l descarc?", "Nu. Nu există un browser Lovense separat — e <strong>Lovense Cam Extension</strong>, care se instalează în Chrome sau Edge. Împerecherea toy-ului o face aplicația separată Lovense Connect (desktop) sau Lovense Remote (mobil)."),
