...
PLATFORMS_EN = [
    {
        ...
        "title": "How to Stream on Chaturbate with SplitCam — Token Setup",
        "desc": "Stream on Chaturbate with free SplitCam — external encoder, broadcast token, RTMP, multi-camera scenes and overlays. No watermark, no signup.",
        "kw": "how to stream on chaturbate, chaturbate, chaturbate broadcast, chaturbate obs, chaturbate external encoder, chaturbate rtmp, chaturbate stream key, chaturbate broadcast token",
    ...
    },
    {
        ...
        "kw": "how to stream on cam4, cam4, cam4 broadcast, cam4 obs, cam4 external encoder, cam4 rtmp, cam4 stream key, cam4.com",
    ...
    },
    {
        ...
        "kw": "how to stream on bongacams, bongacams, bongacams broadcast, bongacams obs, bongacams external encoder, bongacams rtmp, bongacams stream key, bongcams",
    ...
    },
    {
        ...
        "kw": "how to stream on stripchat, stripchat, strip cam, stripchat broadcast, stripchat external software, stripchat rtmp, stripchat stream key, stripchat obs",
    ...
    },
    {
        ...
        "title": "How to Go Live on OnlyFans with SplitCam — Stream Key",
        "desc": "Go live on OnlyFans with free SplitCam — sign-in Authorization or OBS Key, multi-camera scenes and overlays. Free, no watermark, no signup.",
        "kw": "how to go live on onlyfans, onlyfans, onlyfans live, onlyfans broadcast, onlyfans obs, onlyfans stream key, onlyfans authorization, onlyfans streaming software",
    ...
    },
    {
        ...
        "title": "How to Stream on CamPlace with SplitCam — RTMP Setup",
        "desc": "Stream on CamPlace with free SplitCam — external encoder, RTMP server URL and stream key, multi-camera scenes and overlays. Free, no watermark.",
        "kw": "how to stream on camplace, camplace, camplace broadcast, camplace obs, camplace external encoder, camplace rtmp, camplace stream key",
    ...
    },
    {
        ...
        "kw": "how to stream on camsoda, camsoda live, camsoda, camsoda broadcast, camsoda obs, camsoda external encoder, camsoda rtmp, camsoda stream key",
    ...
    },
    {
        ...
        "title": "How to Stream on Streamate with SplitCam — SM Connect",
        "desc": "Stream on Streamate with free SplitCam — built-in channel, SM Connect key, multi-camera scenes and overlays. Free, no watermark, quick setup.",
        "kw": "how to stream on streamate, streamate, streamate sm connect, streamate broadcast, streamate obs, streamate rtmp, streamate stream key",
    ...
    },
    {
        ...
        "title": "How to Stream on StreamRay with SplitCam — OBS Setup",
        "desc": "Stream on StreamRay with free SplitCam — OBS Broadcaster, stream URL from the chat window, multi-camera scenes and overlays. Free, no watermark.",
        "kw": "how to stream on streamray, streamray, streamray cam, streamray broadcast, streamray obs, streamray external encoder, streamray rtmp",
    ...
    },
    {
        ...
        "title": "How to Stream on XLoveCam with SplitCam — RTMP Setup",
        "desc": "Stream on XLoveCam with free SplitCam — RTMP link and stream key, regional servers, multi-camera scenes and overlays. Free, no watermark.",
        "kw": "how to stream on xlovecam, xlovecam, x love cam, xlovecam broadcast, xlovecam obs, xlovecam rtmp, xlovecam stream key",
    ...
    },
    {
        ...
        "kw": "how to stream on soulcams, soulcams, soul cams, soulcams broadcast, soulcams obs, soulcams external encoder, soulcams rtmp, soulcams stream key",
    ...
    },
    {
        ...
        "title": "How to Use ImLive with SplitCam — Virtual Camera Setup",
        "desc": "Use SplitCam as a virtual camera on ImLive — no RTMP or stream key, just multi-camera scenes, overlays and beauty filters. Free, no watermark.",
        "kw": "how to stream on imlive, im live stream, imlive, imlive virtual camera, imlive broadcast, imlive webcam, im live cam, imlive splitcam",
    ...
    },
    {
        ...
        "title": "How to Stream on VXLive with SplitCam — VISIT-X Setup",
        "desc": "Stream on VXLive (VXModels / VISIT-X) with free SplitCam — official VISIT-X preset, server URL and stream key, scenes and overlays. No watermark.",
        "kw": "how to stream on vxlive, vxlive, visit-x, vxmodels, vxlive broadcast, vxlive rtmp, vxlive stream key, visit-x stream",
    ...
    },
    {
        ...
        "title": "How to Stream on VirtWish with SplitCam — RTMP Setup",
        "desc": "Stream on VirtWish with free SplitCam — OBS section stream URL and key, multi-camera scenes and overlays. Free, no watermark, no signup.",
        "kw": "how to stream on virtwish, virtwish, virtwish broadcast, virtwish obs, virtwish external encoder, virtwish rtmp, virtwish stream key",
    ...
    },
    {
        ...
        "title": "How to Stream on XModels with SplitCam — RTMP Setup",
        "desc": "Stream on XModels with free SplitCam — external encoder in model account settings, RTMP stream key, scenes and overlays. Free, no watermark.",
        "kw": "how to stream on xmodels, xmodels, xmodels broadcast, xmodels obs, xmodels external encoder, xmodels rtmp, xmodels stream key",
    ...
    },
    {
        ...
        "title": "How to Stream on Flirt4Free with SplitCam — RTMP Setup",
        "desc": "Stream on Flirt4Free with free SplitCam — External Broadcast Form, RTMP URL and Stream Name, multi-camera scenes and overlays. No watermark.",
        "kw": "how to stream on flirt4free, flirt for free cam, flirt4free, flirt4free broadcast, flirt4free external encoder, flirt4free rtmp, flirt4free stream key, flirt 4 free cam",
    ...
    },
    {
        ...
        "desc": "Add MFC Alerts (MyFreeCams tip alerts) to your stream with free SplitCam — Browser layer setup, animated effects on viewer tips. No watermark.",
        "kw": "how to add mfc alerts, mfc alerts, myfreecams, myfreecams tip alerts, myfreecams alerts overlay, mfcalerts splitcam",
    ...
    },
    {
        ...
        "desc": "Add a Lovense toy to your SplitCam stream — Lovense Connect app + Cam Extension (built-in SplitCam support), with on-screen tip alerts. No extra plugin.",
        "kw": "how to add lovense to stream, lovense, lovense cam stream, lovense splitcam toolset, lovense cam extension, lovense connect, lovense tip alerts, lovense interactive toy streaming, lovense toy overlay",
        ...
        "intro": "Run your cam stream through free <strong style='color:var(--text)'>SplitCam</strong> "
                 ...
                 "reacts to tips. You install three things: <strong>SplitCam</strong> (the encoder), "
                 "the <strong>Lovense Connect</strong> app (the Bluetooth bridge to the toy) and the "
                 "<strong>Lovense Cam Extension</strong> for Chrome/Edge (it reads tips and feeds the "
                 "on-screen overlay). SplitCam support is built into the Cam Extension (version 30.1.4 "
                 "or newer) — SplitCam sits right in the extension's Video Feedback list, so there's no "
                 "separate plugin to download.",
        "quick": "To add a Lovense toy to your stream: install SplitCam, the Lovense Connect app and "
                 "the Lovense Cam Extension, pair the toy, link the extension to your cam site, add "
                 "the Lovense overlay as a Browser layer in SplitCam, then broadcast as usual."
                 "<ol><li>Install SplitCam.</li>"
                 "<li>Install Lovense Connect &amp; pair the toy.</li>"
                 "<li>Install the Lovense Cam Extension (Chrome/Edge).</li>"
                 "<li>Link the extension to your cam site + add the overlay in SplitCam.</li>"
                 "<li>Go Live.</li></ol>",
        "key_how": "The toy never talks to SplitCam directly. The chain is: a viewer tips on your cam "
                   "site &rarr; the <strong>Lovense Cam Extension</strong> in your browser detects it "
                   "&rarr; it sends a command to the <strong>Lovense Connect</strong> app on localhost "
                   "&rarr; Remote drives the toy over Bluetooth. SplitCam's only job is to show the "
                   "<strong>Lovense overlay</strong> (toy status + recent tips) as a Browser layer and "
                   "broadcast your camera. There is no separate \"Lovense Browser\" app — it's a "
                   "browser <em>extension</em> for Chrome or Edge.",
        "steps": [
            ("Install SplitCam",
             "SplitCam is free live-streaming software for Windows and macOS — the encoder that "
             "sends your video to your cam platform. Install it; no watermark, no signup."),
            ("Install Lovense Connect and pair your toy",
             "Install the <strong>Lovense Connect</strong> app — desktop (Windows / Mac) or the mobile "
             "app on your phone. This is the bridge that talks to the toy over Bluetooth. Turn the toy "
             "on and pair it until the app shows it connected."),
            ("Install the Lovense Cam Extension",
             "Add the <strong>Lovense Cam Extension</strong> to Chrome or Edge (version 30.1.4 or "
             "newer) and log in with your Lovense account. There is no standalone \"Lovense Browser\" "
             "— this extension is what reads tips and powers the overlay. <strong>SplitCam support is "
             "built in</strong>: it's listed in the extension's Video Feedback tab, so you don't need "
             "any separate SplitCam plugin."),
            ("Link the extension to your cam site and add the overlay in SplitCam",
             "In the Cam Extension, click <strong>+</strong> to add your cam site (Chaturbate, "
             "Stripchat, etc.), set your tip levels, then open the <strong>Video Feedback</strong> "
             "tab and pick <strong>SplitCam</strong>. Copy the overlay URL it gives you and add it as "
             "a <strong>Browser</strong> layer in your SplitCam scene so viewers see toy status and "
             "recent tips."),
            ("Build your scene and Go Live",
             "Add your camera and any other overlays, paste your cam platform's RTMP key into "
             "SplitCam, and click <strong>Go Live</strong>. The toy now reacts to tips in real time."),
        ],
        "tips": [
            ("Three installs, in order", "SplitCam (encoder) + Lovense Connect (Bluetooth bridge) + "
             "Lovense Cam Extension (tip reader / overlay). Miss any one and the toy won't react on "
             "stream."),
            ("It's an extension, not a browser", "There is no separate \"Lovense Browser\" to "
             "download — the Lovense Cam Extension installs into Chrome or Edge. Keep it updated "
             "(30.1.4 or newer) or SplitCam may not appear in the Video Feedback list."),
            ("Keep the toy charged", "A mid-show battery death kills the interactive part — "
             "charge fully before going live."),
            ("Test the tip reaction", "Send a small test tip to confirm the toy reacts before "
             "the room is public."),
            ("Which cam sites are covered", "The Cam Extension officially covers Chaturbate, "
             "Stripchat, BongaCams, MyFreeCams and CamSoda — for any other site, use Lovense's "
             "Generic URL integration instead. SplitCam works with all of them as the overlay layer."),
        ],
        "faq": [
            ("What do I need to install for Lovense on SplitCam?", "Three things: <strong>SplitCam</strong> "
             "(the encoder), the <strong>Lovense Connect</strong> app (bridges the toy over Bluetooth), "
             "and the <strong>Lovense Cam Extension</strong> for Chrome/Edge (reads tips and feeds the "
             "overlay). No separate SplitCam plugin — SplitCam support is built into the Cam Extension."),
            ("Does Cam Extension 30.1.4+ work with SplitCam out of the box?", "Yes — SplitCam support is "
             "built in. Open the extension's <strong>Video Feedback</strong> tab, pick <strong>SplitCam</strong>, "
             "copy the overlay URL, and drop it into a Browser layer in SplitCam. No extra plugin, just "
             "that one-time link."),
            ("Is there a \"Lovense Browser\" I need to download?", "No. There's no standalone Lovense "
             "browser — it's the <strong>Lovense Cam Extension</strong>, which installs into Chrome or "
             "Edge. Toy pairing is handled by the separate Lovense Connect app (desktop or mobile)."),
            ("Does the toy connect to SplitCam directly?", "No — the toy pairs with the Lovense Connect "
             "app over Bluetooth; the Cam Extension reads tips and SplitCam just displays the overlay and "
             "broadcasts your camera."),
            ...
            ("Can I show recent tips on screen?", "Yes — the Cam Extension gives you an overlay URL; "
             "add it as a Browser layer in SplitCam and viewers see toy status and recent tips."),
        ],
    },
    {
        ...
        "kw": "broadcast to multiple cam sites, multistream cam sites, multistream, stream to chaturbate and bongacams at once, cam multistreaming software",
    ...
    },
    {
        ...
        "title": "How to Broadcast on LiveJasmin with SplitCam — HD Setup",
        ...
        "kw": "how to broadcast on livejasmin, livejasmin, livejasmin broadcast, livejasmin obs, livejasmin external encoder, livejasmin rtmp, livejasmin stream key, jasmin live",
    ...
    },
    {
        ...
        "title": "How to Broadcast on MyFreeCams with SplitCam — MFC Setup",
        "desc": "Broadcast on MyFreeCams with free SplitCam — Model Admin external broadcaster, RTMP stream key, multi-camera scenes and overlays. No watermark, no signup.",
        "kw": "how to broadcast on myfreecams, myfreecams, mfc, myfreecams broadcast, myfreecams obs, mfc external broadcaster, mfc rtmp, mfc stream key",
    ...
    },
    {
        ...
        "title": "How to Broadcast on Cherry.tv with SplitCam — Setup",
        "desc": "Broadcast on Cherry.tv with free SplitCam — Streamer Dashboard external encoder, RTMP stream key, multi-camera scenes and overlays. No watermark.",
        "kw": "how to broadcast on cherry.tv, cherry.tv, cherry tv broadcast, cherry.tv obs, cherry.tv external encoder, cherry.tv rtmp, cherry.tv stream key, web3 cam",
    ...
    },
    {
        ...
        "title": "How to Broadcast on AmateurTV with SplitCam — Setup",
        "desc": "Broadcast on AmateurTV with free SplitCam — Model Panel external encoder, RTMP stream key, multi-camera scenes and overlays. No watermark, no signup.",
        "kw": "how to broadcast on amateurtv, amateurtv, amateurtv broadcast, amateurtv obs, amateurtv external encoder, amateurtv rtmp, amateurtv stream key, modelos amateur tv",
    ...
    },
    {
        ...
        "title": "How to Broadcast on Camster with SplitCam — Setup",
        "desc": "Broadcast on Camster with free SplitCam — Model Hub external encoder, RTMP stream key, multi-camera scenes and overlays. No watermark, no signup.",
        "kw": "how to broadcast on camster, camster, camster broadcast, camster obs, camster external encoder, camster rtmp, camster stream key, camster.com",
    ...
    },
    {
        ...
        "title": "How to Broadcast on Camversity with SplitCam — Setup",
        "desc": "Broadcast on Camversity with free SplitCam — Performer Dashboard external encoder, RTMP stream key, multi-camera scenes and overlays. No watermark.",
        "kw": "how to broadcast on camversity, camversity, camversity broadcast, camversity obs, camversity external encoder, camversity rtmp, camversity stream key",
    ...
    },
    {
        ...
        "title": "How to Use SkyPrivate with SplitCam — Virtual Camera",
        "desc": "Use SplitCam as a virtual camera on SkyPrivate — Skype-based pay-per-minute cam calls with multi-camera scenes and beauty filters. Free, no watermark.",
        "kw": "how to stream on skyprivate, skyprivate, sky private cam, skyprivate virtual camera, skyprivate broadcast, skype cam private, pay-per-minute cam, skyprivate splitcam",
    ...
    },
    {
        ...
        "title": "How to Stream on MV Live (ManyVids) with SplitCam",
        "desc": "Stream on ManyVids MV Live with free SplitCam — Creator Studio external encoder, RTMP stream key, multi-camera scenes and overlays. No watermark.",
        "kw": "how to stream on manyvids, manyvids, mv live, manyvids live, manyvids broadcast, manyvids obs, mv live external encoder, manyvids stream key",
    ...
    },
    {
        ...
        "title": "How to Stream on Fansly Live with SplitCam — Setup",
        "desc": "Stream on Fansly Live with free SplitCam — Creator Dashboard external encoder, RTMP stream key, multi-camera scenes and overlays. No watermark, no signup.",
        "kw": "how to stream on fansly, fansly, fansly live, fansly broadcast, fansly obs, fansly external encoder, fansly rtmp, fansly stream key",
    ...
    },
    {
        ...
        "title": "How to Broadcast on iFriends with SplitCam — Setup",
        "desc": "Broadcast on iFriends with free SplitCam — Model Center external encoder, RTMP stream key, multi-camera scenes and overlays. No watermark, no signup.",
        "kw": "how to broadcast on ifriends, ifriends, ifriends broadcast, ifriends obs, ifriends external encoder, ifriends rtmp, ifriends stream key, ifriends.net",
    ...
    },
    {
        ...
        "title": "How to Broadcast on Babestation with SplitCam — Setup",
        "desc": "Broadcast on Babestation with free SplitCam — Performer Hub external encoder, RTMP stream key, multi-camera scenes and overlays. No watermark, no signup.",
        "kw": "how to broadcast on babestation, babestation, babestation cam, babestation broadcast, babestation obs, babestation external encoder, babestation rtmp, babestation stream key",
    ...
    },
    {
        ...
        "title": "How to Broadcast on AdultWork with SplitCam — Setup",
        "desc": "Broadcast on AdultWork with free SplitCam — Members Area external encoder, RTMP stream key, multi-camera scenes and overlays. No watermark, no signup.",
        "kw": "how to broadcast on adultwork, adultwork, adultwork cam, adultwork broadcast, adultwork obs, adultwork external encoder, adultwork rtmp, adultwork stream key",
    ...
    },
    {
        ...
        "title": "How to Broadcast on Jerkmate with SplitCam — Setup",
        "desc": "Broadcast on Jerkmate with free SplitCam — Jerkmate sources models from the Streamate network, so you stream via SM Connect and SplitCam's channel.",
        "kw": "how to broadcast on jerkmate, jerkmate, jerkmate cam, jerkmate broadcast, jerkmate streamate, jerkmate sm connect, jerkmate obs, become a jerkmate model",
        "h1html": 'How to broadcast on <span class="accent">Jerkmate</span> with SplitCam',
        "h1short": "Broadcast on Jerkmate",
        "card": "Jerkmate pulls models from the Streamate network — stream via SM Connect + SplitCam.",
        "intro": "Jerkmate is one of the most-searched cam brands, known for its AI matchmaker that pairs viewers with live performers. It doesn't run its own broadcaster — Jerkmate <strong>sources its live models from the Streamate network</strong>. You broadcast as a Streamate-network model and your show is distributed to Jerkmate and its partner sites. Because Streamate is <strong style='color:var(--text)'>pre-configured inside SplitCam</strong>'s channel list, free <strong style='color:var(--text)'>SplitCam</strong> lets you add multi-camera scenes, overlays and filters with no manual RTMP entry.",
        "quick": "Broadcast on Jerkmate with SplitCam: install SplitCam, build your scene, sign up as a model on the Streamate network that feeds Jerkmate, open <em>SM Connect → Start Show</em> and copy the key, then in SplitCam open <em>Stream Settings → Add Channel → Streamate</em> and paste it, and Go Live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Sign up as a Streamate-network model.</li><li>Get the key via SM Connect.</li><li>Add Channel → Streamate, Go Live.</li></ol>",
        "key_how": "Jerkmate's live cams come from the <strong>Streamate broadcasting network</strong> — there is no separate \"Jerkmate encoder.\" Register through Jerkmate's model program or directly on the Streamate network, open <strong>SM Connect</strong>, accept the terms, click <strong>Start Show</strong> and copy your streaming key. In SplitCam open <strong>Stream Settings → Add Channel</strong>, pick <strong>Streamate</strong> from the built-in list and paste the key. Your stream then reaches Jerkmate and the network's partner sites at once.",
        "tips": [
            ("It's the Streamate network underneath", "Don't look for a Jerkmate-specific broadcaster — you broadcast on Streamate and Jerkmate redistributes it. Anything that works for Streamate (SM Connect, the built-in SplitCam channel) works for Jerkmate."),
            ("Convert the AI-matched traffic", "Jerkmate's matchmaker funnels viewers to models who fit their picks — a polished SplitCam scene with overlays and good framing converts those matched viewers far better than a flat webcam."),
            ("One feed, many sites", "Broadcasting to the Streamate network puts you on Jerkmate plus its partner sites simultaneously — wider reach from a single SplitCam stream, no extra setup."),
            _T_ETH,
        ],
        "faq": [
            ("Does Jerkmate have its own broadcaster or stream key?", "No — Jerkmate sources live models from the Streamate network. You broadcast as a Streamate-network model via SM Connect, and your show appears on Jerkmate automatically."),
            ("How do I get my Jerkmate stream key?", "Through SM Connect on the Streamate-network model side: accept terms → Start Show → copy the key. Paste it into SplitCam's built-in Streamate channel — no manual RTMP URL needed."),
            ("What bitrate should I use for Jerkmate?", "Lock 1080p at 30 fps. The network feed is adaptive, so a lower bitrate on a still shot is normal. Run SplitCam's speed test and use a wired connection."),
            ("Is SplitCam free to use with Jerkmate?", "Yes — SplitCam is free, no watermark and no time limit. Streamate (which feeds Jerkmate) is a built-in SplitCam channel, so there's no separate encoder cost."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays, text, a second camera or your phone, beauty filters or an AI background — a strong scene converts Jerkmate's matched viewers."),
            ("Sign up as a model and get your key", "Register through Jerkmate's model program or directly on the <strong>Streamate network</strong> that feeds it. Open <strong>SM Connect</strong>, accept the terms, click <strong>Start Show</strong> and copy your streaming key."),
            ("Add Streamate as a channel in SplitCam", "Open <strong>Stream Settings → Add Channel</strong>, pick <strong>Streamate</strong> from the built-in list and paste the key — no manual RTMP URL. Lock the resolution to 1080p."),
            ("Click Go Live", "Press <strong>Go Live</strong> in SplitCam — a green slider confirms the connection. Your show goes out across the Streamate network and appears on Jerkmate."),
        ],
    },
    {
        "slug": "justforfans", "name": "JustForFans",
        "title": "How to Go Live on JustForFans with SplitCam",
        "desc": "Go live on JustForFans (JFF) with free SplitCam as your virtual camera — multi-camera scenes, overlays and beauty filters in the live broadcaster.",
        "kw": "how to go live on justforfans, justforfans, justforfans live, justforfans virtual camera, justforfans broadcast, jff live stream, justforfans obs, justfor.fans cam",
        "h1html": 'How to go live on <span class="accent">JustForFans</span> with SplitCam',
        "h1short": "Go live on JustForFans",
        "card": "Use SplitCam as your virtual camera in JustForFans' live broadcaster.",
        "intro": "JustForFans (JFF) is a creator-owned subscription platform — a long-running, performer-founded OnlyFans alternative with subscriptions, pay-per-view and a browser-based live feature. Its live broadcaster shows a single plain webcam; pointing it at free <strong style='color:var(--text)'>SplitCam</strong> as a <strong>virtual camera</strong> unlocks multi-camera scenes, overlays and filters. If your creator dashboard also exposes an external-encoder / stream-key option, SplitCam connects over RTMP instead.",
        "quick": "Go live on JustForFans with SplitCam: install SplitCam, build your scene, start a live broadcast on JFF, and in the broadcaster's camera selector choose <em>SplitCam</em> as your webcam — then go live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Start a live broadcast on JFF.</li><li>Select SplitCam in the camera dropdown.</li><li>Go Live.</li></ol>",
        "key_how": "JustForFans' live runs in the browser. Build your scene in SplitCam — it registers as a system webcam called <strong>\"SplitCam Video Driver\"</strong> — then open the JFF live broadcaster and, in the camera dropdown, select <strong>SplitCam</strong> instead of your raw webcam. Your composed scene replaces the flat camera. If JFF's creator dashboard offers an <strong>external-encoder / stream-key</strong> option, paste that key into SplitCam's custom RTMP fields instead.",
        "tips": [
            ("Virtual camera works everywhere", "Even when a platform's live is browser-only, SplitCam appears as a selectable webcam — so your multi-camera scene, overlays and filters work on JFF without any stream key at all."),
            ("Creator-owned, performer-friendly", "JFF is run by performers and keeps a loyal subscriber base. Overlays cross-selling your PPV or subscription convert well to an audience that's already paying."),
            ("Grant the browser camera permission", "If SplitCam doesn't appear in JFF's camera list, make sure SplitCam is running first and the browser has camera permission — then reload the broadcaster."),
            _T_TEST,
        ],
        "faq": [
            ("How does SplitCam connect to JustForFans?", "JFF live is browser-based, so SplitCam connects as a virtual camera: pick SplitCam in the JFF broadcaster's camera selector. No stream key needed."),
            ("Can I use overlays and multiple cameras on JFF?", "Yes — build the scene in SplitCam (second camera, overlays, beauty or AI-background filters) and JFF sees the finished scene as a single webcam."),
            ("Does JustForFans support OBS or external encoders?", "JFF's live is primarily browser/webcam-based. If your creator dashboard shows an external-encoder or stream-key option, paste it into SplitCam's custom RTMP fields; otherwise use the virtual-camera method."),
            ("Is SplitCam free to use with JustForFans?", "Yes — SplitCam is free, no watermark and no time limit."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark. It installs a virtual camera the browser can select."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays, text, a second camera or your phone, beauty filters or an AI background — applied live."),
            ("Start a live broadcast on JFF", "Log in to your JustForFans creator account and open the live broadcaster to start a stream for your subscribers."),
            ("Select SplitCam as your camera", "In the JFF broadcaster's camera dropdown, choose <strong>SplitCam</strong> instead of your raw webcam — your composed scene replaces the flat camera. (Or, if available, paste JFF's external-encoder key into SplitCam's custom RTMP fields.)"),
            ("Go Live", "Start the broadcast — your SplitCam scene, overlays and filters reach your JustForFans subscribers."),
        ],
    },
    {
        "slug": "fanvue", "name": "Fanvue",
        "title": "How to Go Live on Fanvue with SplitCam — Virtual Camera",
        "desc": "Go live on Fanvue with free SplitCam as your virtual camera — multi-camera scenes, overlays and filters for your subscribers. No watermark, no signup.",
        "kw": "how to go live on fanvue, fanvue live, fanvue stream, fanvue obs, fanvue virtual camera, fanvue creator, fanvue broadcast",
        "h1html": 'How to go live on <span class="accent">Fanvue</span> with SplitCam',
        "h1short": "Go live on Fanvue",
        "card": "Use SplitCam as your virtual camera for Fanvue live.",
        "intro": "Fanvue is a fast-growing UK creator-subscription platform — an OnlyFans alternative known for being creator- and AI-friendly, with subscriptions, pay-per-view and live streaming. Its live broadcaster runs in the browser, so pointing it at free <strong style='color:var(--text)'>SplitCam</strong> as a <strong>virtual camera</strong> unlocks multi-camera scenes, overlays and filters. If your creator dashboard exposes an external-encoder / stream-key option, SplitCam connects over RTMP instead.",
        "quick": "Go live on Fanvue with SplitCam: install SplitCam, build your scene, start a live on Fanvue, and in the broadcaster's camera selector choose <em>SplitCam</em> — then go live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Start a live on Fanvue.</li><li>Select SplitCam in the camera dropdown.</li><li>Go Live.</li></ol>",
        "key_how": "Fanvue's live runs in the browser. Build your scene in SplitCam — it registers as a webcam called <strong>\"SplitCam Video Driver\"</strong> — then open Fanvue's live broadcaster and pick <strong>SplitCam</strong> in the camera dropdown instead of your raw webcam. If your creator dashboard offers an <strong>external-encoder / stream-key</strong> option, paste that key into SplitCam's custom RTMP fields instead.",
        "tips": [
            ("Virtual camera works everywhere", "Even when a platform's live is browser-only, SplitCam appears as a selectable webcam — multi-camera scenes, overlays and filters work on Fanvue with no stream key."),
            ("Creator- and AI-friendly", "Fanvue welcomes AI creators and pays out cleanly. Overlays that cross-sell your subscription or PPV convert well to an audience that's already paying."),
            ("Grant the browser camera permission", "If SplitCam doesn't appear in Fanvue's camera list, make sure SplitCam is running first and the browser has camera permission, then reload."),
            _T_TEST,
        ],
        "faq": [
            ("How does SplitCam connect to Fanvue?", "Fanvue live is browser-based, so SplitCam connects as a virtual camera: pick SplitCam in the camera selector. No stream key needed."),
            ("Can I use overlays and multiple cameras on Fanvue?", "Yes — build the scene in SplitCam (second camera, overlays, beauty or AI-background filters) and Fanvue sees the finished scene as one webcam."),
            ("Does Fanvue support OBS or external encoders?", "Fanvue live is primarily browser/webcam-based. If your dashboard shows an external-encoder or stream-key option, paste it into SplitCam's custom RTMP fields; otherwise use the virtual-camera method."),
            ("Is SplitCam free to use with Fanvue?", "Yes — SplitCam is free, no watermark and no time limit."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark. It installs a virtual camera the browser can select."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays, text, a second camera or your phone, beauty filters or an AI background — applied live."),
            ("Start a live on Fanvue", "Log in to your Fanvue creator account and open the live broadcaster to start a stream for your subscribers."),
            ("Select SplitCam as your camera", "In Fanvue's camera dropdown, choose <strong>SplitCam</strong> instead of your raw webcam — your composed scene replaces the flat camera. (Or paste a stream key into SplitCam's custom RTMP fields if available.)"),
            ("Go Live", "Start the broadcast — your SplitCam scene, overlays and filters reach your Fanvue subscribers."),
        ],
    },
    {
        "slug": "loyalfans", "name": "LoyalFans",
        "title": "How to Go Live on LoyalFans with SplitCam — Virtual Camera",
        "desc": "Go live on LoyalFans with free SplitCam as your virtual camera — multi-camera scenes, overlays and filters for subscribers and tippers. No watermark.",
        "kw": "how to go live on loyalfans, loyalfans live, loyalfans stream, loyalfans obs, loyalfans virtual camera, loyalfans broadcast, loyal fans",
        "h1html": 'How to go live on <span class="accent">LoyalFans</span> with SplitCam',
        "h1short": "Go live on LoyalFans",
        "card": "Use SplitCam as your virtual camera for LoyalFans live.",
        "intro": "LoyalFans is a creator-subscription platform with subscriptions, pay-per-view, tipping and a built-in <strong>live cam</strong> feature. The live broadcaster runs in the browser, so connecting free <strong style='color:var(--text)'>SplitCam</strong> as a <strong>virtual camera</strong> adds multi-camera scenes, overlays and filters on top of the standard webcam. If your dashboard exposes an external-encoder / stream-key option, SplitCam connects via RTMP instead.",
        "quick": "Go live on LoyalFans with SplitCam: install SplitCam, build your scene, start a live on LoyalFans, and pick <em>SplitCam</em> in the broadcaster's camera selector — then go live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Start a live on LoyalFans.</li><li>Select SplitCam in the camera dropdown.</li><li>Go Live.</li></ol>",
        "key_how": "LoyalFans' live runs in the browser. Build your scene in SplitCam — it registers as a webcam called <strong>\"SplitCam Video Driver\"</strong> — then open the LoyalFans live broadcaster and select <strong>SplitCam</strong> in the camera dropdown. If a <strong>stream-key / external-encoder</strong> option appears in your creator dashboard, paste it into SplitCam's custom RTMP fields instead.",
        "tips": [
            ("Virtual camera, no key needed", "Browser-based live still gets your full SplitCam scene — overlays, second camera and filters — just by selecting SplitCam as the webcam."),
            ("Tips reward production value", "LoyalFans leans on tipping; on-screen tip-goal overlays and a polished scene push tippers more than a flat webcam."),
            ("Grant the browser camera permission", "If SplitCam isn't in LoyalFans' camera list, start SplitCam first, allow camera access in the browser, then reload the broadcaster."),
            _T_TEST,
        ],
        "faq": [
            ("How does SplitCam connect to LoyalFans?", "LoyalFans live is browser-based, so SplitCam connects as a virtual camera — pick SplitCam in the camera selector. No stream key needed."),
            ("Can I use overlays and multiple cameras on LoyalFans?", "Yes — compose the scene in SplitCam (second camera, overlays, beauty or AI-background filters); LoyalFans sees it as one webcam."),
            ("Does LoyalFans support OBS or external encoders?", "Its live is primarily browser/webcam-based. If your dashboard shows a stream-key option, paste it into SplitCam's custom RTMP fields; otherwise use the virtual-camera method."),
            ("Is SplitCam free to use with LoyalFans?", "Yes — free, no watermark and no time limit."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark. It installs a virtual camera the browser can select."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays, tip-goal text, a second camera or your phone, beauty filters or an AI background."),
            ("Start a live on LoyalFans", "Log in to your LoyalFans account and open the live broadcaster to go live for your subscribers."),
            ("Select SplitCam as your camera", "In the LoyalFans camera dropdown, choose <strong>SplitCam</strong> instead of your raw webcam — your scene replaces the flat camera. (Or paste a stream key into SplitCam's custom RTMP fields if available.)"),
            ("Go Live", "Start the broadcast — your SplitCam scene reaches your LoyalFans audience."),
        ],
    },
    {
        "slug": "fancentro", "name": "FanCentro",
        "title": "How to Go Live on FanCentro with SplitCam — Virtual Camera",
        "desc": "Go live on FanCentro with free SplitCam as your virtual camera — multi-camera scenes, overlays and filters for your subscribers. No watermark, no signup.",
        "kw": "how to go live on fancentro, fancentro live, fancentro stream, fancentro obs, fancentro virtual camera, fancentro broadcast, fan centro",
        "h1html": 'How to go live on <span class="accent">FanCentro</span> with SplitCam',
        "h1short": "Go live on FanCentro",
        "card": "Use SplitCam as your virtual camera for FanCentro live.",
        "intro": "FanCentro is a long-running creator-monetization platform — subscriptions, pay-per-view messages, content and live streaming. Its live runs in the browser, so connecting free <strong style='color:var(--text)'>SplitCam</strong> as a <strong>virtual camera</strong> adds multi-camera scenes, overlays and filters beyond the plain webcam. If your dashboard exposes an external-encoder / stream-key option, SplitCam connects over RTMP instead.",
        "quick": "Go live on FanCentro with SplitCam: install SplitCam, build your scene, start a live on FanCentro, and choose <em>SplitCam</em> in the broadcaster's camera selector — then go live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Start a live on FanCentro.</li><li>Select SplitCam in the camera dropdown.</li><li>Go Live.</li></ol>",
        "key_how": "FanCentro's live runs in the browser. Build your scene in SplitCam — it registers as a webcam called <strong>\"SplitCam Video Driver\"</strong> — then open FanCentro's live broadcaster and pick <strong>SplitCam</strong> in the camera dropdown. If a <strong>stream-key / external-encoder</strong> option is offered, paste it into SplitCam's custom RTMP fields instead.",
        "tips": [
            ("Virtual camera works everywhere", "Browser-only live still gets your full SplitCam scene — overlays, second camera and filters — by selecting SplitCam as the webcam."),
            ("Cross-sell your funnel", "FanCentro is built around creator funnels and PPV. Overlays promoting your subscription or paid messages convert your live viewers into buyers."),
            ("Grant the browser camera permission", "If SplitCam isn't listed, run SplitCam first, allow camera access in the browser, then reload the broadcaster."),
            _T_TEST,
        ],
        "faq": [
            ("How does SplitCam connect to FanCentro?", "FanCentro live is browser-based, so SplitCam connects as a virtual camera — pick SplitCam in the camera selector. No stream key needed."),
            ("Can I use overlays and multiple cameras on FanCentro?", "Yes — build the scene in SplitCam; FanCentro sees the finished scene as a single webcam."),
            ("Does FanCentro support OBS or external encoders?", "Its live is primarily browser/webcam-based. If a stream-key option appears in your dashboard, paste it into SplitCam's custom RTMP fields; otherwise use the virtual-camera method."),
            ("Is SplitCam free to use with FanCentro?", "Yes — free, no watermark and no time limit."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark. It installs a virtual camera the browser can select."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays, text, a second camera or your phone, beauty filters or an AI background."),
            ("Start a live on FanCentro", "Log in to your FanCentro account and open the live broadcaster to go live for your subscribers."),
            ("Select SplitCam as your camera", "In FanCentro's camera dropdown, choose <strong>SplitCam</strong> instead of your raw webcam. (Or paste a stream key into SplitCam's custom RTMP fields if available.)"),
            ("Go Live", "Start the broadcast — your SplitCam scene reaches your FanCentro subscribers."),
        ],
    },
    {
        "slug": "ismygirl", "name": "IsMyGirl",
        "title": "How to Go Live on IsMyGirl with SplitCam — Virtual Camera",
        "desc": "Go live on IsMyGirl with free SplitCam as your virtual camera — multi-camera scenes, overlays and filters for your subscribers. No watermark, no signup.",
        "kw": "how to go live on ismygirl, ismygirl live, ismygirl stream, ismygirl obs, ismygirl virtual camera, ismygirl broadcast, is my girl",
        "h1html": 'How to go live on <span class="accent">IsMyGirl</span> with SplitCam',
        "h1short": "Go live on IsMyGirl",
        "card": "Use SplitCam as your virtual camera for IsMyGirl live.",
        "intro": "IsMyGirl is a creator-subscription platform — an OnlyFans alternative with subscriptions, paid content and live streaming, known for hands-on creator support. The live broadcaster runs in the browser, so connecting free <strong style='color:var(--text)'>SplitCam</strong> as a <strong>virtual camera</strong> brings multi-camera scenes, overlays and filters. If your dashboard exposes an external-encoder / stream-key option, SplitCam connects over RTMP instead.",
        "quick": "Go live on IsMyGirl with SplitCam: install SplitCam, build your scene, start a live on IsMyGirl, and select <em>SplitCam</em> in the broadcaster's camera selector — then go live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Start a live on IsMyGirl.</li><li>Select SplitCam in the camera dropdown.</li><li>Go Live.</li></ol>",
        "key_how": "IsMyGirl's live runs in the browser. Build your scene in SplitCam — it registers as a webcam called <strong>\"SplitCam Video Driver\"</strong> — then open the IsMyGirl live broadcaster and choose <strong>SplitCam</strong> in the camera dropdown. If a <strong>stream-key / external-encoder</strong> option appears, paste it into SplitCam's custom RTMP fields instead.",
        "tips": [
            ("Virtual camera, no key needed", "Browser-only live still gets your full SplitCam scene — overlays, second camera and filters — by selecting SplitCam as the webcam."),
            ("Lean on the creator support", "IsMyGirl markets strong creator support and promotion. A polished SplitCam scene plus cross-sell overlays makes the most of the traffic they send you."),
            ("Grant the browser camera permission", "If SplitCam isn't listed, run SplitCam first, allow camera access, then reload the broadcaster."),
            _T_TEST,
        ],
        "faq": [
            ("How does SplitCam connect to IsMyGirl?", "IsMyGirl live is browser-based, so SplitCam connects as a virtual camera — pick SplitCam in the camera selector. No stream key needed."),
            ("Can I use overlays and multiple cameras on IsMyGirl?", "Yes — compose the scene in SplitCam; IsMyGirl sees it as one webcam."),
            ("Does IsMyGirl support OBS or external encoders?", "Its live is primarily browser/webcam-based. If a stream-key option appears, paste it into SplitCam's custom RTMP fields; otherwise use the virtual-camera method."),
            ("Is SplitCam free to use with IsMyGirl?", "Yes — free, no watermark and no time limit."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark. It installs a virtual camera the browser can select."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays, text, a second camera or your phone, beauty filters or an AI background."),
            ("Start a live on IsMyGirl", "Log in to your IsMyGirl account and open the live broadcaster to go live for your subscribers."),
            ("Select SplitCam as your camera", "In IsMyGirl's camera dropdown, choose <strong>SplitCam</strong> instead of your raw webcam. (Or paste a stream key into SplitCam's custom RTMP fields if available.)"),
            ("Go Live", "Start the broadcast — your SplitCam scene reaches your IsMyGirl subscribers."),
        ],
    },
    {
        "slug": "dxlive", "name": "DXLive",
        "title": "How to Broadcast on DXLive with SplitCam — External Encoder",
        "desc": "Broadcast on DXLive with free SplitCam — external encoder for the Japanese premium cam network, multi-camera scenes and overlays. No watermark, no signup.",
        "kw": "how to broadcast on dxlive, dxlive broadcast, dxlive cam, dxlive obs, dxlive external encoder, dxlive rtmp, dxlive performer",
        "h1html": 'How to broadcast on <span class="accent">DXLive</span> with SplitCam',
        "h1short": "Broadcast on DXLive",
        "card": "External encoder setup for DXLive's premium cam network.",
        "intro": "DXLive is an established premium webcam network popular in Japan and across Asia, built on a pay-per-minute model with a loyal audience. The performer area supports a standard <strong>external encoder</strong> path that free <strong style='color:var(--text)'>SplitCam</strong> connects to — letting you broadcast with multi-camera scenes, overlays and beauty filters instead of a single flat webcam.",
        "quick": "Broadcast on DXLive with SplitCam: install SplitCam, build your scene, in the performer area open the <em>external encoder / broadcast</em> settings, copy the server URL and stream key, paste into SplitCam, Go Live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Get URL + stream key from the performer area.</li><li>Paste into SplitCam.</li><li>Go Live.</li></ol>",
        "key_how": "Log in to your DXLive performer account and open the <strong>broadcast / external encoder</strong> settings in the performer area. The page reveals a <strong>server URL</strong> and <strong>stream key</strong> tied to your account — copy both into SplitCam's custom RTMP fields. DXLive verification is required before the live cam feature is enabled.",
        "tips": [
            ("Built for the Asian market", "DXLive's audience skews Japan/Asia and pays per minute. Time your shows to JST evenings and the loyal, paying base converts well."),
            ("Polish beats raw webcam", "A clean SplitCam scene with overlays and beauty filters stands out on a premium pay-per-minute network where viewers expect quality."),
            ("Use the external encoder, not just the webcam", "Routing through SplitCam's RTMP rather than the basic browser cam is what unlocks multi-camera scenes and filters."),
            _T_ETH,
        ],
        "faq": [
            ("Does DXLive support external encoders like SplitCam?", "Yes — the performer area exposes a standard external-encoder / RTMP path. Copy the server URL and stream key into SplitCam after verification."),
            ("Where do I get my DXLive stream key?", "In the performer area's broadcast / external-encoder settings — both the server URL and stream key appear there. Paste both into SplitCam's custom RTMP fields."),
            ("What bitrate should I use for DXLive?", "Push 1920×1080 at 30 fps, 3,500–6,000 Kbps with a 2-second keyframe interval. Run SplitCam's built-in speed test first."),
            ("Is SplitCam free to use with DXLive?", "Yes — SplitCam is free, no watermark and no time limit. DXLive's external-encoder option is free in the performer area."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays, text, a second camera or your phone, beauty filters or an AI background."),
            ("Get your DXLive URL and stream key", "Log in to your DXLive performer account and open the <strong>broadcast / external encoder</strong> settings. Copy the <strong>server URL</strong> and <strong>stream key</strong>."),
            ("Connect SplitCam to DXLive", "In SplitCam open <strong>Stream Settings</strong>, paste the DXLive server URL and stream key into the custom RTMP fields. Set 3,500–6,000 Kbps at 1920×1080, 30 fps, with a 2-second keyframe."),
            ("Click Go Live", "Press <strong>Go Live</strong> in SplitCam, then go online from the performer area. Within ~10 seconds your stream reaches DXLive's audience."),
        ],
    },
    {
        "slug": "streamen", "name": "Streamen",
        "title": "How to Broadcast on Streamen with SplitCam — External Encoder",
        "desc": "Broadcast on Streamen with free SplitCam — external encoder setup, multi-camera scenes, overlays and beauty filters. No watermark, no signup.",
        "kw": "how to broadcast on streamen, streamen broadcast, streamen cam, streamen obs, streamen external encoder, streamen rtmp, streamen.tv",
        "h1html": 'How to broadcast on <span class="accent">Streamen</span> with SplitCam',
        "h1short": "Broadcast on Streamen",
        "card": "External encoder setup for the Streamen cam platform.",
        "intro": "Streamen is a live cam platform where models broadcast to a tipping-driven audience. Its broadcast settings expose a standard <strong>external encoder</strong> path that free <strong style='color:var(--text)'>SplitCam</strong> connects to — so you can stream with multi-camera scenes, overlays and filters rather than a single plain webcam.",
        "quick": "Broadcast on Streamen with SplitCam: install SplitCam, build your scene, in your model dashboard open <em>broadcast settings → external encoder</em>, copy the server URL and stream key, paste into SplitCam, Go Live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Get URL + stream key from the dashboard.</li><li>Paste into SplitCam.</li><li>Go Live.</li></ol>",
        "key_how": "Log in to your Streamen model account and open the <strong>broadcast settings / external encoder</strong> section. It reveals a <strong>server URL</strong> and <strong>stream key</strong> tied to your account — copy both into SplitCam's custom RTMP fields. Model verification is required before broadcasting is enabled.",
        "tips": [
            ("Tip-driven audience", "Streamen viewers tip — on-screen tip goals and a polished scene push more tips than a flat webcam."),
            ("External encoder unlocks scenes", "Routing through SplitCam's RTMP instead of the basic browser cam is what enables multi-camera layouts, overlays and filters."),
            ("Lock your resolution", "Set 1080p by hand so the feed doesn't quietly drop quality; a bitrate that dips on a still shot is normal on adaptive feeds."),
            _T_ETH,
        ],
        "faq": [
            ("Does Streamen support external encoders like SplitCam?", "Yes — the broadcast settings expose a standard external-encoder / RTMP path. Copy the server URL and stream key into SplitCam after verification."),
            ("Where do I get my Streamen stream key?", "In your model dashboard's broadcast / external-encoder settings — both the server URL and stream key appear there. Paste both into SplitCam's custom RTMP fields."),
            ("What bitrate should I use for Streamen?", "Push 1920×1080 at 30 fps, 3,500–6,000 Kbps with a 2-second keyframe interval. Run SplitCam's speed test first."),
            ("Is SplitCam free to use with Streamen?", "Yes — SplitCam is free, no watermark and no time limit. Streamen's external-encoder option is free in the dashboard."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays, tip-goal text, a second camera or your phone, beauty filters or an AI background."),
            ("Get your Streamen URL and stream key", "Log in to your Streamen model account, open <strong>broadcast settings → external encoder</strong>, and copy the <strong>server URL</strong> and <strong>stream key</strong>."),
            ("Connect SplitCam to Streamen", "In SplitCam open <strong>Stream Settings</strong>, paste the Streamen server URL and stream key into the custom RTMP fields. Set 3,500–6,000 Kbps at 1920×1080, 30 fps, with a 2-second keyframe."),
            ("Click Go Live", "Press <strong>Go Live</strong> in SplitCam, then go online from your dashboard. Within ~10 seconds your stream reaches Streamen's audience."),
        ],
    },
    {
        "slug": "xcams", "name": "XCams",
        "title": "How to Broadcast on XCams with SplitCam — External Encoder",
        "desc": "Broadcast on XCams with free SplitCam — external encoder for the European cam community, multi-camera scenes, overlays and filters. No watermark, no signup.",
        "kw": "how to broadcast on xcams, xcams broadcast, xcams cam, xcams obs, xcams external encoder, xcams rtmp, x cams",
        "h1html": 'How to broadcast on <span class="accent">XCams</span> with SplitCam',
        "h1short": "Broadcast on XCams",
        "card": "External encoder setup for the XCams European community.",
        "intro": "XCams is a European live cam community — strong in Italy, France and Spain — built around live shows and a tipping/private-show economy. The model area supports a standard <strong>external encoder</strong> path that free <strong style='color:var(--text)'>SplitCam</strong> connects to, so you can broadcast with multi-camera scenes, overlays and beauty filters.",
        "quick": "Broadcast on XCams with SplitCam: install SplitCam, build your scene, in the model area open <em>broadcast / external encoder</em>, copy the server URL and stream key, paste into SplitCam, Go Live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Get URL + stream key from the model area.</li><li>Paste into SplitCam.</li><li>Go Live.</li></ol>",
        "key_how": "Log in to your XCams model account and open the <strong>broadcast / external encoder</strong> settings in the model area. The page reveals a <strong>server URL</strong> and <strong>stream key</strong> tied to your account — copy both into SplitCam's custom RTMP fields. XCams verification is required before broadcasting.",
        "tips": [
            ("European prime time", "XCams traffic peaks in EU evenings (CET). Broadcasting in those hours significantly out-performs off-peak on this community."),
            ("Private shows reward quality", "XCams runs on private/spy shows — a polished SplitCam scene with overlays converts browsers into paid privates."),
            ("External encoder unlocks scenes", "Routing through SplitCam's RTMP instead of the browser cam enables multi-camera layouts, overlays and filters."),
            _T_ETH,
        ],
        "faq": [
            ("Does XCams support external encoders like SplitCam?", "Yes — the model area exposes a standard external-encoder / RTMP path. Copy the server URL and stream key into SplitCam after verification."),
            ("Where do I get my XCams stream key?", "In the model area's broadcast / external-encoder settings — both the server URL and stream key appear there. Paste both into SplitCam's custom RTMP fields."),
            ("What bitrate should I use for XCams?", "Push 1920×1080 at 30 fps, 3,500–6,000 Kbps with a 2-second keyframe interval. Run SplitCam's speed test first."),
            ("Is SplitCam free to use with XCams?", "Yes — SplitCam is free, no watermark and no time limit. XCams' external-encoder option is free in the model area."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays, text, a second camera or your phone, beauty filters or an AI background."),
            ("Get your XCams URL and stream key", "Log in to your XCams model account, open <strong>broadcast / external encoder</strong>, and copy the <strong>server URL</strong> and <strong>stream key</strong>."),
            ("Connect SplitCam to XCams", "In SplitCam open <strong>Stream Settings</strong>, paste the XCams server URL and stream key into the custom RTMP fields. Set 3,500–6,000 Kbps at 1920×1080, 30 fps, with a 2-second keyframe."),
            ("Click Go Live", "Press <strong>Go Live</strong> in SplitCam, then go online from the model area. Within ~10 seconds your stream reaches XCams' audience."),
        ],
    },
    {
        "slug": "camcontacts", "name": "CamContacts",
        "title": "How to Broadcast on CamContacts with SplitCam — External Encoder",
        "desc": "Broadcast on CamContacts with free SplitCam — external encoder for the long-running pay-per-minute cam site, multi-camera scenes and overlays. No watermark.",
        "kw": "how to broadcast on camcontacts, camcontacts broadcast, camcontacts cam, camcontacts obs, camcontacts external encoder, camcontacts rtmp, cam contacts",
        "h1html": 'How to broadcast on <span class="accent">CamContacts</span> with SplitCam',
        "h1short": "Broadcast on CamContacts",
        "card": "External encoder setup for CamContacts' pay-per-minute cam.",
        "intro": "CamContacts is one of the longest-running independent cam sites — a pay-per-minute model with a mature, loyal audience and a reputation for steady payouts. The performer area supports a standard <strong>external encoder</strong> path that free <strong style='color:var(--text)'>SplitCam</strong> connects to, so you can broadcast with multi-camera scenes, overlays and beauty filters.",
        "quick": "Broadcast on CamContacts with SplitCam: install SplitCam, build your scene, in the performer area open the <em>external encoder / broadcast</em> settings, copy the server URL and stream key, paste into SplitCam, Go Live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Get URL + stream key from the performer area.</li><li>Paste into SplitCam.</li><li>Go Live.</li></ol>",
        "key_how": "Log in to your CamContacts performer account and open the <strong>broadcast / external encoder</strong> settings in the performer area. The page reveals a <strong>server URL</strong> and <strong>stream key</strong> tied to your account — copy both into SplitCam's custom RTMP fields. CamContacts verification is required for the live cam feature.",
        "tips": [
            ("Mature, loyal audience", "CamContacts has run for decades with long-term members — steadier, higher-paying regulars than a churn-heavy free site, slower growth for newcomers."),
            ("Pay-per-minute rewards retention", "Keep viewers in paid time with a polished scene and overlays; production value extends sessions on a per-minute model."),
            ("External encoder unlocks scenes", "Routing through SplitCam's RTMP rather than the basic cam enables multi-camera layouts, overlays and filters."),
            _T_ETH,
        ],
        "faq": [
            ("Does CamContacts support external encoders like SplitCam?", "Yes — the performer area exposes a standard external-encoder / RTMP path. Copy the server URL and stream key into SplitCam after verification."),
            ("Where do I get my CamContacts stream key?", "In the performer area's broadcast / external-encoder settings — both the server URL and stream key appear there. Paste both into SplitCam's custom RTMP fields."),
            ("What bitrate should I use for CamContacts?", "Push 1920×1080 at 30 fps, 3,500–6,000 Kbps with a 2-second keyframe interval. Run SplitCam's speed test first."),
            ("Is SplitCam free to use with CamContacts?", "Yes — SplitCam is free, no watermark and no time limit. CamContacts' external-encoder option is free in the performer area."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays, text, a second camera or your phone, beauty filters or an AI background."),
            ("Get your CamContacts URL and stream key", "Log in to your CamContacts performer account, open the <strong>broadcast / external encoder</strong> settings, and copy the <strong>server URL</strong> and <strong>stream key</strong>."),
            ("Connect SplitCam to CamContacts", "In SplitCam open <strong>Stream Settings</strong>, paste the CamContacts server URL and stream key into the custom RTMP fields. Set 3,500–6,000 Kbps at 1920×1080, 30 fps, with a 2-second keyframe."),
            ("Click Go Live", "Press <strong>Go Live</strong> in SplitCam, then go online from the performer area. Within ~10 seconds your stream reaches CamContacts' audience."),
        ],
    },
    {
        "slug": "royalcams", "name": "RoyalCams",
        "title": "How to Broadcast on RoyalCams with SplitCam — External Encoder",
        "desc": "Broadcast on RoyalCams with free SplitCam — external encoder for the token-based free cam site, multi-camera scenes, overlays and filters. No watermark.",
        "kw": "how to broadcast on royalcams, royalcams broadcast, royalcams cam, royalcams obs, royalcams external encoder, royalcams rtmp, royal cams",
        "h1html": 'How to broadcast on <span class="accent">RoyalCams</span> with SplitCam',
        "h1short": "Broadcast on RoyalCams",
        "card": "External encoder setup for RoyalCams' token cam site.",
        "intro": "RoyalCams is a token-based free cam site — open public rooms funded by tips, with private shows on top. The broadcast settings support a standard <strong>external encoder</strong> path that free <strong style='color:var(--text)'>SplitCam</strong> connects to, so you can stream with multi-camera scenes, overlays and beauty filters instead of a single flat webcam.",
        "quick": "Broadcast on RoyalCams with SplitCam: install SplitCam, build your scene, in your model dashboard open <em>broadcast settings → external encoder</em>, copy the server URL and stream key, paste into SplitCam, Go Live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Get URL + stream key from the dashboard.</li><li>Paste into SplitCam.</li><li>Go Live.</li></ol>",
        "key_how": "Log in to your RoyalCams model account and open the <strong>broadcast settings / external encoder</strong> section. It reveals a <strong>server URL</strong> and <strong>stream key</strong> tied to your account — copy both into SplitCam's custom RTMP fields. Model verification is required before broadcasting.",
        "tips": [
            ("Token rooms reward production", "RoyalCams' public rooms run on tips — tip-goal overlays and a polished scene convert lurkers into tippers and private shows."),
            ("Convert to private shows", "Use a strong public scene to upsell private shows, where the real earnings are on token cam sites."),
            ("External encoder unlocks scenes", "Routing through SplitCam's RTMP rather than the browser cam enables multi-camera layouts, overlays and filters."),
            _T_ETH,
        ],
        "faq": [
            ("Does RoyalCams support external encoders like SplitCam?", "Yes — the broadcast settings expose a standard external-encoder / RTMP path. Copy the server URL and stream key into SplitCam after verification."),
            ("Where do I get my RoyalCams stream key?", "In your model dashboard's broadcast / external-encoder settings — both the server URL and stream key appear there. Paste both into SplitCam's custom RTMP fields."),
            ("What bitrate should I use for RoyalCams?", "Push 1920×1080 at 30 fps, 3,500–6,000 Kbps with a 2-second keyframe interval. Run SplitCam's speed test first."),
            ("Is SplitCam free to use with RoyalCams?", "Yes — SplitCam is free, no watermark and no time limit. RoyalCams' external-encoder option is free in the dashboard."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays, tip-goal text, a second camera or your phone, beauty filters or an AI background."),
            ("Get your RoyalCams URL and stream key", "Log in to your RoyalCams model account, open <strong>broadcast settings → external encoder</strong>, and copy the <strong>server URL</strong> and <strong>stream key</strong>."),
            ("Connect SplitCam to RoyalCams", "In SplitCam open <strong>Stream Settings</strong>, paste the RoyalCams server URL and stream key into the custom RTMP fields. Set 3,500–6,000 Kbps at 1920×1080, 30 fps, with a 2-second keyframe."),
            ("Click Go Live", "Press <strong>Go Live</strong> in SplitCam, then go online from your dashboard. Within ~10 seconds your stream reaches RoyalCams' audience."),
        ],
    },
    {
        "slug": "modelhub", "name": "Modelhub",
        "title": "How to Broadcast on Modelhub with SplitCam — External Encoder",
        "desc": "Broadcast on Modelhub Live with free SplitCam — external encoder for Pornhub's creator platform, multi-camera scenes, overlays and filters. No watermark.",
        "kw": "how to broadcast on modelhub, modelhub live, modelhub broadcast, modelhub obs, modelhub external encoder, modelhub rtmp, modelhub cam",
        "h1html": 'How to broadcast on <span class="accent">Modelhub</span> with SplitCam',
        "h1short": "Broadcast on Modelhub",
        "card": "External encoder setup for Modelhub Live (Pornhub).",
        "intro": "Modelhub is Pornhub's creator platform — video sales, fan subscriptions and a <strong>live cam</strong> product with massive top-of-funnel traffic from the Pornhub network. The model dashboard supports a standard <strong>external encoder</strong> path that free <strong style='color:var(--text)'>SplitCam</strong> connects to, so you can broadcast with multi-camera scenes, overlays and beauty filters.",
        "quick": "Broadcast on Modelhub with SplitCam: install SplitCam, build your scene, in the model dashboard open <em>Live → broadcast / external encoder</em>, copy the server URL and stream key, paste into SplitCam, Go Live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Get URL + stream key from the dashboard.</li><li>Paste into SplitCam.</li><li>Go Live.</li></ol>",
        "key_how": "Log in to your Modelhub model account and open the <strong>Live / broadcast / external encoder</strong> settings in the dashboard. The page reveals a <strong>server URL</strong> and <strong>stream key</strong> tied to your account — copy both into SplitCam's custom RTMP fields. Model verification with the network is required before going live.",
        "tips": [
            ("Huge top-of-funnel traffic", "Modelhub draws viewers from the Pornhub network — a polished SplitCam scene converts that big, casual audience into paying live viewers and subscribers."),
            ("Cross-sell your videos", "Use overlays to point live viewers to your Modelhub videos and subscription — the platform is built for that funnel."),
            ("External encoder unlocks scenes", "Routing through SplitCam's RTMP rather than the basic cam enables multi-camera layouts, overlays and filters."),
            _T_ETH,
        ],
        "faq": [
            ("Does Modelhub support external encoders like SplitCam?", "Yes — the model dashboard exposes a standard external-encoder / RTMP path for Modelhub Live. Copy the server URL and stream key into SplitCam after verification."),
            ("Where do I get my Modelhub stream key?", "In the dashboard's Live / broadcast / external-encoder settings — both the server URL and stream key appear there. Paste both into SplitCam's custom RTMP fields."),
            ("What bitrate should I use for Modelhub?", "Push 1920×1080 at 30 fps, 3,500–6,000 Kbps with a 2-second keyframe interval. Run SplitCam's speed test first."),
            ("Is SplitCam free to use with Modelhub?", "Yes — SplitCam is free, no watermark and no time limit. Modelhub's external-encoder option is free in the dashboard."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays, text, a second camera or your phone, beauty filters or an AI background."),
            ("Get your Modelhub URL and stream key", "Log in to your Modelhub model account, open <strong>Live → broadcast / external encoder</strong>, and copy the <strong>server URL</strong> and <strong>stream key</strong>."),
            ("Connect SplitCam to Modelhub", "In SplitCam open <strong>Stream Settings</strong>, paste the Modelhub server URL and stream key into the custom RTMP fields. Set 3,500–6,000 Kbps at 1920×1080, 30 fps, with a 2-second keyframe."),
            ("Click Go Live", "Press <strong>Go Live</strong> in SplitCam, then go online from the dashboard. Within ~10 seconds your stream reaches Modelhub's audience."),
        ],
    },
    {
        "slug": "xhamsterlive", "name": "xHamsterLive",
        "title": "How to Stream on xHamsterLive with SplitCam (RTMP/OBS)",
        "desc": "Stream on xHamsterLive with free SplitCam over RTMP — multi-camera scenes, overlays and filters. Reach xHamster's mainstream traffic, no watermark.",
        "kw": "how to stream on xhamsterlive, xhamsterlive obs, xhamsterlive rtmp, xhamster live broadcast, xhamsterlive model, x hamster live cam, xhamsterlive studio, xhamster live stream key",
        "h1html": 'How to stream on <span class="accent">xHamsterLive</span> with SplitCam',
        "h1short": "Stream on xHamsterLive",
        "card": "Free SplitCam → RTMP/OBS-style stream to xHamsterLive.",
        "intro": "xHamsterLive is xHamster's live-cam arm — same broadcaster tech as Stripchat, but funnelled through xHamster's mainstream traffic, which is one of the biggest viewer bases in adult. Models broadcast through the xHamsterLive <strong>Studio</strong>, which supports both the in-browser webcam broadcaster and an <strong>external encoder over RTMP</strong>. With free <strong style='color:var(--text)'>SplitCam</strong> you stream as an external encoder for full multi-camera scenes, overlays and filters — or, if you broadcast from the browser, point xHamsterLive at SplitCam as a <strong>virtual camera</strong> for the same effect.",
        "quick": "Stream on xHamsterLive with SplitCam: install SplitCam, build your scene, copy the xHamsterLive Studio server URL + stream key, paste them into SplitCam's RTMP settings, hit Go Live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Copy URL + stream key from xHamsterLive Studio → External Encoder.</li><li>Paste into SplitCam's custom RTMP.</li><li>Click Go Live.</li></ol>",
        "key_how": "xHamsterLive's Studio shows broadcasters an <strong>external encoder</strong> tab with a server URL and a stream key. Paste both into SplitCam's <strong>Stream Settings → Custom RTMP</strong>; pick 4,000–6,000 Kbps at 1920×1080, 30 fps, 2-second keyframe. Click <strong>Go Live</strong> in SplitCam, then go online from the Studio. If you'd rather use the browser broadcaster, open it and select <strong>SplitCam</strong> from the camera dropdown instead — your composed scene replaces your raw webcam.",
        "tips": [
            ("xHamster traffic, Stripchat engine", "Same broadcaster tooling as Stripchat (Studio panel, tipper menu, Lovense) but with xHamster's mainstream funnel — a different audience mix lands on your room."),
            ("Use an external encoder if you can", "RTMP from SplitCam gives you a stable bitrate and full multi-camera/overlay scenes; the browser broadcaster is fine but caps composition options."),
            ("Tip menus convert mainstream viewers", "Many xHamster visitors are new to cam — a clean on-screen tip menu and a goal bar set expectations and lift session conversion."),
            _T_TEST,
        ],
        "faq": [
            ("Is xHamsterLive the same as Stripchat?", "It runs on Stripchat's broadcaster engine, but the brand and traffic source are different — xHamster funnels its mainstream audience here, so the viewer profile differs from a Stripchat-only signup."),
            ("Where do I get the xHamsterLive stream key?", "In the xHamsterLive Studio, open the <em>Broadcast</em> or <em>External Encoder</em> panel — you'll see a server URL and a stream key. Paste both into SplitCam's custom RTMP fields."),
            ("Browser broadcaster or RTMP?", "External encoder (RTMP) is preferred for serious models — stable bitrate and full SplitCam scenes. Browser broadcaster works too: pick SplitCam as the webcam."),
            ("Is SplitCam free to use with xHamsterLive?", "Yes — SplitCam is free, no watermark and no time limit."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays, a tip menu, a second camera or your phone, beauty filters or an AI background — all live."),
            ("Get the xHamsterLive Studio URL + key", "Log into xHamsterLive, open the Studio, switch to <strong>External Encoder</strong>, and copy the <strong>server URL</strong> and your <strong>stream key</strong>."),
            ("Connect SplitCam to xHamsterLive", "In SplitCam → <strong>Stream Settings → Custom RTMP</strong>, paste the URL and key. Set 4,000–6,000 Kbps at 1920×1080, 30 fps, 2-second keyframe."),
            ("Click Go Live", "Hit <strong>Go Live</strong> in SplitCam, then go online from the xHamsterLive Studio. Within ~10 seconds your stream lands on the public list."),
        ],
    },
    {
        "slug": "premium-chat", "name": "Premium.Chat",
        "title": "How to Use SplitCam on Premium.Chat — Paid Video Calls",
        "desc": "Use free SplitCam as your virtual camera on Premium.Chat — accept paid per-minute video calls with multi-camera scenes, overlays and filters. No watermark.",
        "kw": "how to use splitcam on premium chat, premium chat video call, premium chat virtual camera, premium.chat pay per minute, premium chat model, premium chat advisor, premium chat live, video call platform splitcam",
        "h1html": 'How to use SplitCam on <span class="accent">Premium.Chat</span>',
        "h1short": "Premium.Chat with SplitCam",
        "card": "Use SplitCam as your virtual camera for Premium.Chat paid calls.",
        "intro": "Premium.Chat is a paid pay-per-minute platform: you set your per-minute rate for chat, voice or <strong>video calls</strong>, share your personal link, and customers pay to talk to you. Calls run in the browser, which means free <strong style='color:var(--text)'>SplitCam</strong> plugs straight in as a <strong>virtual camera</strong> — multi-camera scenes, overlays, lighting filters and an AI background all reach the caller without changing how Premium.Chat works.",
        "quick": "Use SplitCam on Premium.Chat: install SplitCam, build a clean scene for video calls, accept an incoming Premium.Chat call, and in the call's camera selector pick <em>SplitCam</em>."
                 "<ol><li>Install SplitCam.</li><li>Set up your scene (good light, optional overlay).</li><li>Set your per-minute rate on Premium.Chat.</li><li>Accept the incoming video call.</li><li>Select SplitCam as the camera.</li></ol>",
        "key_how": "Premium.Chat calls happen in the browser. SplitCam installs a virtual webcam called <strong>\"SplitCam Video Driver\"</strong> — when a call starts, click the camera-icon menu in the Premium.Chat call window and switch from your built-in webcam to <strong>SplitCam</strong>. Your composed scene (real camera + overlays + filters) becomes what the caller sees.",
        "tips": [
            ("Premium.Chat is per-minute, not streaming", "Unlike chaturbate-style tipping rooms, you're paid by the minute. Soft lighting, clear audio and an AI background look more like a premium consultation than a public cam."),
            ("Promote your link, not a profile", "Premium.Chat gives you a personal link you can drop on socials, OnlyFans bio or a Linktree — that's how callers find you."),
            ("Overlays only if useful", "For 1-on-1 calls, heavy overlays distract. Use SplitCam for the camera quality, lighting and background — keep the screen mostly you."),
            _T_TEST,
        ],
        "faq": [
            ("How does SplitCam connect to Premium.Chat?", "As a virtual camera. Premium.Chat calls run in the browser; pick SplitCam in the call's camera selector — no stream key, no RTMP."),
            ("Does Premium.Chat support OBS?", "Premium.Chat is browser-based, so OBS plugs in the same way SplitCam does — via virtual camera. SplitCam is the lighter, free option with no watermark."),
            ("Can I use a second camera or overlay on Premium.Chat?", "Yes — compose the scene in SplitCam (second camera, overlays, filters) and Premium.Chat sees one webcam. Use sparingly on 1-on-1 calls."),
            ("Is SplitCam free?", "Yes — free, no watermark and no time limit."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark. It installs a virtual camera the browser can use."),
            ("Set up your scene for calls", "Open SplitCam, add your webcam, set up your light, optionally add an AI background or a subtle overlay. Keep the framing clean — this is a paid call, not a stage."),
            ("Set your rate on Premium.Chat", "Log in to Premium.Chat, set your per-minute rate for video calls and copy your personal link. Share it on socials or in bios."),
            ("Accept the incoming video call", "When a customer pays for time, the call request comes in. Accept it in the Premium.Chat dashboard."),
            ("Select SplitCam as the camera", "In the call window's camera-icon menu, switch from your built-in webcam to <strong>SplitCam</strong>. Your composed scene now reaches the caller."),
        ],
    },
    {
        "slug": "arousr", "name": "Arousr",
        "title": "How to Use SplitCam on Arousr — Sexting & Video Chat",
        "desc": "Use free SplitCam as your virtual camera on Arousr video chats — multi-camera scenes, overlays and filters for paid sexting, voice and video. No watermark.",
        "kw": "how to use splitcam on arousr, arousr video chat, arousr virtual camera, arousr cam girl, arousr model, sexting platform splitcam, arousr live, arousr broadcast",
        "h1html": 'How to use SplitCam on <span class="accent">Arousr</span>',
        "h1short": "Arousr with SplitCam",
        "card": "Use SplitCam as your virtual camera for Arousr video chat.",
        "intro": "Arousr is a paid <strong>sexting + voice + video chat</strong> platform — customers buy credits to text, talk to or video-chat with models, and you're paid per session. The video side runs in the browser (or the Arousr mobile app on phones), which means free <strong style='color:var(--text)'>SplitCam</strong> connects as a <strong>virtual camera</strong> on desktop: multi-camera scenes, overlays, lighting filters and an AI background go straight through to the customer.",
        "quick": "Use SplitCam on Arousr: install SplitCam, set up your scene, accept an incoming Arousr video request, and in the camera selector pick <em>SplitCam</em>."
                 "<ol><li>Install SplitCam.</li><li>Set up scene + lighting.</li><li>Set your sexting/video rates on Arousr.</li><li>Accept the incoming video request.</li><li>Select SplitCam in the camera dropdown.</li></ol>",
        "key_how": "Arousr's web video runs in the browser. SplitCam installs a virtual webcam called <strong>\"SplitCam Video Driver\"</strong> — when a video session starts in the Arousr dashboard, switch the camera in the session window to <strong>SplitCam</strong>. The composed scene (camera + overlays + filters) becomes what the customer sees. On the Arousr mobile app, virtual cameras aren't available — use a real phone camera there and reserve SplitCam for desktop sessions.",
        "tips": [
            ("Sessions are paid by time", "Customers buy credits per minute (or per message for text). Polished video — good light, AI background, beauty filter — pays for itself in longer sessions."),
            ("Sexting first, video upsell", "Most Arousr revenue is text. A short video preview during a sext chat upsells the customer to a full video session — that's where the per-minute rate kicks in."),
            ("Mobile app sessions ≠ desktop", "Virtual cameras work in browser video on desktop. The Arousr mobile app uses the phone camera directly — same workflow, different tool."),
            _T_TEST,
        ],
        "faq": [
            ("How does SplitCam connect to Arousr?", "As a virtual camera. Arousr video chat runs in the browser on desktop — pick SplitCam in the camera selector. No stream key required."),
            ("Does Arousr support OBS?", "Arousr is browser-based, so OBS plugs in the same way as SplitCam — via virtual camera. SplitCam is the free no-watermark option."),
            ("Can I use overlays on a sexting + video session?", "Yes — compose the scene in SplitCam (lighting, overlay, second camera) and Arousr sees a single webcam. Keep overlays light during 1-on-1."),
            ("Is SplitCam free to use with Arousr?", "Yes — free, no watermark and no time limit."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark. It installs a virtual camera the browser can pick."),
            ("Build your scene", "Open SplitCam, add your webcam, dial in lighting, add an optional AI background or beauty filter. Keep it intimate — this is a paid 1-on-1 session, not a public stage."),
            ("Set your rates on Arousr", "Log in to Arousr, set your per-message and per-minute video rate, and make sure your profile is approved so requests can come in."),
            ("Accept the incoming video request", "When a customer initiates a video session from sexting or directly, accept it in the Arousr dashboard."),
            ("Select SplitCam as the camera", "In the session window's camera dropdown, switch from your built-in webcam to <strong>SplitCam</strong>. Your composed scene now reaches the customer."),
        ],
    },
    {
        "slug": "cams-com", "name": "Cams.com",
        "title": "How to Broadcast on Cams.com with SplitCam (RTMP/OBS)",
        "desc": "Broadcast on Cams.com with free SplitCam over RTMP — multi-camera scenes, overlays and filters. Reach AFF's built-in spender base. No watermark.",
        "kw": "how to broadcast on cams.com, cams.com obs, cams.com rtmp, cams.com model, cams.com broadcaster, cams.com stream key, adult friend finder cams, cams.com live, cams com model signup",
        "h1html": 'How to broadcast on <span class="accent">Cams.com</span> with SplitCam',
        "h1short": "Broadcast on Cams.com",
        "card": "Free SplitCam → RTMP stream to the Cams.com / AFF network.",
        "intro": "Cams.com is the cam arm of the AdultFriendFinder network — one of the oldest dating + cam ecosystems online, with a sizeable base of <strong>already-paying members</strong> cross-flowing in from AFF, AmateurMatch and other FriendFinder properties. Models broadcast from the Cams.com <strong>Model Center</strong>, which supports both the in-browser broadcaster and an <strong>external encoder over RTMP</strong>. Free <strong style='color:var(--text)'>SplitCam</strong> streams over RTMP for full multi-camera scenes, overlays and filters — or, in the browser broadcaster, registers as a <strong>virtual camera</strong> for the same result.",
        "quick": "Broadcast on Cams.com: install SplitCam, build your scene, get the Cams.com RTMP server URL + stream key from the Model Center, paste them into SplitCam, click Go Live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Copy server URL + key from Cams.com Model Center → External Encoder.</li><li>Paste into SplitCam's custom RTMP.</li><li>Click Go Live.</li></ol>",
        "key_how": "Cams.com Model Center has an <strong>External Encoder / OBS</strong> tab with a server URL and a stream key. Paste both into SplitCam's <strong>Stream Settings → Custom RTMP</strong>; pick 3,500–5,000 Kbps at 1920×1080, 30 fps, 2-second keyframe. Click <strong>Go Live</strong> in SplitCam, then start your show from the Model Center. If you'd rather use the in-browser broadcaster, pick <strong>SplitCam</strong> from the camera dropdown instead.",
        "tips": [
            ("AFF cross-traffic = paying members", "Cams.com pulls viewers from AdultFriendFinder accounts who already have a payment method on file — different from a fresh signup audience. Conversion to private and tips tends to be higher."),
            ("External encoder beats browser", "RTMP from SplitCam gives a clean bitrate and lets you compose multi-camera scenes with overlays; the browser broadcaster works but limits production."),
            ("Use private show tools", "Cams.com leans on private/exclusive sessions. A tip menu and a clear path to private (in-overlay) lifts revenue per viewer noticeably."),
            _T_TEST,
        ],
        "faq": [
            ("Is Cams.com the same as AdultFriendFinder?", "Same parent network. Cams.com is the cam-broadcasting brand; viewers can arrive through AFF, AmateurMatch and other FriendFinder sites, which is a big part of its traffic."),
            ("Where do I get the Cams.com stream key?", "In the Cams.com Model Center, open the <em>External Encoder</em> or <em>OBS</em> tab — you'll see a server URL and a stream key. Paste both into SplitCam's custom RTMP fields."),
            ("Browser broadcaster or RTMP?", "RTMP (external encoder) is preferred — stable bitrate, full SplitCam scenes. Browser broadcaster works as a fallback: pick SplitCam as the webcam."),
            ("Is SplitCam free to use with Cams.com?", "Yes — SplitCam is free, no watermark and no time limit."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays, a tip menu, a second camera or your phone, beauty filters or an AI background — all live."),
            ("Get your Cams.com URL + stream key", "Log in to the Cams.com Model Center, open the <strong>External Encoder / OBS</strong> tab, and copy the <strong>server URL</strong> and <strong>stream key</strong>."),
            ("Connect SplitCam to Cams.com", "In SplitCam → <strong>Stream Settings → Custom RTMP</strong>, paste the URL and key. Set 3,500–5,000 Kbps at 1920×1080, 30 fps, 2-second keyframe."),
            ("Click Go Live", "Hit <strong>Go Live</strong> in SplitCam, then go online from the Model Center. Your stream lands in the Cams.com / AFF network within ~10 seconds."),
        ],
    },
    {
        "slug": "stripcamfun", "name": "StripCamFun",
        "title": "How to Stream on StripCamFun with SplitCam (RTMP/OBS)",
        "desc": "Stream on StripCamFun with free SplitCam over RTMP — multi-camera scenes, overlays and filters for an indie cam audience. No watermark, no signup.",
        "kw": "how to stream on stripcamfun, stripcamfun obs, stripcamfun rtmp, stripcamfun model, stripcamfun broadcast, strip cam fun model signup, stripcamfun stream key, indie cam site obs",
        "h1html": 'How to stream on <span class="accent">StripCamFun</span> with SplitCam',
        "h1short": "Stream on StripCamFun",
        "card": "Free SplitCam → RTMP/OBS-style stream to StripCamFun.",
        "intro": "StripCamFun is an independent live-cam site — smaller than the Chaturbate-tier giants but with a real, less-saturated audience and noticeably less broadcaster competition per niche. Models broadcast from the StripCamFun model panel, which exposes an <strong>external-encoder / RTMP</strong> option. Free <strong style='color:var(--text)'>SplitCam</strong> connects over RTMP for full multi-camera scenes, overlays and filters — and where a browser broadcaster is offered, SplitCam also registers as a <strong>virtual camera</strong>.",
        "quick": "Stream on StripCamFun: install SplitCam, build your scene, copy the StripCamFun server URL + stream key, paste them into SplitCam's RTMP settings, hit Go Live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Copy URL + stream key from StripCamFun model panel → External Encoder.</li><li>Paste into SplitCam's custom RTMP.</li><li>Click Go Live.</li></ol>",
        "key_how": "Open the StripCamFun model dashboard and the <strong>External Encoder / OBS</strong> section. Copy the server URL and your stream key into SplitCam's <strong>Stream Settings → Custom RTMP</strong>; set 3,500–5,000 Kbps at 1920×1080, 30 fps, 2-second keyframe. Click <strong>Go Live</strong> in SplitCam, then turn yourself online from the dashboard.",
        "tips": [
            ("Smaller pool, easier visibility", "On a Tier-1 site you're one of thousands online; on StripCamFun the broadcaster list is short — a polished SplitCam scene stands out on the homepage faster."),
            ("Cross-broadcast for reach", "Indie cam sites pair well with multi-streaming. Use SplitCam to stream simultaneously to StripCamFun and a larger site to keep tippers from both pools."),
            ("Lean into niche tagging", "Indie audiences search by niche more than star power. Specific tags + a scene overlay that names the niche pulls viewers off the listing."),
            _T_TEST,
        ],
        "faq": [
            ("Where do I get StripCamFun's stream key?", "In the model dashboard, open the <em>External Encoder / OBS</em> tab — you'll see a server URL and a stream key. Paste both into SplitCam's custom RTMP fields."),
            ("Is StripCamFun safe to broadcast on?", "Like any indie cam site, check the model agreement and payout terms before you go live. Use a real email and verify your payout method first."),
            ("Can I multi-stream to StripCamFun and another cam site?", "Yes — SplitCam can push to several custom RTMP endpoints at once. Confirm exclusivity rules on each site first."),
            ("Is SplitCam free to use with StripCamFun?", "Yes — free, no watermark and no time limit."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays, a tip menu, a second camera or your phone, beauty filters or an AI background — all live."),
            ("Get your StripCamFun URL + stream key", "Log in to the StripCamFun model dashboard, open <strong>External Encoder / OBS</strong>, and copy the <strong>server URL</strong> and <strong>stream key</strong>."),
            ("Connect SplitCam to StripCamFun", "In SplitCam → <strong>Stream Settings → Custom RTMP</strong>, paste the URL and key. Set 3,500–5,000 Kbps at 1920×1080, 30 fps, 2-second keyframe."),
            ("Click Go Live", "Hit <strong>Go Live</strong> in SplitCam, then turn yourself online in the StripCamFun dashboard. Your stream lands on the public list within ~10 seconds."),
        ],
    },
    {
        "slug": "mym-fans", "name": "MYM.fans",
        "title": "How to Go Live on MYM.fans with SplitCam — Virtual Camera",
        "desc": "Go live on MYM.fans (the French OnlyFans alternative) with free SplitCam as your virtual camera — multi-camera scenes, overlays and filters. No watermark.",
        "kw": "how to go live on mym, mym.fans live, mym fans virtual camera, mym creator, mym france, mym live stream, mym obs, mym fans broadcast, mym influencer",
        "h1html": 'How to go live on <span class="accent">MYM.fans</span> with SplitCam',
        "h1short": "Go live on MYM.fans",
        "card": "Use SplitCam as your virtual camera for MYM.fans live.",
        "intro": "MYM.fans is the leading French creator-subscription platform — France's answer to OnlyFans, with subscriptions, pay-per-view, tipping and a built-in <strong>live stream</strong> feature for fans. Its broadcaster runs in the browser, so pointing free <strong style='color:var(--text)'>SplitCam</strong> at MYM as a <strong>virtual camera</strong> adds multi-camera scenes, overlays and filters on top of the standard webcam. If your creator dashboard exposes an external-encoder option, SplitCam can also connect over RTMP.",
        "quick": "Go live on MYM.fans with SplitCam: install SplitCam, build your scene, start a live on MYM, and in the broadcaster's camera selector pick <em>SplitCam</em> — then go live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Start a live on MYM.fans.</li><li>Select SplitCam in the camera dropdown.</li><li>Go Live.</li></ol>",
        "key_how": "MYM.fans' live runs in the browser. Build your scene in SplitCam — it registers as a webcam called <strong>\"SplitCam Video Driver\"</strong> — then open MYM's live broadcaster and select <strong>SplitCam</strong> in the camera dropdown. If a <strong>stream-key / external-encoder</strong> option is offered in your creator dashboard, paste it into SplitCam's custom RTMP fields.",
        "tips": [
            ("Biggest French creator platform", "MYM is the #1 fan-platform in France, with a French/European audience that's used to paying in EUR. A polished SplitCam scene + French-language overlays convert better than a plain webcam."),
            ("Virtual camera works without a stream key", "Browser-only live still gets your full SplitCam scene — second camera, overlays, beauty filters or AI background — just by selecting SplitCam as the webcam."),
            ("Cross-sell PPV during the live", "MYM is built around paid content. On-screen overlays promoting your subscription or unlocking PPV messages turn live viewers into paying subscribers."),
            _T_TEST,
        ],
        "faq": [
            ("How does SplitCam connect to MYM.fans?", "MYM live is browser-based, so SplitCam connects as a virtual camera — pick SplitCam in the camera selector. No stream key needed."),
            ("Can I use overlays and multiple cameras on MYM?", "Yes — build the scene in SplitCam (second camera, overlays, AI background); MYM sees the finished scene as one webcam."),
            ("Does MYM.fans support OBS or external encoders?", "Its live is primarily browser/webcam-based. If your dashboard offers a stream-key option, paste it into SplitCam's custom RTMP fields; otherwise use the virtual-camera method."),
            ("Is SplitCam free to use with MYM.fans?", "Yes — SplitCam is free, no watermark and no time limit."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark. It installs a virtual camera the browser can select."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays, text (in French if your audience is FR), a second camera or your phone, beauty filters or an AI background."),
            ("Start a live on MYM.fans", "Log in to your MYM creator account and open the live broadcaster to start a stream for your subscribers."),
            ("Select SplitCam as your camera", "In MYM's camera dropdown, choose <strong>SplitCam</strong> instead of your raw webcam — your composed scene replaces the flat camera. (Or paste a stream key into SplitCam's custom RTMP fields if available.)"),
            ("Go Live", "Start the broadcast — your SplitCam scene, overlays and filters reach your MYM subscribers."),
        ],
    },
    {
        "slug": "fc2-live", "name": "FC2 Live",
        "title": "How to Stream on FC2 Live with SplitCam (RTMP/OBS)",
        "desc": "Stream on FC2 Live (Japan's biggest live-cam site) with free SplitCam over RTMP — multi-camera scenes, overlays and filters. No watermark, no signup.",
        "kw": "how to stream on fc2 live, fc2 live obs, fc2 live rtmp, fc2 live broadcast, fc2 live配信, fc2 live stream key, fc2 live model, fc2 live japan, fc2 ライブ",
        "h1html": 'How to stream on <span class="accent">FC2 Live</span> with SplitCam',
        "h1short": "Stream on FC2 Live",
        "card": "Free SplitCam → RTMP/OBS-style stream to FC2 Live.",
        "intro": "FC2 Live is Japan's biggest live-streaming platform — a massive viewer base, a dedicated adult section and a separate paid-show flow that makes it one of the most lucrative cam markets in Asia. Models broadcast from the FC2 broadcaster panel, which supports both the in-browser broadcaster and an <strong>external encoder over RTMP</strong>. Free <strong style='color:var(--text)'>SplitCam</strong> streams over RTMP for full multi-camera scenes, overlays and filters.",
        "quick": "Stream on FC2 Live with SplitCam: install SplitCam, build your scene, copy the FC2 broadcaster server URL + stream key, paste them into SplitCam's RTMP settings, click Go Live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Copy URL + stream key from FC2 broadcaster panel.</li><li>Paste into SplitCam's custom RTMP.</li><li>Click Go Live.</li></ol>",
        "key_how": "Open the FC2 Live broadcaster panel and switch to <strong>External Encoder / RTMP</strong>. Copy the server URL and your stream key into SplitCam's <strong>Stream Settings → Custom RTMP</strong>; set 3,500–5,000 Kbps at 1920×1080, 30 fps, 2-second keyframe. Click <strong>Go Live</strong> in SplitCam, then start your show from the FC2 dashboard.",
        "tips": [
            ("Huge Japanese audience", "FC2 is Tier 1 in Japan — viewers are local, used to paying in JPY, and lean toward longer paid shows. Japanese overlay text (e.g. tip menu in 円 / JPY) lifts conversion noticeably."),
            ("Adult section is separated", "FC2 has both general and adult lives. Set the room category correctly before going live — adult shows can't be discovered from the general section."),
            ("Use external encoder for stable bitrate", "Japan's mobile-heavy audience is sensitive to dropped frames. RTMP from SplitCam at a steady 4 Mbps beats the browser broadcaster for reliability."),
            _T_TEST,
        ],
        "faq": [
            ("Where do I get the FC2 Live stream key?", "In the FC2 Live broadcaster panel, switch to <em>External Encoder</em> or <em>OBS</em> — you'll see a server URL and a stream key. Paste both into SplitCam's custom RTMP fields."),
            ("Browser broadcaster or RTMP?", "RTMP (external encoder) is preferred — stable bitrate, full SplitCam scenes. Browser broadcaster works as a fallback: pick SplitCam as the webcam."),
            ("Do I need a Japanese account to stream on FC2?", "An FC2 account is required, and adult streaming has additional age-verification steps for the model. Follow FC2's onboarding."),
            ("Is SplitCam free to use with FC2 Live?", "Yes — SplitCam is free, no watermark and no time limit."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays, a tip menu in 円 (JPY), a second camera or your phone, beauty filters or an AI background — all live."),
            ("Get your FC2 Live URL + stream key", "Log in to FC2, open the Live broadcaster panel, switch to <strong>External Encoder</strong>, and copy the <strong>server URL</strong> and your <strong>stream key</strong>."),
            ("Connect SplitCam to FC2 Live", "In SplitCam → <strong>Stream Settings → Custom RTMP</strong>, paste the URL and key. Set 3,500–5,000 Kbps at 1920×1080, 30 fps, 2-second keyframe."),
            ("Click Go Live", "Press <strong>Go Live</strong> in SplitCam, then start the show from the FC2 dashboard. Your stream lands on the public list within ~10 seconds."),
        ],
    },
    {
        "slug": "boosty", "name": "Boosty",
        "title": "How to Go Live on Boosty with SplitCam — Virtual Camera",
        "desc": "Go live on Boosty (Russia's creator platform) with free SplitCam as your virtual camera — multi-camera scenes, overlays and filters. No watermark.",
        "kw": "how to go live on boosty, boosty live, boosty stream, boosty virtual camera, boosty creator, бусти прямой эфир, boosty obs, boosty paid live, boosty subscriber",
        "h1html": 'How to go live on <span class="accent">Boosty</span> with SplitCam',
        "h1short": "Go live on Boosty",
        "card": "Use SplitCam as your virtual camera for Boosty live.",
        "intro": "Boosty is Russia's largest creator-monetization platform — a Patreon-style service with subscriptions, paid posts, tips and a <strong>live broadcast</strong> feature, with a creator audience that includes adult creators alongside mainstream ones. Its live runs in the browser, so connecting free <strong style='color:var(--text)'>SplitCam</strong> as a <strong>virtual camera</strong> adds multi-camera scenes, overlays and filters that subscribers wouldn't get from a plain webcam.",
        "quick": "Go live on Boosty with SplitCam: install SplitCam, build your scene, start a live on Boosty, and select <em>SplitCam</em> in the broadcaster's camera dropdown — then go live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Start a live on Boosty.</li><li>Select SplitCam in the camera dropdown.</li><li>Go Live.</li></ol>",
        "key_how": "Boosty's live runs in the browser. Build your scene in SplitCam — it registers as a webcam called <strong>\"SplitCam Video Driver\"</strong> — then open Boosty's live broadcaster and pick <strong>SplitCam</strong> in the camera dropdown instead of your raw webcam.",
        "tips": [
            ("Russia's biggest creator platform", "Boosty replaced Patreon for many RU creators after sanctions, so the audience is loyal and used to paying in RUB. A polished SplitCam scene with Russian-language overlays converts well."),
            ("Subscriber-tier live shows", "Boosty lets you gate live streams by subscriber tier. SplitCam works with all tiers — the encoder doesn't care which tier the viewer is on, you just stream once and Boosty handles access."),
            ("Tip and pay-per-view overlay", "Boosty supports paid post unlocks and tips. An on-screen overlay that names the tier perks lifts conversions during live streams."),
            _T_TEST,
        ],
        "faq": [
            ("How does SplitCam connect to Boosty?", "Boosty live is browser-based, so SplitCam connects as a virtual camera — pick SplitCam in the camera selector. No stream key needed."),
            ("Can I use overlays on a Boosty live?", "Yes — compose the scene in SplitCam (overlays, second camera, AI background); Boosty sees one webcam. Subscribers get the full composed scene."),
            ("Does Boosty support OBS or external encoders?", "Boosty live is primarily browser-based. If a stream-key option appears in your creator panel, paste it into SplitCam's custom RTMP fields; otherwise use the virtual-camera method."),
            ("Is SplitCam free to use with Boosty?", "Yes — SplitCam is free, no watermark and no time limit."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark. It installs a virtual camera the browser can select."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays (Russian-language for your audience), a second camera or your phone, beauty filters or an AI background."),
            ("Start a live on Boosty", "Log in to your Boosty creator account and open the live broadcaster. Set the tier gating if you want the live behind a paid level."),
            ("Select SplitCam as your camera", "In Boosty's camera dropdown, choose <strong>SplitCam</strong> instead of your raw webcam — your composed scene replaces the flat camera."),
            ("Go Live", "Start the broadcast — your SplitCam scene, overlays and filters reach your Boosty subscribers."),
        ],
    },
    {
        "slug": "amateurcommunity", "name": "AmateurCommunity",
        "title": "How to Stream on AmateurCommunity with SplitCam (RTMP)",
        "desc": "Stream on AmateurCommunity (Germany's biggest amateur cam site) with free SplitCam over RTMP — multi-camera scenes, overlays and filters. No watermark.",
        "kw": "how to stream on amateurcommunity, amateurcommunity obs, amateurcommunity rtmp, amateur community deutschland, amateurcommunity model, ac community broadcast, amateurcommunity live, amateur cam deutschland",
        "h1html": 'How to stream on <span class="accent">AmateurCommunity</span> with SplitCam',
        "h1short": "Stream on AmateurCommunity",
        "card": "Free SplitCam → RTMP stream to AmateurCommunity (DE).",
        "intro": "AmateurCommunity is Germany's biggest amateur cam and content community — running since the early 2000s with a deeply loyal German-speaking audience that's used to paying for content and live shows. Models broadcast from the AC model panel, which supports an <strong>external encoder over RTMP</strong> as well as the in-browser broadcaster. Free <strong style='color:var(--text)'>SplitCam</strong> streams over RTMP for full multi-camera scenes, overlays and filters — German-language overlays speak directly to the local audience.",
        "quick": "Stream on AmateurCommunity: install SplitCam, build your scene, copy the AC server URL + stream key from the model panel, paste them into SplitCam's RTMP settings, click Go Live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Copy URL + stream key from AC model panel.</li><li>Paste into SplitCam's custom RTMP.</li><li>Click Go Live.</li></ol>",
        "key_how": "Open the AmateurCommunity model panel and the <strong>External Encoder / OBS</strong> tab. Copy the server URL and your stream key into SplitCam's <strong>Stream Settings → Custom RTMP</strong>; set 3,500–5,000 Kbps at 1920×1080, 30 fps, 2-second keyframe. Click <strong>Go Live</strong> in SplitCam, then turn yourself online from the panel.",
        "tips": [
            ("German-speaking, German-paying audience", "AmateurCommunity's audience is overwhelmingly DACH (DE/AT/CH) and pays in EUR — overlays, tip menu and on-stream chat in German convert noticeably better than English."),
            ("Premium PPV + live combo", "AC lets you sell PPV content alongside live. A live show that teases the PPV (with an on-screen overlay) tends to lift PPV sales during and after the broadcast."),
            ("External encoder for stable quality", "AC's audience expects high production; RTMP at a steady 4 Mbps from SplitCam beats the browser broadcaster's variable bitrate."),
            _T_TEST,
        ],
        "faq": [
            ("Where do I get the AmateurCommunity stream key?", "In the AC model panel, open the <em>External Encoder</em> or <em>OBS</em> tab — you'll see a server URL and a stream key. Paste both into SplitCam's custom RTMP fields."),
            ("Browser broadcaster or RTMP?", "RTMP (external encoder) is preferred for serious models — stable bitrate, full SplitCam scenes. Browser broadcaster works as a fallback: pick SplitCam as the webcam."),
            ("Do I need to be in Germany to stream on AC?", "No, but the audience is German-speaking. Models from anywhere can register — passing the model verification + tax forms is the main step."),
            ("Is SplitCam free to use with AmateurCommunity?", "Yes — SplitCam is free, no watermark and no time limit."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays (in German — \"Trinkgeld\" / \"PPV freischalten\"), a second camera or your phone, beauty filters or an AI background — all live."),
            ("Get your AmateurCommunity URL + stream key", "Log in to the AC model panel, open <strong>External Encoder / OBS</strong>, and copy the <strong>server URL</strong> and <strong>stream key</strong>."),
            ("Connect SplitCam to AmateurCommunity", "In SplitCam → <strong>Stream Settings → Custom RTMP</strong>, paste the URL and key. Set 3,500–5,000 Kbps at 1920×1080, 30 fps, 2-second keyframe."),
            ("Click Go Live", "Hit <strong>Go Live</strong> in SplitCam, then turn yourself online in the AC model panel. Your stream lands on the public list within ~10 seconds."),
        ],
    },
    {
        "slug": "myfans-jp", "name": "MyFans.jp",
        "title": "How to Go Live on MyFans.jp with SplitCam — Virtual Camera",
        "desc": "Go live on MyFans.jp (Japan's OnlyFans alternative) with free SplitCam as virtual camera — multi-camera scenes, overlays, filters. No watermark.",
        "kw": "how to go live on myfans, myfans.jp live, myfans 配信, myfans virtual camera, myfans creator, マイファンズ, myfans japan, myfans broadcast, myfans subscriber",
        "h1html": 'How to go live on <span class="accent">MyFans.jp</span> with SplitCam',
        "h1short": "Go live on MyFans.jp",
        "card": "Use SplitCam as your virtual camera for MyFans.jp live.",
        "intro": "MyFans.jp is Japan's leading creator-subscription platform — the Japanese answer to OnlyFans, with subscriptions, pay-per-view, tipping (投げ銭) and a built-in <strong>live stream</strong> feature for fans. Its broadcaster runs in the browser, so pointing free <strong style='color:var(--text)'>SplitCam</strong> at MyFans as a <strong>virtual camera</strong> adds multi-camera scenes, overlays and filters that a plain webcam can't deliver. If your creator dashboard offers an external-encoder option, SplitCam can also connect over RTMP.",
        "quick": "Go live on MyFans.jp with SplitCam: install SplitCam, build your scene, start a live on MyFans, and in the broadcaster's camera selector pick <em>SplitCam</em> — then go live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Start a live on MyFans.jp.</li><li>Select SplitCam in the camera dropdown.</li><li>Go Live.</li></ol>",
        "key_how": "MyFans.jp's live runs in the browser. Build your scene in SplitCam — it registers as a webcam called <strong>\"SplitCam Video Driver\"</strong> — then open the MyFans live broadcaster and pick <strong>SplitCam</strong> in the camera dropdown. If a <strong>stream-key / external-encoder</strong> option appears in your creator dashboard, paste it into SplitCam's custom RTMP fields instead.",
        "tips": [
            ("Japan's biggest fan-platform", "MyFans is the #1 creator-subscription platform in Japan, with a JP-native audience that pays in 円 (JPY). Japanese overlays and a polished SplitCam scene convert far better than a plain webcam."),
            ("Virtual camera, no stream key needed", "Browser-only live still gets your full SplitCam scene — second camera, overlays, beauty filters or AI background — by selecting SplitCam as the webcam."),
            ("Cross-sell PPV during the live", "MyFans is built around 投げ銭 (tipping) and paid posts. An on-screen overlay that names your PPV pack or tip-goal lifts revenue noticeably during a live."),
            _T_TEST,
        ],
        "faq": [
            ("How does SplitCam connect to MyFans.jp?", "MyFans live is browser-based, so SplitCam connects as a virtual camera — pick SplitCam in the camera selector. No stream key needed."),
            ("Can I use overlays and multiple cameras on MyFans?", "Yes — build the scene in SplitCam (second camera, overlays, AI background); MyFans sees the finished scene as a single webcam."),
            ("Does MyFans.jp support OBS or external encoders?", "Its live is primarily browser/webcam-based. If a stream-key option appears in your dashboard, paste it into SplitCam's custom RTMP fields; otherwise use the virtual-camera method."),
            ("Is SplitCam free to use with MyFans.jp?", "Yes — SplitCam is free, no watermark and no time limit."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark. It installs a virtual camera the browser can select."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays (in Japanese — 「投げ銭」「PPV解放」 for your audience), a second camera or your phone, beauty filters or an AI background."),
            ("Start a live on MyFans.jp", "Log in to your MyFans creator account and open the live broadcaster (配信) to start a stream for your subscribers."),
            ("Select SplitCam as your camera", "In MyFans' camera dropdown, choose <strong>SplitCam</strong> instead of your raw webcam — your composed scene replaces the flat camera. (Or paste a stream key into SplitCam's custom RTMP fields if available.)"),
            ("Go Live", "Start the broadcast — your SplitCam scene, overlays and filters reach your MyFans subscribers."),
        ],
    },
    {
        "slug": "privacy-com-br", "name": "Privacy.com.br",
        "title": "How to Go Ao Vivo on Privacy.com.br with SplitCam",
        "desc": "Go ao vivo on Privacy.com.br (Brazil's OnlyFans) with free SplitCam as virtual camera — multi-camera scenes, overlays, filters. No watermark, no signup.",
        "kw": "how to go live on privacy, privacy.com.br ao vivo, privacy live, privacy brasil, privacy virtual camera, privacy creator, privacy broadcast, privacy br criadora, privacy assinante",
        "h1html": 'How to go live on <span class="accent">Privacy.com.br</span> with SplitCam',
        "h1short": "Go live on Privacy.com.br",
        "card": "Use SplitCam as your virtual camera for Privacy.com.br ao vivo.",
        "intro": "Privacy.com.br is Brazil's leading creator-subscription platform — the Brazilian answer to OnlyFans, with assinaturas, pay-per-view, gorjetas and a built-in <strong>ao vivo</strong> (live stream) feature for fãs. Its broadcaster runs in the browser, so pointing free <strong style='color:var(--text)'>SplitCam</strong> at Privacy as a <strong>virtual camera</strong> adds multi-camera scenes, overlays and filters that a flat webcam can't deliver. If your creator dashboard offers an external-encoder option, SplitCam can also connect over RTMP.",
        "quick": "Go live on Privacy.com.br with SplitCam: install SplitCam, build your scene, start an ao-vivo on Privacy, and in the broadcaster's camera selector pick <em>SplitCam</em> — then go live."
                 "<ol><li>Install SplitCam.</li><li>Add camera + scene.</li><li>Start an ao vivo on Privacy.com.br.</li><li>Select SplitCam in the camera dropdown.</li><li>Go Live.</li></ol>",
        "key_how": "Privacy.com.br's ao vivo runs in the browser. Build your scene in SplitCam — it registers as a webcam called <strong>\"SplitCam Video Driver\"</strong> — then open the Privacy live broadcaster and pick <strong>SplitCam</strong> in the camera dropdown. If a <strong>stream-key / external-encoder</strong> option is offered, paste it into SplitCam's custom RTMP fields instead.",
        "tips": [
            ("Brazil's biggest fan-platform", "Privacy is the #1 creator-subscription platform in Brazil, with a Portuguese-speaking audience used to paying in BRL via PIX. Overlays in Portuguese + a polished SplitCam scene convert much better than a plain webcam."),
            ("Virtual camera, no stream key needed", "Browser-only live still gets your full SplitCam scene — second camera, overlays, beauty filters or AI background — just by selecting SplitCam as the webcam."),
            ("Tip menus + PPV during ao vivo", "Privacy supports gorjetas (tips) and paid posts. An on-screen overlay that names your PPV pack or meta-de-gorjeta lifts revenue during a live."),
            _T_TEST,
        ],
        "faq": [
            ("How does SplitCam connect to Privacy.com.br?", "Privacy's ao vivo is browser-based, so SplitCam connects as a virtual camera — pick SplitCam in the camera selector. No stream key needed."),
            ("Can I use overlays and multiple cameras on Privacy?", "Yes — build the scene in SplitCam (second camera, overlays, AI background); Privacy sees the finished scene as a single webcam."),
            ("Does Privacy.com.br support OBS or external encoders?", "Its ao vivo is primarily browser/webcam-based. If a stream-key option appears in your dashboard, paste it into SplitCam's custom RTMP fields; otherwise use the virtual-camera method."),
            ("Is SplitCam free to use with Privacy.com.br?", "Yes — SplitCam is free, no watermark and no time limit."),
        ],
        "steps": [
            ("Download and install SplitCam", "SplitCam is free live-streaming software for Windows and macOS — no signup, no card, no watermark. It installs a virtual camera the browser can select."),
            ("Build your scene", "Open SplitCam and add your webcam. Layer in overlays in Portuguese (\"gorjeta\", \"desbloquear PPV\"), a second camera or your phone, beauty filters or an AI background."),
            ("Start an ao vivo on Privacy.com.br", "Log in to your Privacy creator account and open the ao-vivo broadcaster to start a live for your subscribers."),
            ("Select SplitCam as your camera", "In Privacy's camera dropdown, choose <strong>SplitCam</strong> instead of your raw webcam — your composed scene replaces the flat camera. (Or paste a stream key into SplitCam's custom RTMP fields if available.)"),
            ("Go Live", "Start the broadcast — your SplitCam scene, overlays and filters reach your Privacy.com.br subscribers."),
        ],
    },
]
