...
PLATFORMS_EN = [
    ...
    },
    {
        ...
        "kw": "how to add lovense to stream, lovense, lovense cam stream, lovense splitcam toolset, lovense tip alerts, lovense interactive toy streaming, lovense toy overlay",
