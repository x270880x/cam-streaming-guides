...
PLATFORMS_EN = [
    ...
    },
    {
        ...
        "title": "How to Broadcast on Jerkmate with SplitCam — Streamate Network Setup",
        "desc": "Broadcast on Jerkmate with free SplitCam — Jerkmate sources its live models from the Streamate network, so you stream via SM Connect and SplitCam's built-in Streamate channel. Multi-camera scenes, no watermark.",
        "kw": "how to broadcast on jerkmate, become a jerkmate model, jerkmate cam, jerkmate streamate, jerkmate obs, jerkmate external encoder, jerkmate broadcast",
    ...
    },
    {
        ...
        "title": "How to Go Live on JustForFans with SplitCam — Virtual Camera Setup",
        "desc": "Go live on JustForFans (JFF) with free SplitCam — use SplitCam as your virtual camera in the JFF live broadcaster for multi-camera scenes, overlays and filters. No watermark, no signup.",
        "kw": "how to go live on justforfans, justforfans live, jff live stream, justforfans obs, justforfans virtual camera, justfor.fans cam, justforfans broadcast",
