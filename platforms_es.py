...
PLATFORMS_ES = [
    ...
    },
    {
        ...
        "desc": "Añade un juguete Lovense a tu emisión con SplitCam — app Lovense Connect + Cam Extension (soporte SplitCam integrado), con alertas de propinas.",
        "kw": "cómo añadir lovense al stream, lovense, lovense splitcam, lovense splitcam toolset, lovense cam extension, lovense connect, lovense alertas de propinas, lovense juguete interactivo, overlay de juguete lovense",
        ...
        "intro": "Emite tu cam con <strong style='color:var(--text)'>SplitCam</strong> gratis "
                 "y vincula un juguete interactivo <strong style='color:var(--text)'>Lovense</strong> "
                 "para que reaccione a las propinas. Instalas tres cosas: <strong>SplitCam</strong> "
                 "(el codificador), la app <strong>Lovense Connect</strong> (el puente Bluetooth al "
                 "juguete) y la <strong>Lovense Cam Extension</strong> para Chrome/Edge (lee las "
                 "propinas y alimenta el overlay en pantalla). El soporte de SplitCam está integrado "
                 "en la Cam Extension (versión 30.1.4 o más nueva) — SplitCam aparece en la lista "
                 "Video Feedback de la extensión, así que no hay ningún plugin aparte que descargar.",
        "quick": "Para añadir un juguete Lovense a tu emisión: instala SplitCam, la app Lovense "
                 "Connect y la Lovense Cam Extension, vincula el juguete, conecta la extensión a tu "
                 "sitio cam, añade el overlay de Lovense como capa Browser en SplitCam y emite "
                 "normalmente."
                 "<ol><li>Instala SplitCam.</li>"
                 "<li>Instala Lovense Connect y vincula el juguete.</li>"
                 "<li>Instala la Lovense Cam Extension (Chrome/Edge).</li>"
                 "<li>Conecta la extensión a tu sitio cam + añade el overlay en SplitCam.</li>"
                 "<li>Pulsa Go Live.</li></ol>",
        "key_how": "El juguete nunca habla directamente con SplitCam. La cadena es: un espectador da "
                   "una propina en tu sitio cam &rarr; la <strong>Lovense Cam Extension</strong> de tu "
                   "navegador la detecta &rarr; envía un comando a la app <strong>Lovense Connect</strong> "
                   "en localhost &rarr; Connect mueve el juguete por Bluetooth. La única función de "
                   "SplitCam es mostrar el <strong>overlay de Lovense</strong> (estado del juguete + "
                   "propinas recientes) como capa Browser y emitir tu cámara. No existe una app aparte "
                   "llamada \"Lovense Browser\" — es una <em>extensión</em> de navegador para Chrome o Edge.",
        "steps": [
            ("Instala SplitCam",
             "SplitCam es software de streaming gratuito para Windows y macOS — el codificador "
             "que envía tu vídeo a tu plataforma cam. Instálalo; sin marca de agua, sin registro."),
            ("Instala Lovense Connect y vincula tu juguete",
             "Instala la app <strong>Lovense Connect</strong> — de escritorio (Windows / Mac) o la "
             "app móvil en tu teléfono. Este es el "
             "puente que habla con el juguete por Bluetooth. Enciende el juguete y vincúlalo hasta "
             "que la app lo muestre conectado."),
            ("Instala la Lovense Cam Extension",
             "Añade la <strong>Lovense Cam Extension</strong> a Chrome o Edge (versión 30.1.4 o más "
             "nueva) e inicia sesión con tu cuenta de Lovense. No hay un \"Lovense Browser\" aparte "
             "— esta extensión es la que lee las propinas y alimenta el overlay. <strong>El soporte "
             "de SplitCam está integrado</strong>: aparece en la pestaña Video Feedback de la "
             "extensión, así que no necesitas ningún plugin de SplitCam aparte."),
            ("Conecta la extensión a tu sitio cam y añade el overlay en SplitCam",
             "En la Cam Extension, pulsa <strong>+</strong> para añadir tu sitio cam (Chaturbate, "
             "Stripchat, etc.), configura tus niveles de propina, luego abre la pestaña "
             "<strong>Video Feedback</strong> y elige <strong>SplitCam</strong>. Copia la URL del "
             "overlay que te da y añádela como capa <strong>Browser</strong> en tu escena de "
             "SplitCam para que los espectadores vean el estado del juguete y las propinas recientes."),
            ("Monta tu escena y emite",
             "Añade tu cámara y otras superposiciones, pega la clave RTMP de tu plataforma cam "
             "en SplitCam y pulsa <strong>Go Live</strong>. El juguete ya reacciona a las propinas "
             "en tiempo real."),
        ],
        "tips": [
            ("Tres instalaciones, en orden", "SplitCam (codificador) + Lovense Connect (puente "
             "Bluetooth) + Lovense Cam Extension (lectora de propinas / overlay). Si falta "
             "cualquiera, el juguete no reaccionará en la emisión."),
            ("Es una extensión, no un navegador", "No hay un \"Lovense Browser\" aparte que "
             "descargar — la Lovense Cam Extension se instala en Chrome o Edge. Mantenla "
             "actualizada (30.1.4 o más nueva) o SplitCam puede no aparecer en la lista Video Feedback."),
            ("Carga el juguete", "Una batería agotada a mitad de show mata la parte "
             "interactiva — cárgalo del todo antes de emitir."),
            ("Prueba la reacción a las propinas", "Envía una pequeña propina de prueba para "
             "confirmar que el juguete reacciona antes de que la sala sea pública."),
            ("Qué sitios cam están cubiertos", "La Cam Extension cubre oficialmente Chaturbate, "
             "Stripchat, BongaCams, MyFreeCams y CamSoda — para cualquier otro sitio, usa la "
             "integración Generic URL de Lovense. SplitCam funciona con todos ellos como capa de overlay."),
        ],
        "faq": [
            ("¿Qué necesito instalar para usar Lovense con SplitCam?", "Tres cosas: "
             "<strong>SplitCam</strong> (el codificador), la app <strong>Lovense Connect</strong> "
             "(que hace de puente con el juguete por Bluetooth) y la <strong>Lovense Cam "
             "Extension</strong> para Chrome/Edge (lee las propinas y alimenta el overlay). "
             "Sin ningún plugin de SplitCam aparte — el soporte de SplitCam está integrado en la Cam Extension."),
            ("¿La Cam Extension 30.1.4+ funciona con SplitCam de fábrica?", "Sí — el soporte de "
             "SplitCam está integrado. Abre la pestaña <strong>Video Feedback</strong> de la "
             "extensión, elige <strong>SplitCam</strong>, copia la URL del overlay y colócala en una "
             "capa Browser en SplitCam. Sin plugins extra, solo esa vinculación única."),
            ("¿Hay un \"Lovense Browser\" que deba descargar?", "No. No existe un navegador Lovense "
             "aparte — es la <strong>Lovense Cam Extension</strong>, que se instala en Chrome o "
             "Edge. La vinculación del juguete la gestiona una app aparte: Lovense Connect "
             "(escritorio o móvil)."),
            ("¿El juguete se conecta directo a SplitCam?", "No — el juguete se vincula con la app "
             "Lovense Connect por Bluetooth; la Cam Extension lee las propinas y SplitCam solo "
             "muestra el overlay y emite tu cámara."),
            ("¿Qué sitios cam admiten Lovense?", "La Cam Extension de Lovense admite "
             ...
             "variable para otros — consulta la lista actual en la app de Lovense."),
            ("¿Puedo mostrar las propinas recientes en pantalla?", "Sí — la Cam Extension te da una "
             "URL de overlay; añádela como capa Browser en SplitCam y los espectadores verán el "
             "estado del juguete y las propinas recientes."),
        ],
    },
    {
    ...
    },
    {
        ...
        "title": "Cómo emitir en directo en MYM.fans con SplitCam",
        "desc": "Emite en directo en MYM.fans (la OnlyFans francesa) con SplitCam gratis como cámara virtual — escenas multicámara, overlays y filtros.",
        "kw": "cómo emitir en directo en mym, mym.fans directo, mym fans cámara virtual, mym creador, mym francia, mym live stream, mym obs, mym fans emisión, mym influencer",
        "h1html": 'Cómo emitir en directo en <span class="accent">MYM.fans</span> con SplitCam',
        "h1short": "Directo en MYM.fans",
        "card": "Usa SplitCam como cámara virtual para el directo de MYM.fans.",
        "intro": "MYM.fans es la principal plataforma francesa de suscripción para creadores — la respuesta de Francia a OnlyFans, con suscripciones, pago por visión, propinas y una función de <strong>directo</strong> integrada para fans. Su broadcaster funciona en el navegador, así que apuntar <strong style='color:var(--text)'>SplitCam</strong> gratis a MYM como <strong>cámara virtual</strong> añade escenas multicámara, overlays y filtros sobre la webcam estándar. Si tu panel de creador expone una opción de codificador externo, SplitCam también puede conectarse por RTMP.",
        "quick": "Emite en directo en MYM.fans con SplitCam: instala SplitCam, monta tu escena, abre un directo en MYM y, en el selector de cámara del broadcaster, elige <em>SplitCam</em> — luego ponte en directo."
                 "<ol><li>Instala SplitCam.</li><li>Añade cámara + escena.</li><li>Inicia un directo en MYM.fans.</li><li>Elige SplitCam en el desplegable de cámara.</li><li>Pulsa Go Live.</li></ol>",
        "key_how": "El directo de MYM.fans corre en el navegador. Monta tu escena en SplitCam — se registra como una webcam llamada <strong>\"SplitCam Video Driver\"</strong> — y abre el broadcaster de MYM y elige <strong>SplitCam</strong> en el desplegable de cámara. Si tu panel de creador ofrece una opción de <strong>stream key / codificador externo</strong>, pégala en los campos de RTMP personalizado de SplitCam.",
        "tips": [
            ("La mayor plataforma francesa de creadores", "MYM es la plataforma de fans #1 en Francia, con un público francés/europeo acostumbrado a pagar en EUR. Una escena pulida en SplitCam y overlays en francés convierten mejor que una webcam plana."),
            ("La cámara virtual funciona sin stream key", "El directo solo por navegador igualmente lleva tu escena completa de SplitCam — segunda cámara, overlays, filtros de belleza o fondo IA — basta con elegir SplitCam como webcam."),
            ("Vende PPV durante el directo", "MYM está pensada para contenido de pago. Los overlays en pantalla que promocionan tu suscripción o desbloquean mensajes PPV convierten a los espectadores del directo en suscriptores que pagan."),
            _T_TEST,
        ],
        "faq": [
            ("¿Cómo se conecta SplitCam a MYM.fans?", "El directo de MYM funciona en el navegador, así que SplitCam se conecta como cámara virtual — elige SplitCam en el selector de cámara. No hace falta stream key."),
            ("¿Puedo usar overlays y varias cámaras en MYM?", "Sí — monta la escena en SplitCam (segunda cámara, overlays, fondo IA); MYM ve la escena terminada como una sola webcam."),
            ("¿MYM.fans admite OBS o codificadores externos?", "Su directo es principalmente por navegador/webcam. Si tu panel ofrece una opción de stream key, pégala en los campos de RTMP personalizado de SplitCam; si no, usa el método de cámara virtual."),
            ("¿SplitCam es gratis para usar con MYM.fans?", "Sí — SplitCam es gratis, sin marca de agua y sin límite de tiempo."),
        ],
        "steps": [
            ("Descarga e instala SplitCam",
             "SplitCam es software gratuito de streaming en directo para Windows y macOS — sin registro, sin tarjeta, sin marca de agua. Instala una cámara virtual que el navegador puede seleccionar."),
            ("Monta tu escena",
             "Abre SplitCam y añade tu webcam. Suma overlays, texto (en francés si tu audiencia es FR), una segunda cámara o el móvil, filtros de belleza o un fondo IA."),
            ("Inicia un directo en MYM.fans",
             "Inicia sesión en tu cuenta de creador de MYM y abre el broadcaster en directo para empezar una emisión para tus suscriptores."),
            ("Elige SplitCam como cámara",
             "En el desplegable de cámara de MYM, selecciona <strong>SplitCam</strong> en lugar de tu webcam — tu escena compuesta reemplaza la cámara plana. (O pega una stream key en los campos de RTMP personalizado de SplitCam si está disponible.)"),
            ("Pulsa Go Live",
             "Empieza la emisión — tu escena de SplitCam, los overlays y los filtros llegan a tus suscriptores de MYM."),
        ],
    },
    {
        "slug": "fc2-live", "name": "FC2 Live",
        "title": "Cómo emitir en FC2 Live con SplitCam (RTMP/OBS)",
        "desc": "Emite en FC2 Live (el mayor sitio de cam en directo de Japón) con SplitCam gratis por RTMP — escenas multicámara, overlays y filtros. Sin marca de agua.",
        "kw": "cómo emitir en fc2 live, fc2 live obs, fc2 live rtmp, fc2 live emisión, fc2 live stream key, fc2 live modelo, fc2 live japón, fc2 ライブ, fc2 配信",
        "h1html": 'Cómo emitir en <span class="accent">FC2 Live</span> con SplitCam',
        "h1short": "Emitir en FC2 Live",
        "card": "SplitCam gratis → stream RTMP/OBS a FC2 Live.",
        "intro": "FC2 Live es la mayor plataforma de streaming en directo de Japón — una base masiva de espectadores, una sección de adultos dedicada y un flujo separado de shows de pago que la convierten en uno de los mercados cam más lucrativos de Asia. Los modelos emiten desde el panel del broadcaster de FC2, que admite tanto el broadcaster en el navegador como un <strong>codificador externo por RTMP</strong>. <strong style='color:var(--text)'>SplitCam</strong> gratis transmite por RTMP para escenas completas multicámara con overlays y filtros.",
        "quick": "Emite en FC2 Live con SplitCam: instala SplitCam, monta tu escena, copia la URL del servidor y la stream key del broadcaster de FC2, pégalas en los ajustes RTMP de SplitCam y pulsa Go Live."
                 "<ol><li>Instala SplitCam.</li><li>Añade cámara + escena.</li><li>Copia URL + stream key del panel de broadcaster de FC2.</li><li>Pégalas en el RTMP personalizado de SplitCam.</li><li>Pulsa Go Live.</li></ol>",
        "key_how": "Abre el panel del broadcaster de FC2 Live y cambia a <strong>External Encoder / RTMP</strong>. Copia la URL del servidor y tu stream key en <strong>Stream Settings → Custom RTMP</strong> de SplitCam; pon 3.500–5.000 Kbps a 1920×1080, 30 fps y keyframe de 2 segundos. Pulsa <strong>Go Live</strong> en SplitCam y luego empieza tu show desde el dashboard de FC2.",
        "tips": [
            ("Enorme audiencia japonesa", "FC2 es Tier 1 en Japón — los espectadores son locales, acostumbrados a pagar en JPY y propensos a shows de pago largos. Overlays en japonés (por ejemplo, un menú de propinas en 円 / JPY) suben la conversión de forma notable."),
            ("La sección de adultos está separada", "FC2 tiene directos generales y de adultos. Configura la categoría de la sala correctamente antes de salir en directo — los shows para adultos no se descubren desde la sección general."),
            ("Codificador externo para un bitrate estable", "El público japonés es muy móvil y sensible a los fotogramas perdidos. Un RTMP estable desde SplitCam a 4 Mbps gana en fiabilidad al broadcaster del navegador."),
            _T_TEST,
        ],
        "faq": [
            ("¿De dónde saco la stream key de FC2 Live?", "En el panel del broadcaster de FC2 Live, cambia a <em>External Encoder</em> u <em>OBS</em> — verás una URL de servidor y una stream key. Pega ambas en los campos de RTMP personalizado de SplitCam."),
            ("¿Broadcaster por navegador o RTMP?", "El RTMP (codificador externo) es la opción preferida — bitrate estable y escenas completas en SplitCam. El broadcaster por navegador vale como alternativa: elige SplitCam como webcam."),
            ("¿Necesito una cuenta japonesa para emitir en FC2?", "Se requiere una cuenta FC2, y el streaming para adultos tiene pasos adicionales de verificación de edad del modelo. Sigue el onboarding de FC2."),
            ("¿SplitCam es gratis para usar con FC2 Live?", "Sí — SplitCam es gratis, sin marca de agua y sin límite de tiempo."),
        ],
        "steps": [
            ("Descarga e instala SplitCam",
             "SplitCam es software gratuito de streaming en directo para Windows y macOS — sin registro, sin tarjeta, sin marca de agua."),
            ("Monta tu escena",
             "Abre SplitCam y añade tu webcam. Suma overlays, un menú de propinas en 円 (JPY), una segunda cámara o el móvil, filtros de belleza o un fondo IA — todo en directo."),
            ("Saca tu URL y stream key de FC2 Live",
             "Inicia sesión en FC2, abre el panel del broadcaster Live, cambia a <strong>External Encoder</strong> y copia la <strong>URL del servidor</strong> y tu <strong>stream key</strong>."),
            ("Conecta SplitCam a FC2 Live",
             "En SplitCam → <strong>Stream Settings → Custom RTMP</strong>, pega la URL y la key. Pon 3.500–5.000 Kbps a 1920×1080, 30 fps y keyframe de 2 segundos."),
            ("Pulsa Go Live",
             "Pulsa <strong>Go Live</strong> en SplitCam y luego empieza el show desde el dashboard de FC2. En unos 10 segundos tu señal aparece en el listado público."),
        ],
    },
    {
        "slug": "boosty", "name": "Boosty",
        "title": "Cómo emitir en directo en Boosty con SplitCam",
        "desc": "Emite en directo en Boosty (plataforma rusa de creadores) con SplitCam gratis como cámara virtual — escenas multicámara, overlays y filtros.",
        "kw": "cómo emitir en directo en boosty, boosty directo, boosty stream, boosty cámara virtual, boosty creador, бусти прямой эфир, boosty obs, boosty directo de pago, boosty suscriptor",
        "h1html": 'Cómo emitir en directo en <span class="accent">Boosty</span> con SplitCam',
        "h1short": "Directo en Boosty",
        "card": "Usa SplitCam como cámara virtual para el directo de Boosty.",
        "intro": "Boosty es la mayor plataforma de monetización para creadores de Rusia — un servicio al estilo Patreon con suscripciones, posts de pago, propinas y una función de <strong>emisión en directo</strong>, con un público de creadores que incluye tanto a creadores para adultos como mainstream. Su directo corre en el navegador, así que conectar <strong style='color:var(--text)'>SplitCam</strong> gratis como <strong>cámara virtual</strong> añade escenas multicámara, overlays y filtros que los suscriptores no tendrían con una webcam plana.",
        "quick": "Emite en directo en Boosty con SplitCam: instala SplitCam, monta tu escena, inicia un directo en Boosty y selecciona <em>SplitCam</em> en el desplegable de cámara del broadcaster — luego ponte en directo."
                 "<ol><li>Instala SplitCam.</li><li>Añade cámara + escena.</li><li>Inicia un directo en Boosty.</li><li>Elige SplitCam en el desplegable de cámara.</li><li>Pulsa Go Live.</li></ol>",
        "key_how": "El directo de Boosty corre en el navegador. Monta tu escena en SplitCam — se registra como una webcam llamada <strong>\"SplitCam Video Driver\"</strong> — y abre el broadcaster en directo de Boosty y elige <strong>SplitCam</strong> en el desplegable de cámara en lugar de tu webcam.",
        "tips": [
            ("La mayor plataforma de creadores de Rusia", "Boosty sustituyó a Patreon para muchos creadores rusos tras las sanciones, así que la audiencia es fiel y está acostumbrada a pagar en RUB. Una escena pulida en SplitCam con overlays en ruso convierte bien."),
            ("Directos por nivel de suscripción", "Boosty te permite restringir los directos por nivel de suscriptor. SplitCam funciona con todos los niveles — al codificador le da igual qué nivel tiene el espectador, tú emites una sola vez y Boosty gestiona el acceso."),
            ("Overlay de propinas y pago por visión", "Boosty admite desbloqueos de posts de pago y propinas. Un overlay en pantalla que enumere las ventajas del nivel sube la conversión durante el directo."),
            _T_TEST,
        ],
        "faq": [
            ("¿Cómo se conecta SplitCam a Boosty?", "El directo de Boosty funciona en el navegador, así que SplitCam se conecta como cámara virtual — elige SplitCam en el selector de cámara. No hace falta stream key."),
            ("¿Puedo usar overlays en un directo de Boosty?", "Sí — compón la escena en SplitCam (overlays, segunda cámara, fondo IA); Boosty ve una sola webcam. Los suscriptores reciben la escena compuesta completa."),
            ("¿Boosty admite OBS o codificadores externos?", "El directo de Boosty es principalmente por navegador. Si aparece una opción de stream key en tu panel de creador, pégala en los campos de RTMP personalizado de SplitCam; si no, usa el método de cámara virtual."),
            ("¿SplitCam es gratis para usar con Boosty?", "Sí — SplitCam es gratis, sin marca de agua y sin límite de tiempo."),
        ],
        "steps": [
            ("Descarga e instala SplitCam",
             "SplitCam es software gratuito de streaming en directo para Windows y macOS — sin registro, sin tarjeta, sin marca de agua. Instala una cámara virtual que el navegador puede seleccionar."),
            ("Monta tu escena",
             "Abre SplitCam y añade tu webcam. Suma overlays (en ruso para tu audiencia), una segunda cámara o el móvil, filtros de belleza o un fondo IA."),
            ("Inicia un directo en Boosty",
             "Inicia sesión en tu cuenta de creador de Boosty y abre el broadcaster en directo. Configura la restricción por nivel si quieres el directo detrás de un nivel de pago."),
            ("Elige SplitCam como cámara",
             "En el desplegable de cámara de Boosty, elige <strong>SplitCam</strong> en lugar de tu webcam — tu escena compuesta reemplaza la cámara plana."),
            ("Pulsa Go Live",
             "Empieza la emisión — tu escena de SplitCam, los overlays y los filtros llegan a tus suscriptores de Boosty."),
        ],
    },
    {
        "slug": "amateurcommunity", "name": "AmateurCommunity",
        "title": "Cómo emitir en AmateurCommunity con SplitCam (RTMP)",
        "desc": "Emite en AmateurCommunity (el mayor sitio cam amateur alemán) con SplitCam gratis por RTMP — escenas multicámara, overlays y filtros.",
        "kw": "cómo emitir en amateurcommunity, amateurcommunity obs, amateurcommunity rtmp, amateur community deutschland, amateurcommunity modelo, ac community emisión, amateurcommunity directo, amateur cam deutschland",
        "h1html": 'Cómo emitir en <span class="accent">AmateurCommunity</span> con SplitCam',
        "h1short": "Emitir en AmateurCommunity",
        "card": "SplitCam gratis → stream RTMP a AmateurCommunity (DE).",
        "intro": "AmateurCommunity es la mayor comunidad cam y de contenido amateur de Alemania — en marcha desde principios de los 2000 con un público germanohablante profundamente fiel y acostumbrado a pagar por contenido y shows en directo. Los modelos emiten desde el panel de modelo de AC, que admite un <strong>codificador externo por RTMP</strong> además del broadcaster en el navegador. <strong style='color:var(--text)'>SplitCam</strong> gratis transmite por RTMP para escenas completas multicámara con overlays y filtros — los overlays en alemán hablan directamente al público local.",
        "quick": "Emite en AmateurCommunity: instala SplitCam, monta tu escena, copia la URL del servidor y la stream key de AC desde el panel de modelo, pégalas en los ajustes RTMP de SplitCam y pulsa Go Live."
                 "<ol><li>Instala SplitCam.</li><li>Añade cámara + escena.</li><li>Copia URL + stream key del panel de modelo de AC.</li><li>Pégalas en el RTMP personalizado de SplitCam.</li><li>Pulsa Go Live.</li></ol>",
        "key_how": "Abre el panel de modelo de AmateurCommunity y la pestaña <strong>External Encoder / OBS</strong>. Copia la URL del servidor y tu stream key en <strong>Stream Settings → Custom RTMP</strong> de SplitCam; pon 3.500–5.000 Kbps a 1920×1080, 30 fps y keyframe de 2 segundos. Pulsa <strong>Go Live</strong> en SplitCam y luego ponte online desde el panel.",
        "tips": [
            ("Audiencia germanohablante que paga en EUR", "El público de AmateurCommunity es mayoritariamente DACH (DE/AT/CH) y paga en EUR — los overlays, el menú de propinas y el chat en directo en alemán convierten bastante mejor que en inglés."),
            ("Combo de PPV premium + directo", "AC te deja vender contenido PPV junto al directo. Un show en directo que adelante el PPV (con un overlay en pantalla) suele subir las ventas de PPV durante y después de la emisión."),
            ("Codificador externo para calidad estable", "El público de AC espera producción alta; un RTMP estable desde SplitCam a 4 Mbps gana al bitrate variable del broadcaster del navegador."),
            _T_TEST,
        ],
        "faq": [
            ("¿De dónde saco la stream key de AmateurCommunity?", "En el panel de modelo de AC, abre la pestaña <em>External Encoder</em> u <em>OBS</em> — verás una URL de servidor y una stream key. Pega ambas en los campos de RTMP personalizado de SplitCam."),
            ("¿Broadcaster por navegador o RTMP?", "El RTMP (codificador externo) es la opción preferida para modelos serios — bitrate estable y escenas completas en SplitCam. El broadcaster por navegador vale como alternativa: elige SplitCam como webcam."),
            ("¿Tengo que estar en Alemania para emitir en AC?", "No, pero la audiencia es germanohablante. Los modelos de cualquier país pueden registrarse — pasar la verificación de modelo y los formularios fiscales es el paso principal."),
            ("¿SplitCam es gratis para usar con AmateurCommunity?", "Sí — SplitCam es gratis, sin marca de agua y sin límite de tiempo."),
        ],
        "steps": [
            ("Descarga e instala SplitCam",
             "SplitCam es software gratuito de streaming en directo para Windows y macOS — sin registro, sin tarjeta, sin marca de agua."),
            ("Monta tu escena",
             "Abre SplitCam y añade tu webcam. Suma overlays (en alemán — \"Trinkgeld\" / \"PPV freischalten\"), una segunda cámara o el móvil, filtros de belleza o un fondo IA — todo en directo."),
            ("Saca tu URL y stream key de AmateurCommunity",
             "Inicia sesión en el panel de modelo de AC, abre <strong>External Encoder / OBS</strong> y copia la <strong>URL del servidor</strong> y la <strong>stream key</strong>."),
            ("Conecta SplitCam a AmateurCommunity",
             "En SplitCam → <strong>Stream Settings → Custom RTMP</strong>, pega la URL y la key. Pon 3.500–5.000 Kbps a 1920×1080, 30 fps y keyframe de 2 segundos."),
            ("Pulsa Go Live",
             "Pulsa <strong>Go Live</strong> en SplitCam y luego ponte online en el panel de modelo de AC. En unos 10 segundos tu señal aparece en el listado público."),
        ],
    },
    {
        "slug": "myfans-jp", "name": "MyFans.jp",
        "title": "Cómo emitir en directo en MyFans.jp con SplitCam",
        "desc": "Emite en directo en MyFans.jp (el OnlyFans japonés) con SplitCam gratis como cámara virtual — escenas multicámara, overlays y filtros. Sin marca de agua.",
        "kw": "cómo emitir en directo en myfans, myfans.jp directo, myfans 配信, myfans cámara virtual, myfans creador, マイファンズ, myfans japón, myfans emisión, myfans suscriptor",
        "h1html": 'Cómo emitir en directo en <span class="accent">MyFans.jp</span> con SplitCam',
        "h1short": "Directo en MyFans.jp",
        "card": "Usa SplitCam como cámara virtual para el directo de MyFans.jp.",
        "intro": "MyFans.jp es la principal plataforma de suscripción a creadores de Japón — la respuesta nipona a OnlyFans, con suscripciones, pago por visión, propinas (投げ銭) y una función integrada de <strong>directo</strong> para los fans. Su broadcaster corre en el navegador, así que conectar <strong style='color:var(--text)'>SplitCam</strong> gratis a MyFans como <strong>cámara virtual</strong> añade escenas multicámara, overlays y filtros que una webcam plana no puede ofrecer. Si tu panel de creador habilita la opción de codificador externo, SplitCam también se conecta por RTMP.",
        "quick": "Emite en directo en MyFans.jp con SplitCam: instala SplitCam, monta tu escena, inicia un directo en MyFans y elige <em>SplitCam</em> en el desplegable de cámara del broadcaster — luego ponte en directo."
                 "<ol><li>Instala SplitCam.</li><li>Añade cámara + escena.</li><li>Inicia un directo en MyFans.jp.</li><li>Elige SplitCam en el desplegable de cámara.</li><li>Pulsa Go Live.</li></ol>",
        "key_how": "El directo de MyFans.jp corre en el navegador. Monta tu escena en SplitCam — se registra como una webcam llamada <strong>\"SplitCam Video Driver\"</strong> — y abre el broadcaster en directo de MyFans y elige <strong>SplitCam</strong> en el desplegable de cámara. Si en tu panel de creador aparece la opción de <strong>stream key / codificador externo</strong>, pégala en los campos de RTMP personalizado de SplitCam.",
        "tips": [
            ("La mayor plataforma de fans de Japón", "MyFans es la plataforma de suscripción a creadores nº 1 en Japón, con un público nativo nipón que paga en 円 (JPY). Overlays en japonés y una escena pulida en SplitCam convierten mucho mejor que una webcam plana."),
            ("Cámara virtual, sin necesidad de stream key", "Aun siendo solo navegador, el directo recibe tu escena completa de SplitCam — segunda cámara, overlays, filtros de belleza o fondo IA — basta con seleccionar SplitCam como webcam."),
            ("Promociona PPV durante el directo", "MyFans gira en torno a 投げ銭 (propinas) y posts de pago. Un overlay en pantalla que nombre tu pack PPV o tu meta de propinas sube notablemente los ingresos durante un directo."),
            _T_TEST,
        ],
        "faq": [
            ("¿Cómo se conecta SplitCam a MyFans.jp?", "El directo de MyFans funciona en el navegador, así que SplitCam se conecta como cámara virtual — elige SplitCam en el selector de cámara. No hace falta stream key."),
            ("¿Puedo usar overlays y varias cámaras en MyFans?", "Sí — monta la escena en SplitCam (segunda cámara, overlays, fondo IA); MyFans ve la escena terminada como una sola webcam."),
            ("¿MyFans.jp admite OBS o codificadores externos?", "Su directo es principalmente por navegador/webcam. Si en tu panel aparece la opción de stream key, pégala en los campos de RTMP personalizado de SplitCam; si no, usa el método de cámara virtual."),
            ("¿SplitCam es gratis para usar con MyFans.jp?", "Sí — SplitCam es gratis, sin marca de agua y sin límite de tiempo."),
        ],
        "steps": [
            ("Descarga e instala SplitCam",
             "SplitCam es software gratuito de streaming en directo para Windows y macOS — sin registro, sin tarjeta, sin marca de agua. Instala una cámara virtual que el navegador puede seleccionar."),
            ("Monta tu escena",
             "Abre SplitCam y añade tu webcam. Suma overlays (en japonés — 「投げ銭」「PPV解放」 para tu audiencia), una segunda cámara o el móvil, filtros de belleza o un fondo IA."),
            ("Inicia un directo en MyFans.jp",
             "Inicia sesión en tu cuenta de creador de MyFans y abre el broadcaster en directo (配信) para empezar la emisión para tus suscriptores."),
            ("Elige SplitCam como cámara",
             "En el desplegable de cámara de MyFans, elige <strong>SplitCam</strong> en lugar de tu webcam — tu escena compuesta reemplaza la cámara plana. (O pega una stream key en los campos de RTMP personalizado de SplitCam si está disponible.)"),
            ("Pulsa Go Live",
             "Empieza la emisión — tu escena de SplitCam, los overlays y los filtros llegan a tus suscriptores de MyFans."),
        ],
    },
    {
        "slug": "privacy-com-br", "name": "Privacy.com.br",
        "title": "Cómo emitir ao vivo en Privacy.com.br con SplitCam",
        "desc": "Emite ao vivo en Privacy.com.br (el OnlyFans de Brasil) con SplitCam gratis como cámara virtual — escenas multicámara, overlays, filtros. Sin marca.",
        "kw": "cómo emitir en directo en privacy, privacy.com.br ao vivo, privacy directo, privacy brasil, privacy cámara virtual, privacy creadora, privacy emisión, privacy br criadora, privacy assinante",
        "h1html": 'Cómo emitir en directo en <span class="accent">Privacy.com.br</span> con SplitCam',
        "h1short": "Directo en Privacy.com.br",
        "card": "Usa SplitCam como cámara virtual para el ao vivo de Privacy.com.br.",
        "intro": "Privacy.com.br es la principal plataforma de suscripción a creadores de Brasil — la respuesta brasileña a OnlyFans, con assinaturas, pago por visión, gorjetas y una función integrada de <strong>ao vivo</strong> (directo) para los fãs. Su broadcaster corre en el navegador, así que conectar <strong style='color:var(--text)'>SplitCam</strong> gratis a Privacy como <strong>cámara virtual</strong> añade escenas multicámara, overlays y filtros que una webcam plana no puede ofrecer. Si tu panel de creador habilita la opción de codificador externo, SplitCam también se conecta por RTMP.",
        "quick": "Emite ao vivo en Privacy.com.br con SplitCam: instala SplitCam, monta tu escena, inicia un ao-vivo en Privacy y elige <em>SplitCam</em> en el desplegable de cámara del broadcaster — luego ponte en directo."
                 "<ol><li>Instala SplitCam.</li><li>Añade cámara + escena.</li><li>Inicia un ao vivo en Privacy.com.br.</li><li>Elige SplitCam en el desplegable de cámara.</li><li>Pulsa Go Live.</li></ol>",
        "key_how": "El ao vivo de Privacy.com.br corre en el navegador. Monta tu escena en SplitCam — se registra como una webcam llamada <strong>\"SplitCam Video Driver\"</strong> — y abre el broadcaster en directo de Privacy y elige <strong>SplitCam</strong> en el desplegable de cámara. Si se ofrece la opción de <strong>stream key / codificador externo</strong>, pégala en los campos de RTMP personalizado de SplitCam.",
        "tips": [
            ("La mayor plataforma de fans de Brasil", "Privacy es la plataforma de suscripción a creadores nº 1 en Brasil, con un público lusoparlante acostumbrado a pagar en BRL vía PIX. Overlays en portugués + una escena pulida en SplitCam convierten mucho mejor que una webcam plana."),
            ("Cámara virtual, sin necesidad de stream key", "Aun siendo solo navegador, el directo recibe tu escena completa de SplitCam — segunda cámara, overlays, filtros de belleza o fondo IA — basta con seleccionar SplitCam como webcam."),
            ("Menús de propinas + PPV durante el ao vivo", "Privacy admite gorjetas (propinas) y posts de pago. Un overlay en pantalla que nombre tu pack PPV o la meta-de-gorjeta sube los ingresos durante el directo."),
            _T_TEST,
        ],
        "faq": [
            ("¿Cómo se conecta SplitCam a Privacy.com.br?", "El ao vivo de Privacy funciona en el navegador, así que SplitCam se conecta como cámara virtual — elige SplitCam en el selector de cámara. No hace falta stream key."),
            ("¿Puedo usar overlays y varias cámaras en Privacy?", "Sí — monta la escena en SplitCam (segunda cámara, overlays, fondo IA); Privacy ve la escena terminada como una sola webcam."),
            ("¿Privacy.com.br admite OBS o codificadores externos?", "Su ao vivo es principalmente por navegador/webcam. Si en tu panel aparece la opción de stream key, pégala en los campos de RTMP personalizado de SplitCam; si no, usa el método de cámara virtual."),
            ("¿SplitCam es gratis para usar con Privacy.com.br?", "Sí — SplitCam es gratis, sin marca de agua y sin límite de tiempo."),
        ],
        "steps": [
            ("Descarga e instala SplitCam",
             "SplitCam es software gratuito de streaming en directo para Windows y macOS — sin registro, sin tarjeta, sin marca de agua. Instala una cámara virtual que el navegador puede seleccionar."),
            ("Monta tu escena",
             "Abre SplitCam y añade tu webcam. Suma overlays en portugués (\"gorjeta\", \"desbloquear PPV\"), una segunda cámara o el móvil, filtros de belleza o un fondo IA."),
            ("Inicia un ao vivo en Privacy.com.br",
             "Inicia sesión en tu cuenta de creadora de Privacy y abre el broadcaster de ao-vivo para empezar un directo para tus suscriptores."),
            ("Elige SplitCam como cámara",
             "En el desplegable de cámara de Privacy, elige <strong>SplitCam</strong> en lugar de tu webcam — tu escena compuesta reemplaza la cámara plana. (O pega una stream key en los campos de RTMP personalizado de SplitCam si está disponible.)"),
            ("Pulsa Go Live",
             "Empieza la emisión — tu escena de SplitCam, los overlays y los filtros llegan a tus suscriptores de Privacy.com.br."),
        ],
    },
]
