...
PLATFORMS_ES = [
    {
        ...
        "kw": "cómo transmitir en chaturbate, chaturbate broadcast token, chaturbate rtmp obs, chaturbate codificador externo, chaturbate live stream",
    ...
    },
    {
        ...
        "kw": "cómo transmitir en cam4, cam4 external encoder, cam4 stream key, cam4 rtmp obs, cam4 broadcast",
    ...
    },
    {
        ...
        "title": "Cómo transmitir en BongaCams con SplitCam — codificador externo",
        ...
        "kw": "bongacams, bongcams, cómo transmitir en bongacams, bongacams external encoder, bongacams rtmp obs",
    ...
    },
    {
        ...
        "kw": "strip cam, stripchat live, cómo transmitir en stripchat, stripchat external software, stripchat stream key, stripchat rtmp obs",
    ...
    },
    {
        ...
        "title": "Cómo transmitir en directo en OnlyFans con SplitCam — autorización o clave",
        ...
        "kw": "cómo transmitir en directo en onlyfans, onlyfans live, onlyfans autorización splitcam, onlyfans obs key, onlyfans software de emisión",
    ...
    },
    {
        ...
        "kw": "cómo transmitir en camplace, camplace software de emisión, camplace rtmp, camplace external encoder",
    ...
    },
    {
        ...
        "title": "Cómo transmitir en CamSoda con SplitCam — Use OBS Broadcaster",
        ...
        "kw": "camsoda live, cómo transmitir en camsoda, camsoda obs broadcaster, camsoda rtmp, camsoda live broadcast",
    ...
    },
    {
        ...
        "kw": "streamate, streamate sm connect, cómo transmitir en streamate, streamate software de emisión, streamate rtmp",
    ...
    },
    {
        ...
        "title": "Cómo transmitir en StreamRay con SplitCam — URL desde el chat",
        ...
        "kw": "streamray, streamray cam, cómo transmitir en streamray, streamray obs broadcaster, streamray rtmp",
    ...
    },
    {
        ...
        "title": "Cómo transmitir en XLoveCam con SplitCam — enlace RTMP y clave",
        ...
        "kw": "xlovecam, x love cam, cómo transmitir en xlovecam, xlovecam rtmp, xlovecam stream key",
    ...
    },
    {
        ...
        "kw": "soul cams, soulcams, cómo transmitir en soulcams, soulcams obs, soulcams rtmp",
    ...
    },
    {
        ...
        "kw": "im live stream, imlive splitcam, cómo transmitir en imlive, imlive cámara virtual, imlive webcam",
    ...
    },
    {
        ...
        "kw": "vxlive, visit-x, vxmodels splitcam, cómo transmitir en vxlive, visit-x splitcam, vxlive rtmp",
    ...
    },
    {
        ...
        "title": "Cómo transmitir en VirtWish con SplitCam — URL del stream y clave",
        ...
        "kw": "virtwish, cómo transmitir en virtwish, virtwish software de emisión, virtwish rtmp, virtwish stream key, virtwish obs",
    ...
    },
    {
        ...
        "kw": "xmodels, cómo transmitir en xmodels, xmodels software de emisión, xmodels rtmp, xmodels codificador externo",
    ...
    },
    {
        ...
        "title": "Cómo transmitir en Flirt4Free con SplitCam — External Broadcast Form",
        ...
        "kw": "flirt for free cam, flirt 4 free cam, flirt4free, cómo transmitir en flirt4free, flirt4free external broadcast, flirt4free rtmp",
    ...
    },
    {
        ...
        "kw": "transmitir en varios sitios cam, multistream cam, transmitir en chaturbate y bongacams a la vez, software de multiemisión cam",
    ...
    },
    {
        ...
        "title": "Cómo transmitir en LiveJasmin con SplitCam — codificador externo HD",
        "desc": "Transmite en LiveJasmin con SplitCam gratis — codificador externo del Model Center, configuración HD 1080p, escenas multicámara y overlays. Sin marca de agua, sin registro.",
        "kw": "transmitir en livejasmin, livejasmin obs, livejasmin codificador externo, livejasmin rtmp, livejasmin stream key, configurar modelo livejasmin",
    ...
    },
    {
        ...
        "title": "Cómo transmitir en MyFreeCams (MFC) con SplitCam — bypass del Model Web Broadcaster",
        "desc": "Transmite en MyFreeCams con SplitCam gratis — opción de broadcaster externo del Model Admin, economía de tokens MFC, escenas multicámara, overlays. Sin marca de agua, sin registro.",
    ...
    },
    {
        ...
        "title": "Cómo transmitir en Cherry.tv con SplitCam — codificador externo Web3-friendly",
        "desc": "Transmite en Cherry.tv con SplitCam gratis — codificador externo del Streamer Dashboard, plataforma cam cripto-friendly, escenas multicámara. Sin marca de agua, sin registro.",
        "kw": "transmitir cherry tv, cherry.tv obs, cherry tv codificador externo, cherry.tv rtmp, cherry.tv stream key, cherry tv streamer, cam web3",
    ...
    },
    {
        ...
        "title": "Cómo transmitir en AmateurTV con SplitCam — la red cam en español de toda la vida",
        "desc": "Transmite en AmateurTV con SplitCam gratis — codificador externo del Model Panel, red cam hispanohablante (España y LatAm), escenas multicámara. Sin marca de agua, sin registro.",
        "kw": "transmitir en amateurtv, amateur.tv obs, amateurtv codificador externo, amateurtv rtmp, amateurtv stream key, modelos amateur tv",
    ...
    },
    {
        ...
        "title": "Cómo transmitir en Camster con SplitCam — codificador externo del Model Hub",
        "desc": "Transmite en Camster con SplitCam gratis — codificador externo del Model Hub, plataforma cam mid-tier asentada, escenas multicámara y overlays. Sin marca de agua, sin registro.",
        "kw": "transmitir camster, camster.com obs, camster codificador externo, camster rtmp, camster stream key, camster model hub",
    ...
    },
    {
        ...
        "title": "Cómo transmitir en Camversity con SplitCam — codificador externo del Performer Dashboard",
        "desc": "Transmite en Camversity con SplitCam gratis — codificador externo del Performer Dashboard, plataforma cam independiente en crecimiento, escenas multicámara. Sin marca de agua, sin registro.",
        "kw": "transmitir camversity, camversity obs, camversity codificador externo, camversity rtmp, camversity stream key, camversity performer",
    ...
    },
    {
        ...
        "title": "Cómo transmitir en iFriends con SplitCam — codificador externo del Model Center",
        "desc": "Transmite en iFriends con SplitCam gratis — codificador externo del Model Center, red cam independiente veterana, escenas multicámara. Sin marca de agua, sin registro.",
        "kw": "transmitir ifriends, ifriends obs, ifriends codificador externo, ifriends rtmp, ifriends stream key, ifriends model center, ifriends.net",
    ...
    },
    {
        ...
        "title": "Cómo transmitir en Babestation con SplitCam — configuración de la red cam del Reino Unido",
        "desc": "Transmite en Babestation con SplitCam gratis — codificador externo del Performer Hub, red británica de TV adulta y cam, escenas multicámara y overlays. Sin marca de agua, sin registro.",
        "kw": "transmitir babestation, babestation cam, babestation obs, babestation codificador externo, babestation rtmp, babestation performer, red cam reino unido",
    ...
    },
    {
        ...
        "title": "Cómo transmitir en AdultWork con SplitCam — codificador externo del Members Area",
        "desc": "Transmite en AdultWork con SplitCam gratis — codificador externo del Members Area, marketplace británico de servicios adultos con función cam, escenas multicámara. Sin marca de agua, sin registro.",
        "kw": "transmitir adultwork, adultwork cam, adultwork obs, adultwork codificador externo, adultwork rtmp, adultwork webcam, cam reino unido",
    ...
    },
    {
        ...
        "title": "Cómo transmitir en Jerkmate con SplitCam — setup de la red Streamate",
        "desc": "Transmite en Jerkmate con SplitCam gratis — Jerkmate saca sus modelos en directo de la red Streamate, así que emites vía SM Connect y el canal Streamate integrado de SplitCam. Escenas multicámara, sin marca de agua.",
        "kw": "cómo transmitir en jerkmate, ser modelo de jerkmate, jerkmate cam, jerkmate streamate, jerkmate obs, jerkmate codificador externo, jerkmate broadcast",
    ...
    },
    {
        ...
        "title": "Cómo transmitir en directo en JustForFans con SplitCam — cámara virtual",
        "desc": "Transmite en directo en JustForFans (JFF) con SplitCam gratis — usa SplitCam como cámara virtual en el broadcaster en directo de JFF para escenas multicámara, superposiciones y filtros. Sin marca de agua, sin registro.",
        "kw": "cómo transmitir en directo en justforfans, justforfans live, jff live stream, justforfans obs, justforfans cámara virtual, justfor.fans cam, justforfans broadcast",
