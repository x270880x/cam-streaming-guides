...
PLATFORMS_DA = [
    ...
    {"slug": "lovense", "name": "Lovense",
     ...
     "desc": "Forbind et Lovense-legetøj til SplitCam-streamen — Lovense Connect-app, Cam Extension og officielt SplitCam Toolset, med tip-alerts på skærmen.",
     ...
     "steps": [
         ...
         ("Installér Lovense Connect og par legetøjet",
          "Installér <strong>Lovense Connect</strong>-appen (desktop, fra lovense.com/connect) — eller brug <strong>Lovense Remote</strong> på mobilen. Det er broen, der taler med legetøjet over Bluetooth. Tænd legetøjet og par, til appen viser det forbundet."),
         ("Installér Lovense Cam Extension",
          "Tilføj <strong>Lovense Cam Extension</strong> til Chrome eller Edge (version 30.1.4 eller nyere) og log ind med din Lovense-konto. Der findes ingen separat «Lovense Browser» — det er denne udvidelse, der læser tips og driver overlayet. For SplitCam-specifikke widgets hent også det officielle <strong>Lovense SplitCam Toolset</strong> fra SplitCams plugins-side (splitcam.com/more-plugins)."),
     ...
     "tips": [
         ...
         ("Det er en udvidelse, ikke en browser", "Der er ingen separat «Lovense Browser» at hente — Lovense Cam Extension installeres i Chrome eller Edge. Hold den opdateret (30.1.4 eller nyere), ellers loader SplitCam-overlayet måske ikke."),
         ("Hold legetøjet opladet", "Et fladt batteri midt i showet dræber den interaktive side — oplad fuldt før live."),
         ("Test tip-reaktionen", "Send en lille test-tip for at bekræfte, at legetøjet reagerer, før rummet bliver offentligt."),
         ("Tjek versions-kravene", "Lovense SplitCam Toolset kræver SplitCam 10.4.5 eller nyere. Cam Extension dækker officielt Chaturbate, Stripchat, BongaCams, MyFreeCams og CamSoda — for andre sites brug Lovense's Generic URL-integration i stedet."),
     ],
     "faq": [
         ("Hvad skal jeg installere for Lovense på SplitCam?", "Tre ting: <strong>SplitCam</strong> (encoderen), <strong>Lovense Connect</strong>-appen (broer legetøjet over Bluetooth) og <strong>Lovense Cam Extension</strong> til Chrome/Edge (læser tips og fodrer overlayet). Tilføj eventuelt det officielle Lovense SplitCam Toolset fra splitcam.com/more-plugins."),
         ("Findes der en «Lovense Browser», jeg skal hente?", "Nej. Der er ingen separat Lovense-browser — det er <strong>Lovense Cam Extension</strong>, som installeres i Chrome eller Edge. Parring af legetøjet klares af den separate Lovense Connect (desktop) eller Lovense Remote (mobil)."),
