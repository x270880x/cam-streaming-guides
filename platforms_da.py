...
PLATFORMS_DA = [
    ...
    {"slug": "lovense", "name": "Lovense",
     ...
     "tips": [
         ...
         ("Tjek versions-kravene", "Lovense SplitCam Toolset kræver SplitCam 10.4.5 eller nyere. Cam Extension dækker officielt Chaturbate, Stripchat, BongaCams, MyFreeCams og CamSoda — for andre sites brug Lovenses Generic URL-integration i stedet."),
     ],
     "faq": [
