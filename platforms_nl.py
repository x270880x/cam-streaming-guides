...
PLATFORMS_NL = [
    ...
    },
    {
        ...
        "title": "SkyPrivate gebruiken met SplitCam — Skype-gebaseerde privé-camcalls",
        "desc": "SkyPrivate gebruiken met gratis SplitCam als virtuele camera — pay-per-minute Skype-camcalls, multi-camera scènes, beauty-filters. Geen watermerk, geen registratie.",
        "kw": "skyprivate, sky private cam, skype cam private, skyprivate splitcam, skyprivate virtuele camera, pay-per-minute cam",
    ...
    },
    {
        ...
        "title": "Streamen op MV Live (ManyVids) met SplitCam — Creator Studio setup",
        "desc": "Streamen op ManyVids' MV Live met gratis SplitCam — Creator Studio external encoder, OnlyFans-achtige creator economy, multi-camera scènes. Geen watermerk, geen registratie.",
        "kw": "manyvids streamen, mv live, manyvids live broadcast, manyvids obs, mv live external encoder, manyvids stream key, manyvids creator",
    ...
    },
    {
        ...
        "title": "Streamen op Fansly Live met SplitCam — Creator Dashboard External Encoder",
        "desc": "Streamen op Fansly Live met gratis SplitCam — Creator Dashboard external encoder, OnlyFans-concurrent, multi-camera scènes, beauty-filters. Geen watermerk, geen registratie.",
        "kw": "fansly streamen, fansly live, fansly broadcast, fansly obs, fansly external encoder, fansly rtmp, fansly stream key, fansly creator",
    ...
    },
    {
        ...
        "title": "Streamen op iFriends met SplitCam — Model Center External Encoder",
        "desc": "Streamen op iFriends met gratis SplitCam — Model Center external encoder, langlopend onafhankelijk cam-netwerk, multi-camera scènes. Geen watermerk, geen registratie.",
        "kw": "ifriends streamen, ifriends obs, ifriends external encoder, ifriends rtmp, ifriends stream key, ifriends model center, ifriends.net",
    ...
    },
    {
        ...
        "title": "Streamen op Babestation met SplitCam — UK cam-netwerk-setup",
        "desc": "Streamen op Babestation met gratis SplitCam — Performer Hub external encoder, Brits adult-tv-/cam-netwerk, multi-camera scènes, overlays. Geen watermerk, geen registratie.",
        "kw": "babestation streamen, babestation cam, babestation obs, babestation external encoder, babestation rtmp, babestation performer, uk cam netwerk",
    ...
    },
    {
        ...
        "title": "Streamen op AdultWork met SplitCam — Members Area External Encoder",
        "desc": "Streamen op AdultWork met gratis SplitCam — Members Area external encoder, Britse adult-service-marktplaats met cam-feature, multi-camera scènes. Geen watermerk, geen registratie.",
        "kw": "adultwork streamen, adultwork cam, adultwork obs, adultwork external encoder, adultwork rtmp, adultwork webcam, uk cam",
    ...
    },
    {
        ...
        "title": "Streamen op Jerkmate met SplitCam — Streamate-netwerk-setup",
        "desc": "Streamen op Jerkmate met gratis SplitCam — Jerkmate haalt zijn live models uit het Streamate-netwerk, dus je streamt via SM Connect en SplitCams geïntegreerde Streamate-kanaal. Multi-camera scènes, geen watermerk.",
        "kw": "jerkmate streamen, jerkmate model worden, jerkmate cam, jerkmate streamate, jerkmate obs, jerkmate external encoder, jerkmate broadcast",
    ...
    },
    {
        ...
        "title": "Live gaan op JustForFans met SplitCam — Virtuele-camera-setup",
        "desc": "Live gaan op JustForFans (JFF) met gratis SplitCam — gebruik SplitCam als virtuele camera in de JFF live-broadcaster voor multi-camera scènes, overlays en filters. Geen watermerk, geen registratie.",
        "kw": "live gaan op justforfans, justforfans live, jff live stream, justforfans obs, justforfans virtuele camera, justfor.fans cam, justforfans broadcast",
