...
PLATFORMS_HU = [
    ...
    {"slug": "lovense", "name": "Lovense",
     ...
     "desc": "Adj Lovense játékszert a SplitCam streamedhez — Lovense Connect app, Cam Extension és a hivatalos SplitCam Toolset, borravaló-értesítéssel a képernyőn.",
     ...
     "tips": [
         ...
         ("Figyelj a verziókövetelményekre", "A Lovense SplitCam Toolset SplitCam 10.4.5-öt vagy újabbat igényel. A Cam Extension hivatalosan lefedi a Chaturbate-et, Stripchat-et, BongaCams-t, MyFreeCams-t és CamSoda-t — bármely más site-hoz használd a Lovense Generic URL integrációját."),
     ],
     "faq": [
         ("Mit kell telepítenem a Lovense-hez SplitCamen?", "Három dolgot: a <strong>SplitCamet</strong> (az enkóder), a <strong>Lovense Connect</strong> appot (Bluetooth-on át hidalja a játékszert) és a <strong>Lovense Cam Extension</strong>-t Chrome/Edge-hez (olvassa a borravalókat és táplálja az overlayt). Opcionálisan add hozzá a hivatalos Lovense SplitCam Toolset-et a splitcam.com/more-plugins oldalról."),
