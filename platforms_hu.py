...
PLATFORMS_HU = [
    ...
    {"slug": "lovense", "name": "Lovense",
     ...
     "desc": "Adj Lovense játékszert a SplitCam streamedhez — Lovense Connect app, Cam Extension és a hivatalos SplitCam Toolset, tip alerttel a képernyőn.",
     ...
     "intro": "Futtasd a cam streamedet az ingyenes <strong style='color:var(--text)'>SplitCamen</strong>, és párosíts egy <strong style='color:var(--text)'>Lovense</strong> interaktív játékszert, ami a tipekre reagál. Három dolgot telepítesz: a <strong>SplitCamet</strong> (az enkóder), a <strong>Lovense Connect</strong> appot (a Bluetooth híd a játékszerhez) és a <strong>Lovense Cam Extension</strong>-t Chrome/Edge-hez (ez olvassa a tipeket és táplálja a képernyős overlayt). A Lovense emellett egy hivatalos <strong style='color:var(--text)'>Lovense SplitCam Toolset</strong>-et is közzétesz a SplitCam plugin oldalán — az integráció mindkét oldalról támogatott.",
     "quick": "Lovense játékszer hozzáadásához a streamhez: telepítsd a SplitCamet, a Lovense Connect appot és a Lovense Cam Extension-t, párosítsd a játékszert, kösd az extensiont a cam site-odhoz, add hozzá a Lovense overlayt Browser rétegként a SplitCamben, majd streamelj a szokásos módon."
              ...
              "<li>Telepítsd a Lovense Connectet és párosítsd a játékszert.</li>"
              ...
              "<li>Nyomd meg a Go Live-ot.</li></ol>",
     "key_how": "A játékszer soha nem kommunikál közvetlenül a SplitCammel. A lánc: egy néző tipet ad a cam site-odon → a böngésződben futó <strong>Lovense Cam Extension</strong> ezt észleli → parancsot küld a localhoston futó <strong>Lovense Connect</strong> appnak → a Connect Bluetooth-on át vezérli a játékszert. A SplitCam egyetlen dolga, hogy megjelenítse a <strong>Lovense overlayt</strong> (játékszer státusz + legutóbbi tipek) Browser rétegként, és streamelje a kamerádat. Nincs külön «Lovense Browser» app — ez egy Chrome-hoz vagy Edge-hez való böngésző<em>bővítmény</em>.",
     "steps": [
         ("Telepítsd a SplitCamet",
         ...
         ("Telepítsd a Lovense Connectet és párosítsd a játékszert",
          "Telepítsd a <strong>Lovense Connect</strong> appot (desktop, a lovense.com/connect oldalról) — vagy használd a <strong>Lovense Remote</strong>-ot a telefonodon. Ez a híd, ami Bluetooth-on át kommunikál a játékszerrel. Kapcsold be a játékszert és párosítsd, amíg az app csatlakoztatva-t nem mutat."),
         ("Telepítsd a Lovense Cam Extension-t",
          "Add a <strong>Lovense Cam Extension</strong>-t a Chrome-hoz vagy Edge-hez (30.1.4-es vagy újabb verzió), és jelentkezz be a Lovense fiókoddal. Nincs önálló «Lovense Browser» — ez a bővítmény olvassa a tipeket és hajtja az overlayt. SplitCam-specifikus widgetekért szerezd be a hivatalos <strong>Lovense SplitCam Toolset</strong>-et is a SplitCam plugin oldaláról (splitcam.com/more-plugins)."),
         ("Kösd az extensiont a cam site-odhoz és add hozzá az overlayt a SplitCamben",
          "A Cam Extension-ben kattints a <strong>+</strong>-ra, hogy hozzáadd a cam site-odat (Chaturbate, Stripchat stb.), állítsd be a tip szinteket, majd nyisd meg a <strong>Video Feedback</strong> fület és válaszd a <strong>SplitCam</strong>-et. Másold ki a kapott overlay URL-t, és add hozzá <strong>Browser</strong> rétegként a SplitCam jelenetedbe, hogy a nézők lássák a játékszer státuszát és a legutóbbi tipeket."),
         ("Építsd fel a jelenetet és Go Live",
          "Add hozzá a kamerádat és a többi overlayt, illeszd be a cam platform RTMP kulcsát a SplitCambe, és kattints <strong>Go Live</strong>-ra. A játékszer mostantól valós időben reagál a tipekre."),
     ],
     "tips": [
         ("Három telepítés, sorrendben", "SplitCam (enkóder) + Lovense Connect (Bluetooth híd) + Lovense Cam Extension (tip olvasó / overlay). Ha bármelyik hiányzik, a játékszer nem reagál a streamen."),
         ...
         ("Teszteld a tip reakciót", "Küldj egy kis teszt tipet, hogy megerősítsd, a játékszer reagál, mielőtt a szoba nyilvános lesz."),
         ("Figyelj a verzió követelményekre", "A Lovense SplitCam Toolset SplitCam 10.4.5-öt vagy újabbat igényel. A Cam Extension hivatalosan lefedi a Chaturbate-et, Stripchat-et, BongaCams-t, MyFreeCams-t és CamSoda-t — bármely más site-hoz használd a Lovense Generic URL integrációját."),
     ],
     "faq": [
         ("Mit kell telepítenem a Lovense-hez SplitCamen?", "Három dolgot: a <strong>SplitCamet</strong> (az enkóder), a <strong>Lovense Connect</strong> appot (Bluetooth-on át hidalja a játékszert) és a <strong>Lovense Cam Extension</strong>-t Chrome/Edge-hez (olvassa a tipeket és táplálja az overlayt). Opcionálisan add hozzá a hivatalos Lovense SplitCam Toolset-et a splitcam.com/more-plugins oldalról."),
         ("Kell letöltenem egy «Lovense Browser»-t?", "Nem. Nincs önálló Lovense böngésző — ez a <strong>Lovense Cam Extension</strong>, ami a Chrome-ba vagy Edge-be települ. A játékszer párosítását a külön <strong>Lovense Connect</strong> (desktop) vagy <strong>Lovense Remote</strong> (mobil) app végzi."),
         ("A játékszer közvetlenül csatlakozik a SplitCamhez?", "Nem — a játékszer a Lovense Connect appal párosul Bluetooth-on át; a Cam Extension olvassa a tipeket, a SplitCam pedig csak megjeleníti az overlayt és streameli a kamerádat."),
         ...
         ("Megjeleníthetem a legutóbbi tipeket a képernyőn?", "Igen — a Cam Extension ad egy overlay URL-t; add hozzá Browser rétegként a SplitCamben, és a nézők látják a játékszer státuszát és a legutóbbi tipeket."),
     ]},
