...
PLATFORMS_BG = [
    ...
    {"slug": "lovense", "name": "Lovense",
     ...
     "desc": "Свържи Lovense играчка към SplitCam стрийма — Lovense Connect + Cam Extension с вградена SplitCam поддръжка, tip alerts на екрана. Без плъгин.",
     ...
     "key_how": "Играчката никога не се свързва директно със SplitCam. Веригата е: зрител праща бакшиш на кам сайта "
                ...
                "приложението <strong>Lovense Connect</strong> на localhost &rarr; Remote задвижва играчката по "
     ...
     "steps": [
         ...
         ("Инсталирай Lovense Connect и сдвой играчката",
          "Инсталирай приложението <strong>Lovense Connect</strong> — desktop (Windows / Mac) или мобилното приложение на телефона. Това е мостът, който говори с играчката по Bluetooth. Включи играчката и я сдвой, докато приложението покаже свързано."),
     ...
     "faq": [
         ...
         ("Има ли „Lovense Browser“, който трябва да сваля?", "Не. Няма самостоятелен Lovense браузър — това е <strong>Lovense Cam Extension</strong>, което се инсталира в Chrome или Edge. Сдвояването на играчката се поема от отделното приложение Lovense Connect (desktop или мобилно)."),
