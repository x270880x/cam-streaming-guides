...
PLATFORMS_FI = [
    ...
    {"slug": "lovense", "name": "Lovense",
     ...
     "desc": "Lisää Lovense-lelu SplitCam-striimiin — Lovense Connect -sovellus, Cam Extension ja virallinen SplitCam Toolset, näytön tip-alertit.",
     ...
     "steps": [
         ...
         ("Asenna Lovense Connect ja parita lelu",
          "Asenna <strong>Lovense Connect</strong> -sovellus (pöytäkone, osoitteesta lovense.com/connect) — tai käytä <strong>Lovense Remote</strong>a puhelimessasi. Tämä on silta, joka keskustelee lelun kanssa Bluetoothin yli. Käynnistä lelu ja parita se, kunnes sovellus näyttää sen yhdistetyksi."),
         ("Asenna Lovense Cam Extension",
          "Lisää <strong>Lovense Cam Extension</strong> Chromeen tai Edgeen (versio 30.1.4 tai uudempi) ja kirjaudu Lovense-tililläsi. Erillistä «Lovense Browser» -selainta ei ole — juuri tämä laajennus lukee tipit ja pyörittää overlayta. SplitCam-kohtaisia widgettejä varten hae myös virallinen <strong>Lovense SplitCam Toolset</strong> SplitCamin plugins-sivulta (splitcam.com/more-plugins)."),
         ("Linkitä laajennus cam-sivullesi ja lisää overlay SplitCamiin",
          "Klikkaa Cam Extensionissa <strong>+</strong> lisätäksesi cam-sivusi (Chaturbate, Stripchat jne.), aseta tip-tasosi, avaa sitten <strong>Video Feedback</strong> -välilehti ja valitse <strong>SplitCam</strong>. Kopioi saamasi overlay-URL ja lisää se <strong>Browser</strong>-kerroksena SplitCam-näkymääsi, jotta katsojat näkevät lelun statuksen ja viimeisimmät tipit."),
     ...
     "tips": [
         ...
         ("Huomioi versiovaatimukset", "Lovense SplitCam Toolset vaatii SplitCam 10.4.5:n tai uudemman. Cam Extension kattaa virallisesti Chaturbaten, Stripchatin, BongaCamsin, MyFreeCamsin ja CamSoda:n — muiden sivustojen kohdalla käytä Lovensen Generic URL -integraatiota."),
     ],
     "faq": [
         ("Mitä minun täytyy asentaa Lovenselle SplitCamissa?", "Kolme asiaa: <strong>SplitCam</strong> (enkooderi), <strong>Lovense Connect</strong> -sovellus (siltaa lelun Bluetoothin yli) ja <strong>Lovense Cam Extension</strong> Chromelle/Edgelle (lukee tipit ja syöttää overlayn). Halutessasi lisää virallinen Lovense SplitCam Toolset osoitteesta splitcam.com/more-plugins."),
         ("Pitääkö minun ladata «Lovense Browser»?", "Ei. Erillistä Lovense-selainta ei ole — kyseessä on <strong>Lovense Cam Extension</strong>, joka asentuu Chromeen tai Edgeen. Lelun parituksesta huolehtii erillinen Lovense Connect (pöytäkone)- tai Lovense Remote (mobiili) -sovellus."),
