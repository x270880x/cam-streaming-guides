...
PLATFORMS_RU = [
    ...
    },
    {
        ...
        "steps": [
            ...
            ("Подключите OnlyFans через авторизацию",
             "В SplitCam откройте <strong>Stream Settings</strong> &rarr; <strong>Add "
             "Channel</strong> &rarr; <strong>OnlyFans</strong> и выберите способ "
             "<strong>Авторизация</strong>. Войдите под своими email и паролем OnlyFans — "
             "SplitCam подключается прямо к вашему аккаунту, искать ключ на сайте OnlyFans не "
             "нужно."),
            ("Ключ и настройки синхронизируются автоматически",
             "После авторизации SplitCam забирает ваш ключ трансляции OnlyFans и держит "
             "соединение живым — ключ и настройки эфира OnlyFans остаются синхронизированными "
             "на протяжении всего стрима, копировать руками ничего не надо. Этими настройками "
             "OnlyFans можно управлять прямо в SplitCam."),
            ("Go Live — и меняйте на ходу",
             "Нажмите <strong>Go Live</strong>. Аккаунт подключён, поэтому настройки эфира "
             "OnlyFans можно менять прямо из SplitCam <strong>во время стрима или после "
             "него</strong> — не заходя на сайт OnlyFans."),
        ],
        "tips": [
