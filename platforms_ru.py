...
PLATFORMS_RU = [
    ...
    },
    {
        ...
        "tips": [
            ...
            ("Битрейт держите низким", "Приём OnlyFans ограничивает видеобитрейт примерно "
             "2500 Кбит/с — куда строже большинства. Цельтесь в 720p–1080p при ~2000–2500."),
        ...
        "faq": [
            ("Где OBS Key на OnlyFans?", "Profile → Settings → раздел Other — поле называется "
             "OBS Key."),
            ("OnlyFans официально поддерживает OBS / внешние кодировщики?", "Официально нет — "
             "справка OnlyFans описывает только встроенный эфир в браузере/приложении и не "
             "публикует гайд по OBS. Поле OBS Key существует и ведёт на RTMP-приём OnlyFans, "
             "так что SplitCam на практике работает, но считайте это неофициальным."),
