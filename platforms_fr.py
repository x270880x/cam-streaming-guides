...
PLATFORMS_FR = [
    ...
    },
    {
        ...
        "title": "Comment diffuser sur LiveJasmin avec SplitCam — encodeur externe HD",
        "desc": "Diffuser sur LiveJasmin avec SplitCam gratuit — encodeur externe du Model Center, configuration HD 1080p, scènes multicaméras et overlays. Sans filigrane, sans inscription.",
        "kw": "diffuser livejasmin, livejasmin obs, livejasmin encodeur externe, livejasmin rtmp, livejasmin stream key, configurer modèle livejasmin",
    ...
    },
    {
        ...
        "title": "Comment diffuser sur MyFreeCams (MFC) avec SplitCam — bypass du Model Web Broadcaster",
        "desc": "Diffuser sur MyFreeCams avec SplitCam gratuit — option broadcaster externe du Model Admin, économie de tokens MFC, scènes multicaméras, overlays. Sans filigrane, sans inscription.",
        "kw": "diffuser myfreecams, mfc broadcaster externe, myfreecams obs, mfc rtmp, mfc stream key, model admin, token mfc",
    ...
    },
    {
        ...
        "title": "Comment diffuser sur Cherry.tv avec SplitCam — encodeur externe Web3-friendly",
        "desc": "Diffuser sur Cherry.tv avec SplitCam gratuit — encodeur externe du Streamer Dashboard, plateforme cam crypto-friendly, scènes multicaméras. Sans filigrane, sans inscription.",
        "kw": "diffuser cherry tv, cherry.tv obs, cherry tv encodeur externe, cherry.tv rtmp, cherry.tv stream key, cherry tv streamer, cam web3",
    ...
    },
    {
        ...
        "title": "Comment diffuser sur AmateurTV avec SplitCam — réseau cam hispanophone",
        "desc": "Diffuser sur AmateurTV avec SplitCam gratuit — encodeur externe du Model Panel, réseau cam hispanophone (Espagne et LatAm), scènes multicaméras. Sans filigrane, sans inscription.",
        "kw": "diffuser amateurtv, amateur.tv obs, amateurtv encodeur externe, amateurtv rtmp, amateurtv stream key, modèles amateur tv",
    ...
    },
    {
        ...
        "title": "Comment diffuser sur Camster avec SplitCam — encodeur externe du Model Hub",
        "desc": "Diffuser sur Camster avec SplitCam gratuit — encodeur externe du Model Hub, plateforme cam mid-tier établie, scènes multicaméras et overlays. Sans filigrane, sans inscription.",
        "kw": "diffuser camster, camster.com obs, camster encodeur externe, camster rtmp, camster stream key, camster model hub",
    ...
    },
    {
        ...
        "title": "Comment diffuser sur Camversity avec SplitCam — encodeur externe du Performer Dashboard",
        "desc": "Diffuser sur Camversity avec SplitCam gratuit — encodeur externe du Performer Dashboard, plateforme cam indépendante en croissance, scènes multicaméras. Sans filigrane, sans inscription.",
        "kw": "diffuser camversity, camversity obs, camversity encodeur externe, camversity rtmp, camversity stream key, camversity performer",
    ...
    },
    {
        ...
        "title": "Comment utiliser SkyPrivate avec SplitCam — appels cam privés via Skype",
        "desc": "Utilisez SkyPrivate avec SplitCam gratuit en caméra virtuelle — appels cam privés pay-per-minute via Skype, scènes multicaméras, filtres beauté. Sans filigrane, sans inscription.",
        "kw": "skyprivate, sky private cam, skype cam privé, skyprivate splitcam, skyprivate caméra virtuelle, cam pay per minute",
    ...
    },
    {
        ...
        "title": "Comment diffuser sur MV Live (ManyVids) avec SplitCam — Creator Studio",
        "desc": "Diffuser sur MV Live de ManyVids avec SplitCam gratuit — encodeur externe du Creator Studio, économie de créateur style OnlyFans, scènes multicaméras. Sans filigrane, sans inscription.",
        "kw": "diffuser manyvids, mv live, manyvids live broadcast, manyvids obs, mv live external encoder, manyvids stream key, manyvids creator",
    ...
    },
    {
        ...
        "title": "Comment diffuser sur Fansly Live avec SplitCam — encodeur externe du Creator Dashboard",
        "desc": "Diffuser sur Fansly Live avec SplitCam gratuit — encodeur externe du Creator Dashboard, concurrent direct d'OnlyFans, scènes multicaméras et filtres beauté. Sans filigrane, sans inscription.",
        "kw": "diffuser fansly, fansly live, fansly broadcast, fansly obs, fansly encodeur externe, fansly rtmp, fansly stream key, fansly creator",
    ...
    },
    {
        ...
        "title": "Streamer sur Jerkmate avec SplitCam — Réseau Streamate",
        "desc": "Diffuser sur Jerkmate avec SplitCam gratuit — Jerkmate puise ses modèles live dans le réseau Streamate, donc vous streamez via SM Connect et le canal Streamate intégré à SplitCam. Scènes multi-caméras, sans filigrane.",
        "kw": "streamer sur jerkmate, devenir modèle jerkmate, jerkmate cam, jerkmate streamate, jerkmate obs, jerkmate encodeur externe, jerkmate diffusion",
    ...
    },
    {
        ...
        "title": "Passer en live sur JustForFans avec SplitCam — Caméra virtuelle",
        "desc": "Passer en live sur JustForFans (JFF) avec SplitCam gratuit — utilisez SplitCam comme caméra virtuelle dans le broadcaster live de JFF pour scènes multi-caméras, overlays et filtres. Sans filigrane, sans inscription.",
        "kw": "passer en live sur justforfans, justforfans live, jff live stream, justforfans obs, justforfans caméra virtuelle, justfor.fans cam, justforfans diffusion",
