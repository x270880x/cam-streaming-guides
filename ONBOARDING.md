...
- **Local folder:** `/Users/splitcam/Documents/Проекты/SplitCam/SplitCam сайт/cam-streaming-guides/`
...
## Deploy
```bash
cd "/Users/splitcam/Documents/Проекты/SplitCam/SplitCam сайт/cam-streaming-guides"
python3 build.py
